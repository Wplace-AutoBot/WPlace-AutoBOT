var WPlaceAutoBot=(()=>{var Ya=`/* WPlace Auto-Image Bot - Unified CSS Styles (decoupled from JS)
...
--- UNAVAILABLE COLORS ---`),n.forEach((i,r)=>{console.log(`${r+1}. ID: ${i.id}, Name: "${i.name}", RGB: (${i.rgb[0]}, ${i.rgb[1]}, ${i.rgb[2]}) [LOCKED]`)})),console.log("=== END COLOR STATUS ==="),a},formatTime:t=>{let a=Math.floor(t/1e3%60),n=Math.floor(t/(1e3*60)%60),i=Math.floor(t/(1e3*60*60)%24),r=Math.floor(t/(1e3*60*60*24)),s="";return r>0&&(s+=`${r}d `),(i>0||r>0)&&(s+=`${i}h `),(n>0||i>0||r>0)&&(s+=`${n}m `),s+=`${a}s`,s},calculateEstimatedTime:(t,a,n)=>{if(t<=0)return 0;let i=e.paintingSpeed>0?1e3/e.paintingSpeed:1e3,r=t*i,p=Math.ceil(t/Math.max(a,1))*n;return r+p},initializePaintedMap:(t,a)=>{(!e.paintedMap||e.paintedMap.length!==a)&&(e.paintedMap=Array(a).fill().map(()=>Array(t).fill(!1)),console.log(`\u{1F4CB} Initialized painted map: ${t}x${a}`))},markPixelPainted:(t,a,n=0,i=0)=>{let r=t+n,s=a+i;e.paintedMap&&e.paintedMap[s]&&r>=0&&r<e.paintedMap[s].length&&(e.paintedMap[s][r]=!0)},isPixelPainted:(t,a,n=0,i=0)=>{let r=t+n,s=a+i;return e.paintedMap&&e.paintedMap[s]&&r>=0&&r<e.paintedMap[s].length?e.paintedMap[s][r]:!1},shouldAutoSave:()=>{let t=Date.now(),a=e.paintedPixels-e._lastSavePixelCount,n=t-e._lastSaveTime;return!e._saveInProgress&&a>=25&&n>=3e4},performSmartSave:()=>{if(!o.shouldAutoSave())return!1;e._saveInProgress=!0;let t=o.saveProgress();return t&&(e._lastSavePixelCount=e.paintedPixels,e._lastSaveTime=Date.now(),console.log(`\u{1F4BE} Auto-saved at ${e.paintedPixels} pixels`)),e._saveInProgress=!1,t},packPaintedMapToBase64:(t,a,n)=>{if(!t||!a||!n)return null;let i=a*n,r=Math.ceil(i/8),s=new Uint8Array(r),p=0;for(let d=0;d<n;d++){let l=t[d];for(let v=0;v<a;v++){let u=l&&l[v]?1:0,T=p>>3,m=p&7;u&&(s[T]|=1<<m),p++}}let g="",c=32768;for(let d=0;d<s.length;d+=c)g+=String.fromCharCode.apply(null,s.subarray(d,Math.min(d+c,s.length)));return btoa(g)},unpackPaintedMapFromBase64:(t,a,n)=>{if(!t||!a||!n)return null;let i=atob(t),r=new Uint8Array(i.length);for(let g=0;g<i.length;g++)r[g]=i.charCodeAt(g);let s=Array(n).fill().map(()=>Array(a).fill(!1)),p=0;for(let g=0;g<n;g++)for(let c=0;c<a;c++){let d=p>>3,l=p&7;s[g][c]=(r[d]>>l&1)===1,p++}return s},migrateProgressToV2:t=>{var n,i;if(!t||!(!t.version||t.version==="1"||t.version==="1.0"||t.version==="1.1"))return t;try{let r={...t},s=(n=r.imageData)==null?void 0:n.width,p=(i=r.imageData)==null?void 0:i.height;if(r.paintedMap&&s&&p){let g=o.packPaintedMapToBase64(r.paintedMap,s,p);r.paintedMapPacked={width:s,height:p,data:g}}return delete r.paintedMap,r.version="2",r}catch(r){return console.warn("Migration to v2 failed, using original data:",r),t}},migrateProgressToV21:t=>{var i,r;if(!t||t.version==="2.1")return t;let a=t.version==="2"||t.version==="2.0",n=!t.version||t.version==="1"||t.version==="1.0"||t.version==="1.1";if(!a&&!n)return t;try{let s={...t};if(n){let p=(i=s.imageData)==null?void 0:i.width,g=(r=s.imageData)==null?void 0:r.height;if(s.paintedMap&&p&&g){let c=o.packPaintedMapToBase64(s.paintedMap,p,g);s.paintedMapPacked={width:p,height:g,data:c}}delete s.paintedMap}return s.version="2.1",s}catch(s){return console.warn("Migration to v2.1 failed, using original data:",s),t}},migrateProgressToV22:t=>{try{let a={...t};return a.version="2.2",a.state.coordinateMode||(a.state.coordinateMode=f.COORDINATE_MODE),a.state.coordinateDirection||(a.state.coordinateDirection=f.COORDINATE_DIRECTION),a.state.coordinateSnake||(a.state.coordinateSnake=f.COORDINATE_SNAKE),a.state.blockWidth||(a.state.blockWidth=f.COORDINATE_BLOCK_WIDTH),a.state.blockHeight||(a.state.blockHeight=f.COORDINATE_BLOCK_HEIGHT),a}catch(a){return console.warn("Migration to v2.2 failed, using original data:",a),t}},buildPaintedMapPacked(){if(e.paintedMap&&e.imageData){let t=o.packPaintedMapToBase64(e.paintedMap,e.imageData.width,e.imageData.height);if(t)return{width:e.imageData.width,height:e.imageData.height,data:t}}return null},buildProgressData(){return{timestamp:Date.now(),version:"2.2",state:{totalPixels:e.totalPixels,paintedPixels:e.paintedPixels,lastPosition:e.lastPosition,startPosition:e.startPosition,region:e.region,imageLoaded:e.imageLoaded,colorsChecked:e.colorsChecked,coordinateMode:e.coordinateMode,coordinateDirection:e.coordinateDirection,coordinateSnake:e.coordinateSnake,blockWidth:e.blockWidth,blockHeight:e.blockHeight,availableColors:e.availableColors},imageData:e.imageData?{width:e.imageData.width,height:e.imageData.height,pixels:Array.from(e.imageData.pixels),totalPixels:e.imageData.totalPixels}:null,paintedMapPacked:o.buildPaintedMapPacked()}},migrateProgress(t){if(!t)return null;let a=t,n=a.version;return(!n||n==="1"||n==="1.0"||n==="1.1")&&(a=o.migrateProgressToV2(a)),(a.version==="2"||a.version==="2.0")&&(a=o.migrateProgressToV21(a)),a.version==="2.1"&&(a=o.migrateProgressToV22(a)),a},saveProgress:()=>{try{let t=o.buildProgressData(e);return localStorage.setItem("wplace-bot-progress",JSON.stringify(t)),!0}catch(t){return console.error("Error saving progress:",t),!1}},loadProgress:()=>{try{let t=localStorage.getItem("wplace-bot-progress");if(!t)return null;let a=JSON.parse(t),n=o.migrateProgress(a);if(n&&n!==a)try{localStorage.setItem("wplace-bot-progress",JSON.stringify(n))}catch{}return n}catch(t){return console.error("Error loading progress:",t),null}},clearProgress:()=>{try{return localStorage.removeItem("wplace-bot-progress"),e.paintedMap=null,e._lastSavePixelCount=0,e._lastSaveTime=0,e.coordinateMode=f.COORDINATE_MODE,e.coordinateDirection=f.COORDINATE_DIRECTION,e.coordinateSnake=f.COORDINATE_SNAKE,e.blockWidth=f.COORDINATE_BLOCK_WIDTH,e.blockHeight=f.COORDINATE_BLOCK_HEIGHT,console.log("\u{1F4CB} Progress and painted map cleared"),!0}catch(t){return console.error("Error clearing progress:",t),!1}},restoreProgress:t=>{try{if(Object.assign(e,t.state),t.state.coordinateMode&&(e.coordinateMode=t.state.coordinateMode),t.state.coordinateDirection&&(e.coordinateDirection=t.state.coordinateDirection),t.state.coordinateSnake!==void 0&&(e.coordinateSnake=t.state.coordinateSnake),t.state.blockWidth&&(e.blockWidth=t.state.blockWidth),t.state.blockHeight&&(e.blockHeight=t.state.blockHeight),t.imageData){e.imageData={...t.imageData,pixels:new Uint8ClampedArray(t.imageData.pixels)};try{let a=document.createElement("canvas");a.width=e.imageData.width,a.height=e.imageData.height;let n=a.getContext("2d"),i=new ImageData(e.imageData.pixels,e.imageData.width,e.imageData.height);n.putImageData(i,0,0);let r=new Kt("");r.img=a,r.canvas=a,r.ctx=n,e.imageData.processor=r}catch(a){console.warn("Could not rebuild processor from saved image data:",a)}}if(t.paintedMapPacked&&t.paintedMapPacked.data){let{width:a,height:n,data:i}=t.paintedMapPacked;e.paintedMap=o.unpackPaintedMapFromBase64(i,a,n)}else t.paintedMap&&(e.paintedMap=t.paintedMap.map(a=>Array.from(a)));return!0}catch(a){return console.error("Error restoring progress:",a),!1}},saveProgressToFile:()=>{try{let t=o.buildProgressData(),a=`wplace-bot-progress-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.json`;return o.createFileDownloader(JSON.stringify(t,null,2),a),!0}catch(t){return console.error("Error saving to file:",t),!1}},loadProgressFromFile:async()=>{try{let t=await o.createFileUploader();if(!t||!t.state)throw new Error("Invalid file format");let a=o.migrateProgress(t);return o.restoreProgress(a)}catch(t){throw console.error("Error loading from file:",t),t}},restoreOverlayFromData:async()=>{if(!e.imageLoaded||!e.imageData||!e.startPosition||!e.region)return!1;try{let t=new ImageData(e.imageData.pixels,e.imageData.width,e.imageData.height),a=new OffscreenCanvas(e.imageData.width,e.imageData.height);a.getContext("2d").putImageData(t,0,0);let i=await a.transferToImageBitmap();await Pe.setImage(i),await Pe.setPosition(e.startPosition,e.region),Pe.enable();let r=document.getElementById("toggleOverlayBtn");return r&&(r.disabled=!1,r.classList.add("active")),console.log("Overlay restored from data"),!0}catch(t){return console.error("Failed to restore overlay from data:",t),!1}},updateCoordinateUI({mode:t,directionControls:a,snakeControls:n,blockControls:i}){let r=t==="rows"||t==="columns",s=t==="blocks"||t==="shuffle-blocks";a&&(a.style.display=r?"block":"none"),n&&(n.style.display=r?"block":"none"),i&&(i.style.display=s?"block":"none")}};class Kt{constructor(a){this.imageSrc=a,this.img=null,this.canvas=null,this.ctx=null}async load(){return new Promise((a,n)=>{this.img=new Image,this.img.crossOrigin="anonymous",this.img.onload=()=>{this.canvas=document.createElement("canvas"),this.ctx=this.canvas.getContext("2d"),this.canvas.width=this.img.width,this.canvas.height=this.img.height,this.ctx.drawImage(this.img,0,0),a()},this.img.onerror=n,this.img.src=this.imageSrc})}getDimensions(){return{width:this.canvas.width,height:this.canvas.height}}getPixelData(){return this.ctx.getImageData(0,0,this.canvas.width,this.canvas.height).data}resize(a,n){let i=document.createElement("canvas"),r=i.getContext("2d");return i.width=a,i.height=n,r.imageSmoothingEnabled=!1,r.drawImage(this.canvas,0,0,a,n),this.canvas.width=a,this.canvas.height=n,this.ctx.imageSmoothingEnabled=!1,this.ctx.drawImage(i,0,0),this.ctx.getImageData(0,0,a,n).data}generatePreview(a,n){let i=document.createElement("canvas"),r=i.getContext("2d");return i.width=a,i.height=n,r.imageSmoothingEnabled=!1,r.drawImage(this.img,0,0,a,n),i.toDataURL()}}let Ta={async paintPixelInRegion(t,a,n,i,r){try{if(await ka(),!be)return"token_error";let s={coords:[n,i],colors:[r],t:be},p=await fetch(`https://backend.wplace.live/s0/pixel/${t}/${a}`,{method:"POST",headers:{"Content-Type":"text/plain;charset=UTF-8"},credentials:"include",body:JSON.stringify(s)});if(p.status===403)return console.error("\u274C 403 Forbidden. Turnstile token might be invalid or expired."),be=null,it=new Promise(c=>{Re=c}),"token_error";let g=await p.json();return(g==null?void 0:g.painted)===1}catch(s){return console.error("Paint request failed:",s),!1}},async getCharges(){var a,n,i;let t={charges:0,max:1,cooldown:f.COOLDOWN_DEFAULT};try{let r=await fetch("https://backend.wplace.live/me",{credentials:"include"});if(!r.ok)return console.error(`Failed to get charges: HTTP ${r.status}`),t;let s=await r.json();return{charges:((a=s.charges)==null?void 0:a.count)??0,max:((n=s.charges)==null?void 0:n.max)??1,cooldown:((i=s.charges)==null?void 0:i.cooldownMs)??f.COOLDOWN_DEFAULT}}catch(r){return console.error("Failed to get charges:",r),t}}},We={pollTimer:null,pollIntervalMs:6e4,icon(){let t=document.querySelector("link[rel~='icon']");return(t==null?void 0:t.href)||location.origin+"/favicon.ico"},async requestPermission(){if(!("Notification"in window))return o.showAlert(o.t("notificationsNotSupported"),"warning"),"denied";if(Notification.permission==="granted")return"granted";try{return await Notification.requestPermission()}catch{return Notification.permission}},canNotify(){return e.notificationsEnabled&&typeof Notification<"u"&&Notification.permission==="granted"},notify(t,a,n="wplace-charges",i=!1){if(!this.canNotify()||!i&&e.notifyOnlyWhenUnfocused&&document.hasFocus())return!1;try{return new Notification(t,{body:a,tag:n,renotify:!0,icon:this.icon(),badge:this.icon(),silent:!1}),!0}catch{return o.showAlert(a,"info"),!1}},resetEdgeTracking(){e._lastChargesBelow=e.displayCharges<e.cooldownChargeThreshold,e._lastChargesNotifyAt=0},maybeNotifyChargesReached(t=!1){if(!e.notificationsEnabled||!e.notifyOnChargesReached)return;let a=e.displayCharges>=e.cooldownChargeThreshold,n=Date.now(),i=Math.max(1,Number(e.notificationIntervalMinutes||5))*6e4;if(a){let r=e._lastChargesBelow||t,s=n-(e._lastChargesNotifyAt||0)>=i;if(r||s){let p=o.t("chargesReadyMessage",{current:e.displayCharges,max:e.maxCharges,threshold:e.cooldownChargeThreshold});this.notify(o.t("chargesReadyNotification"),p,"wplace-notify-charges"),e._lastChargesNotifyAt=n}e._lastChargesBelow=!1}else e._lastChargesBelow=!0},startPolling(){this.stopPolling(),!(!e.notificationsEnabled||!e.notifyOnChargesReached)&&(this.pollTimer=setInterval(async()=>{try{let{charges:t,cooldown:a,max:n}=await Ta.getCharges();e.displayCharges=Math.floor(t),e.cooldown=a,e.maxCharges=Math.max(1,Math.floor(n)),this.maybeNotifyChargesReached()}catch{}},this.pollIntervalMs))},stopPolling(){this.pollTimer&&(clearInterval(this.pollTimer),this.pollTimer=null)},syncFromState(){this.resetEdgeTracking(),e.notificationsEnabled&&e.notifyOnChargesReached?this.startPolling():this.stopPolling()}},_e=new Map,$=()=>{},Ne=t=>{},lt=()=>{};function kt(){var a;e.activeColorPalette=[];let t=document.querySelectorAll(".wplace-color-swatch.active");t&&t.forEach(n=>{let i=n.getAttribute("data-rgb");if(i){let r=i.split(",").map(Number);e.activeColorPalette.push(r)}}),((a=document.querySelector(".resize-container"))==null?void 0:a.style.display)==="block"&&fe()}function Ca(t,a=!1){let n=document.querySelectorAll(".wplace-color-swatch");n&&n.forEach(i=>{let r=i.classList.contains("unavailable");(!r||a)&&(r||i.classList.toggle("active",t))}),kt()}function nn(){let t=document.querySelectorAll(".wplace-color-swatch");t&&t.forEach(a=>{let n=parseInt(a.getAttribute("data-color-id"),10);!isNaN(n)&&n>=32&&a.classList.toggle("active",!1)}),kt()}function on(t){var r,s,p;let a=t.querySelector("#colors-container"),n=t.querySelector("#showAllColorsToggle");if(!a)return;if(!e.availableColors||e.availableColors.length===0){a.innerHTML=`<div class="wplace-colors-placeholder">${o.t("uploadImageFirst")}</div>`;return}function i(g=!1){a.innerHTML="";let c=0,d=0;Object.values(f.COLOR_MAP).filter(v=>v.rgb!==null).forEach(v=>{let{id:u,name:T,rgb:m}=v,w=`${m.r},${m.g},${m.b}`;d++;let y=e.availableColors.some(W=>W.rgb[0]===m.r&&W.rgb[1]===m.g&&W.rgb[2]===m.b);if(!g&&!y)return;y&&c++;let S=o.createElement("div",{className:"wplace-color-item"}),I=o.createElement("button",{className:`wplace-color-swatch ${y?"":"unavailable"}`,title:`${T} (ID: ${u})${y?"":" (Unavailable)"}`,"data-rgb":w,"data-color-id":u});I.style.backgroundColor=`rgb(${m.r}, ${m.g}, ${m.b})`,y?I.classList.add("active"):(I.style.opacity="0.4",I.style.filter="grayscale(50%)",I.disabled=!0);let A=o.createElement("span",{className:"wplace-color-item-name",style:y?"":"color: #888; font-style: italic;"},T+(y?"":" (N/A)"));y&&I.addEventListener("click",()=>{I.classList.toggle("active"),kt()}),S.appendChild(I),S.appendChild(A),a.appendChild(S)}),kt()}i(!1),n&&n.addEventListener("change",g=>{i(g.target.checked)}),(r=t.querySelector("#selectAllBtn"))==null||r.addEventListener("click",()=>Ca(!0,n==null?void 0:n.checked)),(s=t.querySelector("#unselectAllBtn"))==null||s.addEventListener("click",()=>Ca(!1,n==null?void 0:n.checked)),(p=t.querySelector("#unselectPaidBtn"))==null||p.addEventListener("click",()=>nn())}async function Jt(){let t=performance.now();if(e.tokenSource==="manual")return console.log("\u{1F3AF} Manual token source selected - using pixel placement automation"),await St();try{let{sitekey:a,token:n}=await o.obtainSitekeyAndToken();if(!a)throw new Error("No valid sitekey found");console.log("\u{1F511} Generating Turnstile token for sitekey:",a),console.log("\u{1F9ED} UA:",navigator.userAgent.substring(0,50)+"...","Platform:",navigator.platform),window.turnstile||await o.loadTurnstile();let i=null;if(n&&typeof n=="string"&&n.length>20?(console.log("\u267B\uFE0F Reusing pre-generated token from sitekey detection phase"),i=n):ot()?(console.log("\u267B\uFE0F Using existing cached token (from previous operation)"),i=be):(console.log("\u{1F510} No valid pre-generated or cached token, creating new one..."),i=await o.executeTurnstile(a,"paint"),i&&Je(i)),console.log(`\u{1F50D} Token received - Type: ${typeof i}, Value: ${i?typeof i=="string"?i.length>50?i.substring(0,50)+"...":i:JSON.stringify(i):"null/undefined"}, Length: ${(i==null?void 0:i.length)||0}`),typeof i=="string"&&i.length>20){let r=Math.round(performance.now()-t);return console.log(`\u2705 Turnstile token generated successfully in ${r}ms`),i}else throw new Error(`Invalid or empty token received - Type: ${typeof i}, Value: ${JSON.stringify(i)}, Length: ${(i==null?void 0:i.length)||0}`)}catch(a){let n=Math.round(performance.now()-t);if(console.error(`\u274C Turnstile token generation failed after ${n}ms:`,a),e.tokenSource==="hybrid")return console.log("\u{1F504} Hybrid mode: Generator failed, automatically switching to manual pixel placement..."),await St();throw a}}async function St(){return new Promise(async(t,a)=>{try{Re||(it=new Promise(r=>{Re=r}));let n=o.sleep(2e4).then(()=>a(new Error("Auto-CAPTCHA timed out."))),i=(async()=>{let r=await o.waitForSelector("button.btn.btn-primary.btn-lg, button.btn-primary.sm\\:btn-xl",200,1e4);if(!r)throw new Error("Could not find the main paint button.");r.click(),await o.sleep(500);let s=await o.waitForSelector("button#color-0",200,5e3);if(!s)throw new Error("Could not find the transparent color button.");s.click(),await o.sleep(500);let p=await o.waitForSelector("canvas",200,5e3);if(!p)throw new Error("Could not find the canvas element.");p.setAttribute("tabindex","0"),p.focus();let g=p.getBoundingClientRect(),c=Math.round(g.left+g.width/2),d=Math.round(g.top+g.height/2);p.dispatchEvent(new MouseEvent("mousemove",{clientX:c,clientY:d,bubbles:!0})),p.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",bubbles:!0})),await o.sleep(50),p.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",bubbles:!0})),await o.sleep(500),await o.sleep(800),(async()=>{for(;!be;){let u=await o.waitForSelector("button.btn.btn-primary.btn-lg, button.btn.btn-primary.sm\\:btn-xl");if(!u){let T=Array.from(document.querySelectorAll("button.btn-primary"));u=T.length?T[T.length-1]:null}u&&u.click(),await o.sleep(500)}})();let v=await it;await o.sleep(300),t(v)})();await Promise.race([i,n])}catch(n){console.error("Auto-CAPTCHA process failed:",n),a(n)}})}async function Zt(){var Ra,Na;await an();let t=document.getElementById("wplace-image-bot-container"),a=document.getElementById("wplace-stats-container"),n=document.getElementById("wplace-settings-container"),i=document.querySelector(".resize-container"),r=document.querySelector(".resize-overlay");t&&t.remove(),a&&a.remove(),n&&n.remove(),i&&i.remove(),r&&r.remove(),va(),await Ja();let s=ba();Ht();function p(b,E={}){if(Array.from(document.head.querySelectorAll("link")).some(K=>K.href===b))return;let O=document.createElement("link");O.rel="stylesheet",O.href=b;for(let[K,Y]of Object.entries(E))O.setAttribute(K,Y);document.head.appendChild(O)}p("https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css"),s.fontFamily.includes("Press Start 2P")&&p("https://fonts.googleapis.com/css2?family=Press+Start+2P&display=swap");let g=document.createElement("style");g.textContent=Ya,g.setAttribute("data-wplace-theme","true"),document.head.appendChild(g);let c=document.createElement("div");c.id="wplace-image-bot-container",c.innerHTML=`
    ...
    `;let l=document.createElement("div");l.id="wplace-settings-container";let v=s.primary?`linear-gradient(135deg, ${s.primary} 0%, ${s.secondary||s.primary} 100%)`:"linear-gradient(135deg, #667eea 0%, #764ba2 100%)";l.className="wplace-settings-container-base",l.style.background=v,l.style.cssText+=`
      min-width: 420px;
      max-width: 480px;
      z-index: 99999;
      color: ${s.text||"white"};
        ...
        <div class="wplace-settings-section">
          ...
          <div id="pixelFilterControls" class="wplace-settings-section-wrapper wplace-pixel-filter-controls">
            ...
            <label class="wplace-settings-toggle">
              <div>
                <span class="wplace-settings-toggle-title" style="color: ${s.text||"white"};">
              ...
              <input type="checkbox" id="settingsPaintWhiteToggle" ${e.paintWhitePixels?"checked":""} 
                ...
                style="accent-color: ${s.highlight||"#48dbfb"};"/>
            </label>
        ...
        <div class="wplace-settings-section">
          ...
          <div id="normalBatchControls" class="wplace-batch-controls wplace-normal-batch-controls">
            <div class="wplace-speed-slider-container">
              ...
              <div id="speedValue" class="wplace-speed-value">${f.PAINTING_SPEED.DEFAULT} (batch size)</div>
            </div>
    ...
    `;let u=document.createElement("div");u.className="resize-container",u.innerHTML=`
      <h3 class="resize-dialog-title" style="color: ${s.text}">${o.t("resizeImage")}</h3>
...
Progress: ${b.state.paintedPixels}/${b.state.totalPixels} pixels`)&&(o.restoreProgress(b)?($("dataLoaded","success"),o.showAlert(o.t("dataLoaded"),"success"),lt(),Ne(),o.restoreOverlayFromData().catch(O=>{console.error("Failed to restore overlay from localStorage:",O)}),e.colorsChecked?(m.disabled=!1,y.disabled=!1):m.disabled=!1,e.imageLoaded&&e.startPosition&&e.region&&e.colorsChecked&&(S.disabled=!1)):o.showAlert(o.t("errorLoadingProgress"),"error"))}),G&&G.addEventListener("click",()=>{o.saveProgressToFile()?($("fileSaved","success"),o.showAlert(o.t("fileSaved"),"success")):o.showAlert(o.t("fileError"),"error")}),J&&J.addEventListener("click",async()=>{if(!e.initialSetupComplete){o.showAlert(o.t("pleaseWaitFileSetup"),"warning");return}try{await o.loadProgressFromFile()&&($("fileLoaded","success"),o.showAlert(o.t("fileLoaded"),"success"),lt(),await Ne(),await o.restoreOverlayFromData().catch(E=>{console.error("Failed to restore overlay from file:",E)}),e.colorsChecked?(m.disabled=!1,y.disabled=!1,w.disabled=!1):m.disabled=!1,e.imageLoaded&&e.startPosition&&e.region&&e.colorsChecked&&(S.disabled=!1))}catch(b){b.message==="Invalid JSON file"?o.showAlert(o.t("invalidFileFormat"),"error"):o.showAlert(o.t("fileError"),"error")}}),$=(b,E="default",B={},O=!1)=>{let K=o.t(b,B);Te.textContent=K,Te.className=`wplace-status status-${E}`,O||(Te.style.animation="none",Te.offsetWidth,Te.style.animation="slide-in 0.3s ease-out")};function Ba(b){let E=document.getElementById("wplace-stat-charges-value"),B=document.getElementById("wplace-stat-fullcharge-value");if(!B&&!E)return;if(!e.fullChargeData){B.textContent="--:--:--";return}let{current:O,max:K,cooldownMs:Y,startTime:ge,spentSinceShot:he}=e.fullChargeData,ce=(Date.now()-ge)/Y,ne=O+ce-he,H=Math.min(ne,K),ue;H-Math.floor(H)>=.95?ue=Math.ceil(H):ue=Math.floor(H),e.displayCharges=Math.max(0,ue),e.preciseCurrentCharges=H;let De=Qt(H,K,e.cooldown,b),pe=o.msToTimeText(De);E&&(E.innerHTML=`${e.displayCharges} / ${e.maxCharges}`),e.displayCharges<e.cooldownChargeThreshold&&!e.stopFlag&&e.running&&rn(b),B&&(e.displayCharges>=K?B.innerHTML='<span style="color:#10b981;">FULL</span>':B.innerHTML=`
        ...
        `}let H="";e.availableColors=e.availableColors.filter(L=>L.name!=="Unknown CoIor NaN"&&L.id!==null);let ue=o.extractAvailableColors(),ke=Array.isArray(ue)?ue.length:0;if(ke===0&&b)o.showAlert(o.t("noColorsFound"),"warning");else if(ke>0&&e.availableColors.length<ke){let L=e.availableColors.length;o.showAlert(o.t("colorsUpdated",{oldCount:L,newCount:ke,diffCount:ke-L}),"success"),e.availableColors=ue}e.colorsChecked&&(H=e.availableColors.map(L=>`<div class="wplace-stat-color-swatch" style="background-color: ${`rgb(${L.rgb.join(",")})`};" title="${o.t("colorTooltip",{id:L.id,rgb:L.rgb.join(", ")})}"></div>`).join("")),ct.innerHTML=`
            ...
            `:""}
        `,Ba(ce)},lt=()=>{let b=e.imageLoaded&&e.imageData;A.disabled=!b,G.disabled=!b},lt();function yn(b){var Ga;let E=b,B,O;if((Ga=e.originalImage)!=null&&Ga.dataUrl)E=new Kt(e.originalImage.dataUrl),B=e.originalImage.width,O=e.originalImage.height;else{let h=b.getDimensions();B=h.width,O=h.height}let K=B/O,Y=e.resizeSettings;Me.max=B*2,Ae.max=O*2;let ge=B,he=O;Y&&Number.isFinite(Y.width)&&Number.isFinite(Y.height)&&Y.width>0&&Y.height>0&&(ge=Y.width,he=Y.height),ge=Math.max(parseInt(Me.min,10)||10,Math.min(ge,parseInt(Me.max,10))),he=Math.max(parseInt(Ae.min,10)||10,Math.min(he,parseInt(Ae.max,10))),Me.value=ge,Ae.value=he,Ia.textContent=ge,Ea.textContent=he,$e.value=1,Pt&&(Pt.textContent="100%"),Aa.checked=e.paintWhitePixels,za.checked=e.paintTransparentPixels;let se=null,ce=0,ne=!1,H=1,ue=null,ke=null,De=h=>((!ue||ue.length!==h*3)&&(ue=new Float32Array(h*3)),(!ke||ke.length!==h)&&(ke=new Uint8Array(h)),{work:ue,eligible:ke}),pe=null,L=null,D=null,N=()=>{D={minX:1/0,minY:1/0,maxX:-1,maxY:-1}},Ge=(h,x)=>{D||N(),h<D.minX&&(D.minX=h),x<D.minY&&(D.minY=x),h>D.maxX&&(D.maxX=h),x>D.maxY&&(D.maxY=x)},It=()=>{if(!D||D.maxX<D.minX||D.maxY<D.minY)return;let h=Math.max(0,D.minX),x=Math.max(0,D.minY),k=Math.min(ve.width-h,D.maxX-h+1),C=Math.min(ve.height-x,D.maxY-x+1);k>0&&C>0&&qe.putImageData(pe,0,0,h,x,k,C),N()},st=(h,x,k=!1)=>{if((!pe||pe.width!==h||pe.height!==x)&&(pe=qe.createImageData(h,x),L=pe.data,k=!0),k){let C=e.resizeIgnoreMask,P=L;if(P.fill(0),C){for(let M=0;M<C.length;M++)if(C[M]){let te=M*4;P[te]=255,P[te+1]=0,P[te+2]=0,P[te+3]=150}}qe.putImageData(pe,0,0),N()}},Et=(h,x)=>{(!e.resizeIgnoreMask||e.resizeIgnoreMask.length!==h*x)&&(e.resizeIgnoreMask=new Uint8Array(h*x)),V.width=h,V.height=x,ve.width=h,ve.height=x,qe.clearRect(0,0,ve.width,ve.height),st(h,x,!0)};fe=async()=>{let h=++ce,x=parseInt(Me.value,10),k=parseInt(Ae.value,10);if(H=parseFloat($e.value),Ia.textContent=x,Ea.textContent=k,Et(x,k),mt.style.width=x+"px",mt.style.height=k+"px",tt.imageSmoothingEnabled=!1,!e.availableColors||e.availableColors.length===0){E!==b&&(!E.img||!E.canvas)&&await E.load(),tt.clearRect(0,0,x,k),tt.drawImage(E.img,0,0,x,k),qe.clearRect(0,0,ve.width,ve.height),pe&&qe.putImageData(pe,0,0),la();return}E!==b&&(!E.img||!E.canvas)&&await E.load(),tt.clearRect(0,0,x,k),tt.drawImage(E.img,0,0,x,k);let C=tt.getImageData(0,0,x,k),P=C.data,M=e.customTransparencyThreshold||f.TRANSPARENCY_THRESHOLD,te=()=>{let z=x,_=k,le=z*_,{work:R,eligible:X}=De(le);for(let U=0;U<_;U++)for(let de=0;de<z;de++){let ae=U*z+de,Se=ae*4,Ie=P[Se],Q=P[Se+1],ie=P[Se+2],oe=P[Se+3],we=(e.paintTransparentPixels||oe>=M)&&(e.paintWhitePixels||!o.isWhitePixel(Ie,Q,ie));X[ae]=we?1:0,R[ae*3]=Ie,R[ae*3+1]=Q,R[ae*3+2]=ie,we||(P[Se+3]=0)}let F=(U,de,ae,Se,Ie,Q)=>{if(U<0||U>=z||de<0||de>=_)return;let ie=de*z+U;if(!X[ie])return;let oe=ie*3;R[oe]=Math.min(255,Math.max(0,R[oe]+ae*Q)),R[oe+1]=Math.min(255,Math.max(0,R[oe+1]+Se*Q)),R[oe+2]=Math.min(255,Math.max(0,R[oe+2]+Ie*Q))};for(let U=0;U<_;U++)for(let de=0;de<z;de++){let ae=U*z+de;if(!X[ae])continue;let Se=ae*3,Ie=R[Se],Q=R[Se+1],ie=R[Se+2],[oe,we,Le]=o.findClosestPaletteColor(Ie,Q,ie,e.activeColorPalette),Ee=ae*4;P[Ee]=oe,P[Ee+1]=we,P[Ee+2]=Le,P[Ee+3]=255;let ze=Ie-oe,Ce=Q-we,Ke=ie-Le;F(de+1,U,ze,Ce,Ke,7/16),F(de-1,U+1,ze,Ce,Ke,3/16),F(de,U+1,ze,Ce,Ke,5/16),F(de+1,U+1,ze,Ce,Ke,1/16)}};if(e.ditheringEnabled&&!ne)te();else for(let z=0;z<P.length;z+=4){let _=P[z],le=P[z+1],R=P[z+2],X=P[z+3];if(!e.paintTransparentPixels&&X<M||!e.paintWhitePixels&&o.isWhitePixel(_,le,R)){P[z+3]=0;continue}let[F,U,de]=o.findClosestPaletteColor(_,le,R,e.activeColorPalette);P[z]=F,P[z+1]=U,P[z+2]=de,P[z+3]=255}h===ce&&(tt.putImageData(C,0,0),qe.clearRect(0,0,ve.width,ve.height),pe&&qe.putImageData(pe,0,0),la())};let Mt=()=>{Ma.checked&&(Ae.value=Math.round(parseInt(Me.value,10)/K)),fe();let h=parseInt(Me.value,10),x=parseInt(Ae.value,10);e.resizeSettings={baseWidth:B,baseHeight:O,width:h,height:x},q();let k=typeof Ye=="function"?Ye():1;!isNaN(k)&&isFinite(k)&&Oe(k)},At=()=>{Ma.checked&&(Me.value=Math.round(parseInt(Ae.value,10)*K)),fe();let h=parseInt(Me.value,10),x=parseInt(Ae.value,10);e.resizeSettings={baseWidth:B,baseHeight:O,width:h,height:x},q();let k=typeof Ye=="function"?Ye():1;!isNaN(k)&&isFinite(k)&&Oe(k)};Aa.onchange=h=>{e.paintWhitePixels=h.target.checked,fe(),q()},za.onchange=h=>{e.paintTransparentPixels=h.target.checked,fe(),q()};let ye=0,j=0,kn=()=>{let h=(me==null?void 0:me.getBoundingClientRect())||{width:0,height:0},x=(V.width||1)*H,k=(V.height||1)*H;if(x<=h.width)ye=Math.floor((h.width-x)/2);else{let C=h.width-x;ye=Math.min(0,Math.max(C,ye))}if(k<=h.height)j=Math.floor((h.height-k)/2);else{let C=h.height-k;j=Math.min(0,Math.max(C,j))}},sa=0,zt=()=>{sa||(sa=requestAnimationFrame(()=>{kn(),mt.style.transform=`translate3d(${Math.round(ye)}px, ${Math.round(j)}px, 0) scale(${H})`,sa=0}))},la=()=>{let h=V.width||1,x=V.height||1;V.style.width=h+"px",V.style.height=x+"px",ve.style.width=h+"px",ve.style.height=x+"px",mt.style.width=h+"px",mt.style.height=x+"px",zt()},Oe=h=>{H=Math.max(.05,Math.min(20,h||1)),$e.value=H,la(),Pt&&(Pt.textContent=`${Math.round(H*100)}%`)};$e.addEventListener("input",()=>{Oe(parseFloat($e.value))}),gt&&gt.addEventListener("click",()=>Oe(parseFloat($e.value)+.1)),ht&&ht.addEventListener("click",()=>Oe(parseFloat($e.value)-.1));let Ye=()=>{let h=me==null?void 0:me.getBoundingClientRect();if(!h)return 1;let x=V.width||1,k=V.height||1,C=10,P=(h.width-C)/x,M=(h.height-C)/k;return Math.max(.05,Math.min(20,Math.min(P,M)))};Da&&Da.addEventListener("click",()=>{Oe(Ye()),wt()}),La&&La.addEventListener("click",()=>{Oe(1),wt()});let wt=()=>{if(!me)return;let h=me.getBoundingClientRect(),x=(V.width||1)*H,k=(V.height||1)*H;ye=Math.floor((h.width-x)/2),j=Math.floor((h.height-k)/2),zt()},Ve=!1,Dt=0,Lt=0,Bt=0,Ot=0,Xe=!1,at=!1,Sn=h=>h.button===1||h.button===2,nt=h=>{me&&(me.style.cursor=h)},Tn=h=>at||Xe||Sn(h),Fa=()=>{ut&&(ut.classList.toggle("active",at),ut.setAttribute("aria-pressed",at?"true":"false"))};if(ut&&(Fa(),ut.addEventListener("click",()=>{at=!at,Fa(),nt(at?"grab":"")})),me){me.addEventListener("contextmenu",C=>{Xe&&C.preventDefault()}),window.addEventListener("keydown",C=>{C.code==="Space"&&(Xe=!0,nt("grab"))}),window.addEventListener("keyup",C=>{C.code==="Space"&&(Xe=!1,Ve||nt(""))}),me.addEventListener("mousedown",C=>{Tn(C)&&(C.preventDefault(),Ve=!0,Dt=C.clientX,Lt=C.clientY,Bt=ye,Ot=j,nt("grabbing"))}),window.addEventListener("mousemove",C=>{if(!Ve)return;let P=C.clientX-Dt,M=C.clientY-Lt;ye=Bt+P,j=Ot+M,zt()}),window.addEventListener("mouseup",()=>{Ve&&(Ve=!1,nt(Xe?"grab":""))}),me.addEventListener("wheel",C=>{if(!C.ctrlKey&&!C.metaKey)return;C.preventDefault();let P=me.getBoundingClientRect(),M=C.clientX-P.left-ye,te=C.clientY-P.top-j,z=H,_=Math.max(.05,Math.min(.5,Math.abs(C.deltaY)>20?.2:.1)),le=Math.max(.05,Math.min(20,z+(C.deltaY>0?-_:_)));if(le===z)return;let R=le/z;ye=ye-M*(R-1),j=j-te*(R-1),Oe(le)},{passive:!1});let h=null,x=0,k=null;me.addEventListener("touchstart",C=>{if(C.touches.length===1){let P=C.touches[0];Ve=!0,Dt=P.clientX,Lt=P.clientY,Bt=ye,Ot=j,nt("grabbing");let M=Date.now();if(M-x<300){let te=Math.abs(H-1)<.01?Ye():1;Oe(te),wt(),k&&clearTimeout(k)}else x=M,k=setTimeout(()=>{k=null},320)}else if(C.touches.length===2){let[P,M]=C.touches;h=Math.hypot(M.clientX-P.clientX,M.clientY-P.clientY)}},{passive:!0}),me.addEventListener("touchmove",C=>{if(C.touches.length===1&&Ve){let P=C.touches[0],M=P.clientX-Dt,te=P.clientY-Lt;ye=Bt+M,j=Ot+te,zt()}else if(C.touches.length===2&&h!=null){C.preventDefault();let[P,M]=C.touches,te=Math.hypot(M.clientX-P.clientX,M.clientY-P.clientY),z=me.getBoundingClientRect(),_=(P.clientX+M.clientX)/2-z.left-ye,le=(P.clientY+M.clientY)/2-z.top-j,R=H,X=te/(h||te),F=Math.max(.05,Math.min(20,R*X));F!==R&&(ye=ye-_*(F/R-1),j=j-le*(F/R-1),Oe(F)),h=te}},{passive:!1}),me.addEventListener("touchend",()=>{Ve=!1,h=null,nt(at||Xe?"grab":"")})}let ca=()=>{se&&clearTimeout(se);let h=()=>{se=null,fe()};window.requestIdleCallback?se=setTimeout(()=>requestIdleCallback(h,{timeout:150}),50):se=setTimeout(()=>requestAnimationFrame(h),50)},$a=()=>{ne=!0},Wa=()=>{ne=!1,ca()};Me.addEventListener("pointerdown",$a),Ae.addEventListener("pointerdown",$a),Me.addEventListener("pointerup",Wa),Ae.addEventListener("pointerup",Wa),Me.addEventListener("input",()=>{Mt(),ca()}),Ae.addEventListener("input",()=>{At(),ca()});let Rt=!1,Cn=-1,Pn=-1,Nt=1,ft=1,je="ignore",bt=u.querySelector("#maskBrushSize"),da=u.querySelector("#maskBrushSizeValue"),pa=u.querySelector("#maskModeIgnore"),ga=u.querySelector("#maskModeUnignore"),ha=u.querySelector("#maskModeToggle"),_a=u.querySelector("#clearIgnoredBtn"),Ua=u.querySelector("#invertMaskBtn"),vt=u.querySelector("#rowColSize"),ua=u.querySelector("#rowColSizeValue"),Ha=()=>{let h=[[pa,"ignore"],[ga,"unignore"],[ha,"toggle"]];for(let[x,k]of h){if(!x)continue;let C=je===k;x.classList.toggle("active",C),x.setAttribute("aria-pressed",C?"true":"false")}},ma=h=>{je=h,Ha()};bt&&da&&(bt.addEventListener("input",()=>{Nt=parseInt(bt.value,10)||1,da.textContent=Nt}),da.textContent=bt.value,Nt=parseInt(bt.value,10)||1),vt&&ua&&(vt.addEventListener("input",()=>{ft=parseInt(vt.value,10)||1,ua.textContent=ft}),ua.textContent=vt.value,ft=parseInt(vt.value,10)||1),pa&&pa.addEventListener("click",()=>ma("ignore")),ga&&ga.addEventListener("click",()=>ma("unignore")),ha&&ha.addEventListener("click",()=>ma("toggle")),Ha();let In=(h,x)=>{let k=V.getBoundingClientRect(),C=k.width/V.width,P=k.height/V.height,M=(h-k.left)/C,te=(x-k.top)/P,z=Math.floor(M),_=Math.floor(te);return{x:z,y:_}},wa=(h,x)=>{(!e.resizeIgnoreMask||e.resizeIgnoreMask.length!==h*x)&&(e.resizeIgnoreMask=new Uint8Array(h*x))},En=(h,x,k,C)=>{let P=V.width,M=V.height;wa(P,M);let te=k*k;for(let z=x-k;z<=x+k;z++)if(!(z<0||z>=M))for(let _=h-k;_<=h+k;_++){if(_<0||_>=P)continue;let le=_-h,R=z-x;if(le*le+R*R<=te){let X=z*P+_,F=e.resizeIgnoreMask[X];if(je==="toggle"?F=F?0:1:je==="ignore"?F=1:F=0,e.resizeIgnoreMask[X]=F,L){let U=X*4;F?(L[U]=255,L[U+1]=0,L[U+2]=0,L[U+3]=150):(L[U]=0,L[U+1]=0,L[U+2]=0,L[U+3]=0),Ge(_,z)}}}},Mn=(h,x)=>{let k=V.width,C=V.height;if(wa(k,C),h<0||h>=C)return;let P=Math.floor(ft/2),M=Math.max(0,h-P),te=Math.min(C-1,h+P);for(let z=M;z<=te;z++){for(let _=0;_<k;_++){let le=z*k+_,R=e.resizeIgnoreMask[le];if(je==="toggle"?R=R?0:1:je==="ignore"?R=1:R=0,e.resizeIgnoreMask[le]=R,L){let X=le*4;R?(L[X]=255,L[X+1]=0,L[X+2]=0,L[X+3]=150):(L[X]=0,L[X+1]=0,L[X+2]=0,L[X+3]=0)}}L&&(Ge(0,z),Ge(k-1,z))}},An=(h,x)=>{let k=V.width,C=V.height;if(wa(k,C),h<0||h>=k)return;let P=Math.floor(ft/2),M=Math.max(0,h-P),te=Math.min(k-1,h+P);for(let z=M;z<=te;z++){for(let _=0;_<C;_++){let le=_*k+z,R=e.resizeIgnoreMask[le];if(je==="toggle"?R=R?0:1:je==="ignore"?R=1:R=0,e.resizeIgnoreMask[le]=R,L){let X=le*4;R?(L[X]=255,L[X+1]=0,L[X+2]=0,L[X+3]=150):(L[X]=0,L[X+1]=0,L[X+2]=0,L[X+3]=0)}}L&&(Ge(z,0),Ge(z,C-1))}},zn=()=>{It()},qa=h=>{if((h.buttons&4)===4||(h.buttons&2)===2||Xe)return;let{x,y:k}=In(h.clientX,h.clientY),C=V.width,P=V.height;if(x<0||k<0||x>=C||k>=P)return;let M=Math.max(1,Math.floor(Nt/2));h.shiftKey?Mn(k):h.altKey?An(x):En(x,k,M),Cn=x,Pn=k,zn()};ve.addEventListener("mousedown",h=>{h.button===1||h.button===2||Xe||(Rt=!0,qa(h))}),ve.addEventListener("touchstart",h=>{},{passive:!0}),ve.addEventListener("touchmove",h=>{},{passive:!0}),ve.addEventListener("touchend",h=>{},{passive:!0}),window.addEventListener("mousemove",h=>{Rt&&qa(h)}),window.addEventListener("mouseup",()=>{Rt&&(Rt=!1,q())}),_a&&_a.addEventListener("click",()=>{let h=V.width,x=V.height;e.resizeIgnoreMask&&e.resizeIgnoreMask.fill(0),st(h,x,!0),fe(),q()}),Ua&&Ua.addEventListener("click",()=>{if(!e.resizeIgnoreMask)return;for(let k=0;k<e.resizeIgnoreMask.length;k++)e.resizeIgnoreMask[k]=e.resizeIgnoreMask[k]?0:1;let h=V.width,x=V.height;st(h,x,!0),fe(),q()}),un.onclick=async()=>{let h=parseInt(Me.value,10),x=parseInt(Ae.value,10),k=document.createElement("canvas"),C=k.getContext("2d");k.width=h,k.height=x,C.imageSmoothingEnabled=!1,E!==b&&(!E.img||!E.canvas)&&await E.load(),C.drawImage(E.img,0,0,h,x);let P=C.getImageData(0,0,h,x),M=P.data,te=e.customTransparencyThreshold||f.TRANSPARENCY_THRESHOLD,z=0,_=e.resizeIgnoreMask&&e.resizeIgnoreMask.length===h*x?e.resizeIgnoreMask:null,le=async()=>{let F=h,U=x,de=F*U,{work:ae,eligible:Se}=De(de);for(let Q=0;Q<U;Q++){for(let ie=0;ie<F;ie++){let oe=Q*F+ie,we=oe*4,Le=M[we],Ee=M[we+1],ze=M[we+2],Ce=M[we+3],yt=!(_&&_[oe])&&(e.paintTransparentPixels||Ce>=te)&&(e.paintWhitePixels||!o.isWhitePixel(Le,Ee,ze));Se[oe]=yt?1:0,ae[oe*3]=Le,ae[oe*3+1]=Ee,ae[oe*3+2]=ze,yt||(M[we+3]=0)}Q&15||await Promise.resolve()}let Ie=(Q,ie,oe,we,Le,Ee)=>{if(Q<0||Q>=F||ie<0||ie>=U)return;let ze=ie*F+Q;if(!Se[ze])return;let Ce=ze*3;ae[Ce]=Math.min(255,Math.max(0,ae[Ce]+oe*Ee)),ae[Ce+1]=Math.min(255,Math.max(0,ae[Ce+1]+we*Ee)),ae[Ce+2]=Math.min(255,Math.max(0,ae[Ce+2]+Le*Ee))};for(let Q=0;Q<U;Q++){for(let ie=0;ie<F;ie++){let oe=Q*F+ie;if(!Se[oe])continue;let we=oe*3,Le=ae[we],Ee=ae[we+1],ze=ae[we+2],[Ce,Ke,yt]=o.findClosestPaletteColor(Le,Ee,ze,e.activeColorPalette),Ft=oe*4;M[Ft]=Ce,M[Ft+1]=Ke,M[Ft+2]=yt,M[Ft+3]=255,z++;let $t=Le-Ce,Wt=Ee-Ke,_t=ze-yt;Ie(ie+1,Q,$t,Wt,_t,7/16),Ie(ie-1,Q+1,$t,Wt,_t,3/16),Ie(ie,Q+1,$t,Wt,_t,5/16),Ie(ie+1,Q+1,$t,Wt,_t,1/16)}await Promise.resolve()}};if(e.ditheringEnabled)await le();else for(let F=0;F<M.length;F+=4){let U=M[F],de=M[F+1],ae=M[F+2],Se=M[F+3],Ie=_&&_[F>>2],Q=!e.paintTransparentPixels&&Se<te||Ie,ie=!e.paintWhitePixels&&o.isWhitePixel(U,de,ae);if(Q||ie){M[F+3]=0;continue}z++;let[oe,we,Le]=o.findClosestPaletteColor(U,de,ae,e.activeColorPalette);M[F]=oe,M[F+1]=we,M[F+2]=Le,M[F+3]=255}C.putImageData(P,0,0);let R=new Uint8ClampedArray(P.data);e.imageData.pixels=R,e.imageData.width=h,e.imageData.height=x,e.imageData.totalPixels=z,e.totalPixels=z,e.paintedPixels=0,e.resizeSettings={baseWidth:B,baseHeight:O,width:h,height:x},q();let X=await createImageBitmap(k);await Pe.setImage(X),Pe.enable(),re.classList.add("active"),re.setAttribute("aria-pressed","true"),Ne(),$("resizeSuccess","success",{width:h,height:x}),Oa()},wn.onclick=()=>{try{let h=V.width,x=V.height,k=document.createElement("canvas");k.width=h,k.height=x;let C=k.getContext("2d");C.imageSmoothingEnabled=!1,C.drawImage(V,0,0),C.drawImage(ve,0,0);let P=document.createElement("a");P.download="wplace-preview.png",P.href=k.toDataURL(),P.click()}catch(h){console.warn("Failed to download preview:",h)}},mn.onclick=Oa,T.style.display="block",u.style.display="block",on(u),fe(),xt=()=>{try{$e.replaceWith($e.cloneNode(!0))}catch{}try{gt&&gt.replaceWith(gt.cloneNode(!0))}catch{}try{ht&&ht.replaceWith(ht.cloneNode(!0))}catch{}},setTimeout(()=>{if(typeof Ye=="function"){let h=Ye();!isNaN(h)&&isFinite(h)&&(Oe(h),wt())}else wt()},0)}function Oa(){try{typeof xt=="function"&&xt()}catch{}T.style.display="none",u.style.display="none",fe=()=>{};try{typeof cancelAnimationFrame=="function"&&_panRaf&&cancelAnimationFrame(_panRaf)}catch{}try{_previewTimer&&(clearTimeout(_previewTimer),_previewTimer=null)}catch{}_maskImageData=null,_maskData=null,_dirty=null,_ditherWorkBuf=null,_ditherEligibleBuf=null,xt=null}m&&m.addEventListener("click",async()=>{let b=o.extractAvailableColors();if(b===null||b.length<10){$("noColorsFound","error"),o.showAlert(o.t("noColorsFound"),"error");return}e.colorsChecked||(e.availableColors=b,e.colorsChecked=!0,$("colorsFound","success",{count:b.length}),Ne(),y.disabled=!1,e.imageLoaded&&(w.disabled=!1));try{$("loadingImage","default");let E=await o.createImageUploader();if(!E){$("colorsFound","success",{count:e.availableColors.length});return}let B=new Kt(E);await B.load();let{width:O,height:K}=B.getDimensions(),Y=B.getPixelData(),ge=0;for(let se=0;se<Y.length;se+=4){let ce=!e.paintTransparentPixels&&Y[se+3]<(e.customTransparencyThreshold||f.TRANSPARENCY_THRESHOLD),ne=!e.paintWhitePixels&&o.isWhitePixel(Y[se],Y[se+1],Y[se+2]);!ce&&!ne&&ge++}e.imageData={width:O,height:K,pixels:Y,totalPixels:ge,processor:B},e.totalPixels=ge,e.paintedPixels=0,e.imageLoaded=!0,e.lastPosition={x:0,y:0},o.initializePaintedMap(O,K),e.resizeSettings=null,e.resizeIgnoreMask=null,e.originalImage={dataUrl:E,width:O,height:K},q();let he=await createImageBitmap(B.img);await Pe.setImage(he),Pe.enable(),re.disabled=!1,re.classList.add("active"),re.setAttribute("aria-pressed","true"),e.colorsChecked&&(w.disabled=!1),A.disabled=!1,e.startPosition&&(S.disabled=!1),Ne(),lt(),$("imageLoaded","success",{count:ge})}catch{$("imageError","error")}}),w&&w.addEventListener("click",()=>{e.imageLoaded&&e.imageData.processor&&e.colorsChecked?yn(e.imageData.processor):e.colorsChecked||o.showAlert(o.t("uploadImageFirstColors"),"warning")}),y&&y.addEventListener("click",async()=>{if(e.selectingPosition)return;e.selectingPosition=!0,e.startPosition=null,e.region=null,S.disabled=!0,o.showAlert(o.t("selectPositionAlert"),"info"),$("waitingPosition","default");let b=async(B,O)=>{var K;if(typeof B=="string"&&B.includes("https://backend.wplace.live/s0/pixel/")&&((K=O==null?void 0:O.method)==null?void 0:K.toUpperCase())==="POST")try{let Y=await E(B,O),he=await Y.clone().json();if((he==null?void 0:he.painted)===1){let se=B.match(/\/pixel\/(\d+)\/(\d+)/);se&&se.length>=3&&(e.region={x:Number.parseInt(se[1]),y:Number.parseInt(se[2])});let ce=JSON.parse(O.body);ce!=null&&ce.coords&&Array.isArray(ce.coords)&&(e.startPosition={x:ce.coords[0],y:ce.coords[1]},e.lastPosition={x:0,y:0},await Pe.setPosition(e.startPosition,e.region),e.imageLoaded&&(S.disabled=!1),window.fetch=E,e.selectingPosition=!1,$("positionSet","success"))}return Y}catch{return E(B,O)}return E(B,O)},E=window.fetch;window.fetch=b,setTimeout(()=>{e.selectingPosition&&(window.fetch=E,e.selectingPosition=!1,$("positionTimeout","error"),o.showAlert(o.t("positionTimeout"),"error"))},12e4)});async function xn(){if(!e.imageLoaded||!e.startPosition||!e.region){$("missingRequirements","error");return}if(await ka(),!!be){e.running=!0,e.stopFlag=!1,S.disabled=!0,I.disabled=!1,m.disabled=!0,y.disabled=!0,w.disabled=!0,A.disabled=!0,re.disabled=!0,$("startPaintingMsg","success");try{await ln()}catch(b){console.error("Unexpected error:",b),$("paintingError","error")}finally{e.running=!1,I.disabled=!0,A.disabled=!1,e.stopFlag?S.disabled=!1:(S.disabled=!0,m.disabled=!1,y.disabled=!1,w.disabled=!1),re.disabled=!1}}}S&&S.addEventListener("click",xn),I&&I.addEventListener("click",()=>{e.stopFlag=!0,e.running=!1,I.disabled=!0,$("paintingStoppedByUser","warning"),e.imageLoaded&&e.paintedPixels>0&&(o.saveProgress(),o.showAlert(o.t("autoSaved"),"success"))}),setTimeout(()=>{let b=o.loadProgress();if(b&&b.state.paintedPixels>0){let E=new Date(b.timestamp).toLocaleString(),B=Math.round(b.state.paintedPixels/b.state.totalPixels*100);o.showAlert(`${o.t("savedDataFound")}

Saved: ${E}
Progress: ${b.state.paintedPixels}/${b.state.totalPixels} pixels (${B}%)
${o.t("clickLoadToContinue")}`,"info")}},1e3),et&&dt&&et.addEventListener("input",b=>{let E=parseInt(b.target.value);e.cooldownChargeThreshold=E,dt.textContent=E,q(),We.resetEdgeTracking()}),gn(),We.syncFromState()}function Qt(t,a,n,i=0){let r=a-t;return Math.max(0,r*n-i)}function rn(t){if(e.stopFlag)return;let a=e.cooldownChargeThreshold,n=Qt(e.preciseCurrentCharges,a,e.cooldown,t),i=o.msToTimeText(n);$("noChargesThreshold","warning",{threshold:a,current:e.displayCharges,time:i},!0)}function sn(t,a,n,i,r,s,p){let g=[];console.log(`Generating coordinates with 
  mode:`,n,`
  direction:`,i,`
  snake:`,r,`
  blockWidth:`,s,`
  blockHeight:`,p);let c,d,l,v,u,T;switch(i){case"top-left":c=0,d=t,l=1,v=0,u=a,T=1;break;case"top-right":c=t-1,d=-1,l=-1,v=0,u=a,T=1;break;case"bottom-left":c=0,d=t,l=1,v=a-1,u=-1,T=-1;break;case"bottom-right":c=t-1,d=-1,l=-1,v=a-1,u=-1,T=-1;break;default:throw new Error(`Unknown direction: ${i}`)}if(n==="rows")for(let m=v;m!==u;m+=T)if(r&&(m-v)%2!==0)for(let w=d-l;w!==c-l;w-=l)g.push([w,m]);else for(let w=c;w!==d;w+=l)g.push([w,m]);else if(n==="columns")for(let m=c;m!==d;m+=l)if(r&&(m-c)%2!==0)for(let w=u-T;w!==v-T;w-=T)g.push([m,w]);else for(let w=v;w!==u;w+=T)g.push([m,w]);else if(n==="circle-out"){let m=Math.floor(t/2),w=Math.floor(a/2),y=Math.ceil(Math.sqrt(m*m+w*w));for(let S=0;S<=y;S++)for(let I=w-S;I<=w+S;I++)for(let A=m-S;A<=m+S;A++)A>=0&&A<t&&I>=0&&I<a&&Math.max(Math.abs(A-m),Math.abs(I-w))===S&&g.push([A,I])}else if(n==="circle-in"){let m=Math.floor(t/2),w=Math.floor(a/2),y=Math.ceil(Math.sqrt(m*m+w*w));for(let S=y;S>=0;S--)for(let I=w-S;I<=w+S;I++)for(let A=m-S;A<=m+S;A++)A>=0&&A<t&&I>=0&&I<a&&Math.max(Math.abs(A-m),Math.abs(I-w))===S&&g.push([A,I])}else if(n==="blocks"||n==="shuffle-blocks"){let m=[];for(let w=0;w<a;w+=p)for(let y=0;y<t;y+=s){let S=[];for(let I=w;I<Math.min(w+p,a);I++)for(let A=y;A<Math.min(y+s,t);A++)S.push([A,I]);m.push(S)}if(n==="shuffle-blocks")for(let w=m.length-1;w>0;w--){let y=Math.floor(Math.random()*(w+1));[m[w],m[y]]=[m[y],m[w]]}for(let w of m)g.push(...w)}else throw new Error(`Unknown mode: ${n}`);return g}async function Tt(t){if(!t||t.pixels.length===0)return!0;let a=t.pixels.length;console.log(`\u{1F4E6} Sending batch with ${a} pixels (region: ${t.regionX},${t.regionY})`);let n=await dn(t.pixels,t.regionX,t.regionY);if(n){if(t.pixels.forEach(i=>{e.paintedPixels++,o.markPixelPainted(i.x,i.y,t.regionX,t.regionY)}),e.fullChargeData={...e.fullChargeData,spentSinceShot:e.fullChargeData.spentSinceShot+a},Ne(),$("paintingProgress","default",{painted:e.paintedPixels,total:e.totalPixels}),o.performSmartSave(),f.PAINTING_SPEED_ENABLED&&e.paintingSpeed>0&&a>0){let i=1e3/e.paintingSpeed,r=Math.max(100,i*a);await o.sleep(r)}}else console.error("\u274C Batch failed permanently after retries. Stopping painting."),e.stopFlag=!0,$("paintingBatchFailed","error");return t.pixels=[],n}async function ln(){let{width:t,height:a,pixels:n}=e.imageData,{x:i,y:r}=e.startPosition,{x:s,y:p}=e.region;if(!await Pe.waitForTiles(s,p,t,a,i,r,1e4)){$("overlayTilesNotLoaded","error"),e.stopFlag=!0;return}let c=null,d={transparent:0,white:0,alreadyPainted:0,colorUnavailable:0},l=e.customTransparencyThreshold||f.TRANSPARENCY_THRESHOLD;function v(T,m){let w=(m*t+T)*4,y=n[w],S=n[w+1],I=n[w+2],A=n[w+3];if(!e.paintTransparentPixels&&A<l)return{eligible:!1,reason:"transparent"};if(!e.paintWhitePixels&&o.isWhitePixel(y,S,I))return{eligible:!1,reason:"white"};let W=o.isWhitePixel(y,S,I)?[255,255,255]:o.findClosestPaletteColor(y,S,I,e.activeColorPalette),G=o.resolveColor(W,e.availableColors,!e.paintUnavailablePixels);return!e.paintUnavailablePixels&&!G.id?{eligible:!1,reason:"colorUnavailable",r:y,g:S,b:I,a:A,mappedColorId:G.id}:{eligible:!0,r:y,g:S,b:I,a:A,mappedColorId:G.id}}function u(T,m,w,y,S){T!=="transparent"&&console.log(`Skipped pixel for ${T} (id: ${m}, (${w.join(", ")})) at (${y}, ${S})`),d[T]++}try{let T=sn(t,a,e.coordinateMode,e.coordinateDirection,e.coordinateSnake,e.blockWidth,e.blockHeight);e:for(let[m,w]of T){if(e.stopFlag){c&&c.pixels.length>0&&(console.log(`\u{1F3AF} Sending last batch before stop with ${c.pixels.length} pixels`),await Tt(c)),e.lastPosition={x:m,y:w},$("paintingPaused","warning",{x:m,y:w});break e}let y=v(m,w),S=i+m,I=r+w,A=Math.floor(S/1e3),W=Math.floor(I/1e3),G=S%1e3,J=I%1e3,ee=y.mappedColorId;if(!y.eligible){u(y.reason,ee,[y.r,y.g,y.b],G,J);continue}if(!c||c.regionX!==s+A||c.regionY!==p+W){if(c&&c.pixels.length>0)if(console.log(`\u{1F30D} Sending region-change batch with ${c.pixels.length} pixels (switching to region ${s+A},${p+W})`),await Tt(c)){if(f.PAINTING_SPEED_ENABLED&&e.paintingSpeed>0&&c.pixels.length>0){let re=Math.max(1,100/e.paintingSpeed),Te=Math.max(100,re*c.pixels.length);await o.sleep(Te)}Ne()}else{console.error("\u274C Batch failed permanently after retries. Stopping painting."),e.stopFlag=!0,$("paintingBatchFailed","error");break e}c={regionX:s+A,regionY:p+W,pixels:[]}}try{let Z=[c.regionX,c.regionY],re=await Pe.getTilePixelColor(Z[0],Z[1],G,J);if(re&&Array.isArray(re)){let Te=o.resolveColor(re.slice(0,3),e.availableColors),Ze=Te.id===ee;if(Ze){u("alreadyPainted",ee,[y.r,y.g,y.b],G,J);continue}console.debug(`[COMPARE] Pixel at \u{1F4CD} (${G}, ${J}) in region (${s+A}, ${p+W})
