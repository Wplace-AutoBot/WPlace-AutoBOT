var WPlaceAutoBot=(()=>{var _a=`/* WPlace Auto-Image Bot - Unified CSS Styles (decoupled from JS)
...
:root {
  ...
  --wplace-slider-track-bg: linear-gradient(to right, var(--wplace-icon-primary) 0%, var(--wplace-icon-secondary) 100%);
}
...
.wplace-turnstile-title {
  font: 600 12px/1.3 'Segoe UI', sans-serif !important;
...
.wplace-icon-key { font-size: 16px; }
.wplace-icon-robot { font-size: 16px; }
.wplace-icon-speed { font-size: 16px; }
...
`,ct={"classic-light":`/* WPlace Auto-Image Bot - Classic Light Theme */
...
RGB\uFF1A{rgb}`,expandMode:"\u5C55\u958B\u6A21\u5F0F",minimize:"\u6700\u5C0F\u5316",restore:"\u6062\u5FA9",hideStats:"\u96B1\u85CF\u7D71\u8A08",paintOptions:"\u7E6A\u5716\u9078\u9805",paintWhitePixels:"\u7E6A\u88FD\u767D\u8272\u50CF\u7D20",paintTransparentPixels:"\u7E6A\u88FD\u900F\u660E\u50CF\u7D20"}};(async()=>{let y={COOLDOWN_DEFAULT:31e3,TRANSPARENCY_THRESHOLD:100,WHITE_THRESHOLD:250,LOG_INTERVAL:10,PAINTING_SPEED:{MIN:1,MAX:1e3,DEFAULT:5},BATCH_MODE:"normal",RANDOM_BATCH_RANGE:{MIN:3,MAX:20},PAINTING_SPEED_ENABLED:!1,AUTO_CAPTCHA_ENABLED:!0,TOKEN_SOURCE:"generator",COOLDOWN_CHARGE_THRESHOLD:1,NOTIFICATIONS:{ENABLED:!0,ON_CHARGES_REACHED:!0,ONLY_WHEN_UNFOCUSED:!0,REPEAT_MINUTES:5},OVERLAY:{OPACITY_DEFAULT:.6,BLUE_MARBLE_DEFAULT:!1,ditheringEnabled:!1},COLOR_MAP:{0:{id:1,name:"Black",rgb:{r:0,g:0,b:0}},1:{id:2,name:"Dark Gray",rgb:{r:60,g:60,b:60}},2:{id:3,name:"Gray",rgb:{r:120,g:120,b:120}},3:{id:4,name:"Light Gray",rgb:{r:210,g:210,b:210}},4:{id:5,name:"White",rgb:{r:255,g:255,b:255}},5:{id:6,name:"Deep Red",rgb:{r:96,g:0,b:24}},6:{id:7,name:"Red",rgb:{r:237,g:28,b:36}},7:{id:8,name:"Orange",rgb:{r:255,g:127,b:39}},8:{id:9,name:"Gold",rgb:{r:246,g:170,b:9}},9:{id:10,name:"Yellow",rgb:{r:249,g:221,b:59}},10:{id:11,name:"Light Yellow",rgb:{r:255,g:250,b:188}},11:{id:12,name:"Dark Green",rgb:{r:14,g:185,b:104}},12:{id:13,name:"Green",rgb:{r:19,g:230,b:123}},13:{id:14,name:"Light Green",rgb:{r:135,g:255,b:94}},14:{id:15,name:"Dark Teal",rgb:{r:12,g:129,b:110}},15:{id:16,name:"Teal",rgb:{r:16,g:174,b:166}},16:{id:17,name:"Light Teal",rgb:{r:19,g:225,b:190}},17:{id:20,name:"Cyan",rgb:{r:96,g:247,b:242}},18:{id:44,name:"Light Cyan",rgb:{r:187,g:250,b:242}},19:{id:18,name:"Dark Blue",rgb:{r:40,g:80,b:158}},20:{id:19,name:"Blue",rgb:{r:64,g:147,b:228}},21:{id:21,name:"Indigo",rgb:{r:107,g:80,b:246}},22:{id:22,name:"Light Indigo",rgb:{r:153,g:177,b:251}},23:{id:23,name:"Dark Purple",rgb:{r:120,g:12,b:153}},24:{id:24,name:"Purple",rgb:{r:170,g:56,b:185}},25:{id:25,name:"Light Purple",rgb:{r:224,g:159,b:249}},26:{id:26,name:"Dark Pink",rgb:{r:203,g:0,b:122}},27:{id:27,name:"Pink",rgb:{r:236,g:31,b:128}},28:{id:28,name:"Light Pink",rgb:{r:243,g:141,b:169}},29:{id:29,name:"Dark Brown",rgb:{r:104,g:70,b:52}},30:{id:30,name:"Brown",rgb:{r:149,g:104,b:42}},31:{id:31,name:"Beige",rgb:{r:248,g:178,b:119}},32:{id:52,name:"Light Beige",rgb:{r:255,g:197,b:165}},33:{id:32,name:"Medium Gray",rgb:{r:170,g:170,b:170}},34:{id:33,name:"Dark Red",rgb:{r:165,g:14,b:30}},35:{id:34,name:"Light Red",rgb:{r:250,g:128,b:114}},36:{id:35,name:"Dark Orange",rgb:{r:228,g:92,b:26}},37:{id:37,name:"Dark Goldenrod",rgb:{r:156,g:132,b:49}},38:{id:38,name:"Goldenrod",rgb:{r:197,g:173,b:49}},39:{id:39,name:"Light Goldenrod",rgb:{r:232,g:212,b:95}},40:{id:40,name:"Dark Olive",rgb:{r:74,g:107,b:58}},41:{id:41,name:"Olive",rgb:{r:90,g:148,b:74}},42:{id:42,name:"Light Olive",rgb:{r:132,g:197,b:115}},43:{id:43,name:"Dark Cyan",rgb:{r:15,g:121,b:159}},44:{id:45,name:"Light Blue",rgb:{r:125,g:199,b:255}},45:{id:46,name:"Dark Indigo",rgb:{r:77,g:49,b:184}},46:{id:47,name:"Dark Slate Blue",rgb:{r:74,g:66,b:132}},47:{id:48,name:"Slate Blue",rgb:{r:122,g:113,b:196}},48:{id:49,name:"Light Slate Blue",rgb:{r:181,g:174,b:241}},49:{id:53,name:"Dark Peach",rgb:{r:155,g:82,b:73}},50:{id:54,name:"Peach",rgb:{r:209,g:128,b:120}},51:{id:55,name:"Light Peach",rgb:{r:250,g:182,b:164}},52:{id:50,name:"Light Brown",rgb:{r:219,g:164,b:99}},53:{id:56,name:"Dark Tan",rgb:{r:123,g:99,b:82}},54:{id:57,name:"Tan",rgb:{r:156,g:132,b:107}},55:{id:36,name:"Light Tan",rgb:{r:214,g:181,b:148}},56:{id:51,name:"Dark Beige",rgb:{r:209,g:128,b:81}},57:{id:61,name:"Dark Stone",rgb:{r:109,g:100,b:63}},58:{id:62,name:"Stone",rgb:{r:148,g:140,b:107}},59:{id:63,name:"Light Stone",rgb:{r:205,g:197,b:158}},60:{id:58,name:"Dark Slate",rgb:{r:51,g:57,b:65}},61:{id:59,name:"Slate",rgb:{r:109,g:117,b:141}},62:{id:60,name:"Light Slate",rgb:{r:179,g:185,b:209}},63:{id:0,name:"Transparent",rgb:null}},CSS_CLASSES:{BUTTON_PRIMARY:`
      ...
      `},currentTheme:"classic"},Wa=()=>Object.keys(ct),ua=()=>y.currentTheme,Ha=t=>{ct[t]&&(y.currentTheme=t,Ua(),qt(),ta())};function qt(){let t=document.getElementById("wplace-theme-css");t&&t.remove();let a=ua();if(ct[a]){let n=document.createElement("style");n.id="wplace-theme-css",n.textContent=ct[a],document.head.appendChild(n)}}let Ua=()=>{try{localStorage.setItem("wplace-theme",y.currentTheme)}catch(t){console.warn("Could not save theme preference:",t)}},ma=()=>{try{let t=localStorage.getItem("wplace-theme");t&&y.THEMES[t]&&(y.currentTheme=t)}catch(t){console.warn("Could not load theme preference:",t)}},Yt=new Map,Re={},Gt=["en","ru","pt","vi","fr","id","tr","zh-CN","zh-TW","ja","ko","uk"],Vt=async t=>{if(Re[t])return Re[t];if(ha[t]){let a=ha[t];if(typeof a=="object"&&a!==null&&Object.keys(a).length>0)return Re[t]=a,console.log(`\u{1F4DA} Loaded ${t} translations successfully from embedded assets (${Object.keys(a).length} keys)`),a;console.warn(`\u274C Invalid embedded translation format for ${t}`)}else console.warn(`\u274C No embedded translations found for ${t}`);return null},qa=async()=>{let t=localStorage.getItem("wplace_language"),a=navigator.language,n=a.split("-")[0],o="en";try{t&&Gt.includes(t)?(o=t,console.log(`\u{1F504} Using saved language preference: ${o}`)):Gt.includes(a)?(o=a,localStorage.setItem("wplace_language",a),console.log(`\u{1F504} Using browser locale: ${o}`)):Gt.includes(n)?(o=n,localStorage.setItem("wplace_language",n),console.log(`\u{1F504} Using browser language: ${o}`)):console.log("\u{1F504} No matching language found, using English fallback"),e.language=o,o!=="en"&&!Re[o]&&(await Vt(o)||(console.warn(`\u26A0\uFE0F Failed to load ${o} translations, falling back to English`),e.language="en",localStorage.setItem("wplace_language","en")))}catch(r){console.error("\u274C Error in loadLanguagePreference:",r),e.language="en"}},wa=t=>{try{let a=document.createElement("div");a.style.cssText=`
      ...
      `,a.textContent=t,document.body.appendChild(a),setTimeout(()=>{a.parentNode&&a.remove()},8e3)}catch(a){console.warn("Failed to show translation warning UI:",a)}},Ya=async()=>{try{console.log("\u{1F310} Initializing translation system..."),Re.en||await Vt("en")||(console.warn("\u26A0\uFE0F Failed to load English translations from CDN, using fallback"),wa("\u26A0\uFE0F Translation loading failed, using basic fallbacks")),await qa(),console.log(`\u2705 Translation system initialized. Active language: ${e.language}`)}catch(t){console.error("\u274C Translation initialization failed:",t),e.language||(e.language="en"),console.warn("\u26A0\uFE0F Using fallback translations due to initialization failure"),wa("\u26A0\uFE0F Translation system error, using basic English")}},Xt={en:{title:"WPlace Auto-Image",settings:"Settings",close:"Close",language:"Language",loadingError:"Loading translations failed, using fallback",scanColors:"Scan Colors",uploadImage:"Upload Image",startPainting:"Start Painting",stopPainting:"Stop Painting",progress:"Progress",pixels:"Pixels",charges:"Charges",initMessage:"Click 'Upload Image' to begin"}},yn=(t,a={})=>{var o,r,l;let n=(o=Re[e.language])==null?void 0:o[t];return!n&&e.language!=="en"&&(n=(r=Re.en)==null?void 0:r[t]),n||(n=(l=Xt.en)==null?void 0:l[t]),n?Object.entries(a).reduce((s,[d,h])=>s.replace(new RegExp(`\\{${d}\\}`,"g"),h),n):(console.warn(`\u26A0\uFE0F Missing translation for key: ${t}`),t)},e={running:!1,imageLoaded:!1,processing:!1,totalPixels:0,paintedPixels:0,availableColors:[],activeColorPalette:[],paintWhitePixels:!0,paintTransparentPixels:!1,currentCharges:0,maxCharges:1,cooldown:y.COOLDOWN_DEFAULT,imageData:null,stopFlag:!1,colorsChecked:!1,startPosition:null,selectingPosition:!1,region:null,minimized:!1,lastPosition:{x:0,y:0},estimatedTime:0,language:"en",paintingSpeed:y.PAINTING_SPEED.DEFAULT,batchMode:y.BATCH_MODE,randomBatchMin:y.RANDOM_BATCH_RANGE.MIN,randomBatchMax:y.RANDOM_BATCH_RANGE.MAX,cooldownChargeThreshold:y.COOLDOWN_CHARGE_THRESHOLD,tokenSource:y.TOKEN_SOURCE,initialSetupComplete:!1,overlayOpacity:y.OVERLAY.OPACITY_DEFAULT,blueMarbleEnabled:y.OVERLAY.BLUE_MARBLE_DEFAULT,ditheringEnabled:!0,colorMatchingAlgorithm:"lab",enableChromaPenalty:!0,chromaPenaltyWeight:.15,customTransparencyThreshold:y.TRANSPARENCY_THRESHOLD,customWhiteThreshold:y.WHITE_THRESHOLD,resizeSettings:null,originalImage:null,resizeIgnoreMask:null,notificationsEnabled:y.NOTIFICATIONS.ENABLED,notifyOnChargesReached:y.NOTIFICATIONS.ON_CHARGES_REACHED,notifyOnlyWhenUnfocused:y.NOTIFICATIONS.ONLY_WHEN_UNFOCUSED,notificationIntervalMinutes:y.NOTIFICATIONS.REPEAT_MINUTES,_lastChargesNotifyAt:0,_lastChargesBelow:!0,_lastSavePixelCount:0,_lastSaveTime:0,_saveInProgress:!1,paintedMap:null},ge=()=>{},xt=null;class Ga{constructor(){this.isEnabled=!1,this.startCoords=null,this.imageBitmap=null,this.chunkedTiles=new Map,this.originalTiles=new Map,this.originalTilesData=new Map,this.tileSize=1e3,this.processPromise=null,this.lastProcessedHash=null,this.workerPool=null}toggle(){return this.isEnabled=!this.isEnabled,console.log(`Overlay ${this.isEnabled?"enabled":"disabled"}.`),this.isEnabled}enable(){this.isEnabled=!0}disable(){this.isEnabled=!1}clear(){this.disable(),this.imageBitmap=null,this.chunkedTiles.clear(),this.originalTiles.clear(),this.originalTilesData.clear(),this.lastProcessedHash=null,this.processPromise&&(this.processPromise=null)}async setImage(a){this.imageBitmap=a,this.lastProcessedHash=null,this.imageBitmap&&this.startCoords&&await this.processImageIntoChunks()}async setPosition(a,n){if(!a||!n){this.startCoords=null,this.chunkedTiles.clear(),this.lastProcessedHash=null;return}this.startCoords={region:n,pixel:a},this.lastProcessedHash=null,this.imageBitmap&&await this.processImageIntoChunks()}_generateProcessHash(){if(!this.imageBitmap||!this.startCoords)return null;let{width:a,height:n}=this.imageBitmap,{x:o,y:r}=this.startCoords.pixel,{x:l,y:s}=this.startCoords.region;return`${a}x${n}_${o},${r}_${l},${s}_${e.blueMarbleEnabled}_${e.overlayOpacity}`}async processImageIntoChunks(){if(!this.imageBitmap||!this.startCoords)return;if(this.processPromise)return this.processPromise;let a=this._generateProcessHash();if(this.lastProcessedHash===a&&this.chunkedTiles.size>0){console.log(`\u{1F4E6} Using cached overlay chunks (${this.chunkedTiles.size} tiles)`);return}this.processPromise=this._doProcessImageIntoChunks();try{await this.processPromise,this.lastProcessedHash=a}finally{this.processPromise=null}}async _doProcessImageIntoChunks(){let a=performance.now();this.chunkedTiles.clear();let{width:n,height:o}=this.imageBitmap,{x:r,y:l}=this.startCoords.pixel,{x:s,y:d}=this.startCoords.region,h=r+n,p=l+o,m=s+Math.floor(r/this.tileSize),g=d+Math.floor(l/this.tileSize),S=s+Math.floor(h/this.tileSize),w=d+Math.floor(p/this.tileSize),u=(S-m+1)*(w-g+1);console.log(`\u{1F504} Processing ${u} overlay tiles...`);let z=4,C=[];for(let P=g;P<=w;P++)for(let B=m;B<=S;B++)C.push({tx:B,ty:P});for(let P=0;P<C.length;P+=z){let B=C.slice(P,P+z);await Promise.all(B.map(async({tx:O,ty:V})=>{let j=`${O},${V}`,le=await this._processTile(O,V,n,o,r,l,s,d);le&&this.chunkedTiles.set(j,le)})),P+z<C.length&&await new Promise(O=>setTimeout(O,0))}let T=performance.now()-a;console.log(`\u2705 Overlay processed ${this.chunkedTiles.size} tiles in ${Math.round(T)}ms`)}async _processTile(a,n,o,r,l,s,d,h){let p=`${a},${n}`,m=(a-d)*this.tileSize-l,g=(n-h)*this.tileSize-s,S=Math.max(0,m),w=Math.max(0,g),u=Math.min(o-S,this.tileSize-(S-m)),z=Math.min(r-w,this.tileSize-(w-g));if(u<=0||z<=0)return null;let C=Math.max(0,-m),T=Math.max(0,-g),P=new OffscreenCanvas(this.tileSize,this.tileSize),B=P.getContext("2d");if(B.imageSmoothingEnabled=!1,B.drawImage(this.imageBitmap,S,w,u,z,C,T,u,z),e.blueMarbleEnabled){let O=B.getImageData(C,T,u,z),V=O.data;for(let j=0;j<V.length;j+=4){let le=j/4,te=Math.floor(le/u);(le%u+te)%2===0&&V[j+3]>0&&(V[j+3]=0)}B.putImageData(O,C,T)}return await P.transferToImageBitmap()}async processAndRespondToTileRequest(a){let{endpoint:n,blobID:o,blobData:r}=a,l=r;if(this.isEnabled&&this.chunkedTiles.size>0){let s=n.match(/(\d+)\/(\d+)\.png/);if(s){let d=parseInt(s[1],10),h=parseInt(s[2],10),p=`${d},${h}`,m=this.chunkedTiles.get(p);try{let g=await createImageBitmap(r);this.originalTiles.set(p,g);try{let S,w;typeof OffscreenCanvas<"u"?(S=new OffscreenCanvas(g.width,g.height),w=S.getContext("2d")):(S=document.createElement("canvas"),S.width=g.width,S.height=g.height,w=S.getContext("2d")),w.imageSmoothingEnabled=!1,w.drawImage(g,0,0);let u=w.getImageData(0,0,g.width,g.height);this.originalTilesData.set(p,{w:g.width,h:g.height,data:new Uint8ClampedArray(u.data)})}catch(S){console.warn("OverlayManager: could not cache ImageData for",p,S)}}catch(g){console.warn("OverlayManager: could not create original bitmap for",p,g)}if(m)try{l=await this._compositeTileOptimized(r,m)}catch(g){console.error("Error compositing overlay:",g),l=r}}}window.postMessage({source:"auto-image-overlay",blobID:o,blobData:l},"*")}async getTilePixelColor(a,n,o,r){let l=`${a},${n}`,s=this.originalTilesData.get(l);if(s&&s.data&&s.w>0&&s.h>0){let h=Math.max(0,Math.min(s.w-1,o)),p=Math.max(0,Math.min(s.h-1,r)),m=(p*s.w+h)*4,g=s.data,S=g[m+3],w=e.customTransparencyThreshold||y.TRANSPARENCY_THRESHOLD;return!e.paintTransparentPixels&&S<w?(window._overlayDebug&&console.debug("getTilePixelColor: transparent pixel, skipping",l,h,p,S),null):[g[m],g[m+1],g[m+2],S]}let d=this.originalTiles.get(l);if(!d)return null;try{let h,p;typeof OffscreenCanvas<"u"?(h=new OffscreenCanvas(d.width,d.height),p=h.getContext("2d")):(h=document.createElement("canvas"),h.width=d.width,h.height=d.height,p=h.getContext("2d")),p.imageSmoothingEnabled=!1,p.drawImage(d,0,0);let m=Math.max(0,Math.min(d.width-1,o)),g=Math.max(0,Math.min(d.height-1,r)),S=p.getImageData(m,g,1,1).data,w=S[3],u=e.customTransparencyThreshold||y.TRANSPARENCY_THRESHOLD;return!e.paintTransparentPixels&&w<u?(window._overlayDebug&&console.debug("getTilePixelColor: transparent pixel (fallback), skipping",l,m,g,w),null):[S[0],S[1],S[2],w]}catch(h){return console.warn("OverlayManager.getTilePixelColor failed for",l,o,r,h),null}}async _compositeTileOptimized(a,n){let o=await createImageBitmap(a),r=new OffscreenCanvas(o.width,o.height),l=r.getContext("2d");return l.imageSmoothingEnabled=!1,l.drawImage(o,0,0),l.globalAlpha=e.overlayOpacity,l.globalCompositeOperation="source-over",l.drawImage(n,0,0),await r.convertToBlob({type:"image/png",quality:.95})}}let Te=new Ga,Se=null,jt=0,Kt=!1,$e=null,nt=new Promise(t=>{$e=t}),xn=0,kn=10,fa=10,Va=24e4;function kt(t){$e&&($e(t),$e=null),Se=t,jt=Date.now()+Va,console.log("\u2705 Turnstile token set successfully")}function Jt(){return Se&&Date.now()<jt}function Xa(){Se=null,jt=0,console.log("\u{1F5D1}\uFE0F Token invalidated, will force fresh generation")}async function ba(t=!1){if(Jt()&&!t)return Se;if(t&&Xa(),Kt)return console.log("\u{1F504} Token generation already in progress, waiting..."),await i.sleep(2e3),Jt()?Se:null;Kt=!0;try{console.log("\u{1F504} Token expired or missing, generating new one...");let a=await va();if(a&&a.length>20)return kt(a),console.log("\u2705 Token captured and cached successfully"),a;console.log("\u26A0\uFE0F Invisible Turnstile failed, forcing browser automation...");let n=await Tt();return n&&n.length>20?(kt(n),console.log("\u2705 Fallback token captured successfully"),n):(console.log("\u274C All token generation methods failed"),null)}finally{Kt=!1}}async function va(){let t=Date.now();try{let a=i.detectSitekey();console.log("\u{1F511} Generating Turnstile token for sitekey:",a),typeof window<"u"&&window.navigator&&console.log("\u{1F9ED} UA:",window.navigator.userAgent,"Platform:",window.navigator.platform);let n=await i.generatePaintToken(a);if(n&&n.length>20){let o=Math.round(Date.now()-t);return console.log(`\u2705 Turnstile token generated successfully in ${o}ms`),n}else throw new Error("Invalid or empty token received")}catch(a){let n=Math.round(Date.now()-t);throw console.log(`\u274C Turnstile token generation failed after ${n}ms:`,a),a}}function ja(t){var n;let a=document.createElement("script");a.textContent=`(${t})();`,(n=document.documentElement)==null||n.appendChild(a),a.remove()}ja(()=>{let t=new Map;window.addEventListener("message",n=>{let{source:o,blobID:r,blobData:l}=n.data;if(o==="auto-image-overlay"&&r&&l){let s=t.get(r);typeof s=="function"&&s(l),t.delete(r)}});let a=window.fetch;window.fetch=async function(...n){let o=await a.apply(this,n),r=n[0]instanceof Request?n[0].url:n[0];if(typeof r=="string"){if(r.includes("https://backend.wplace.live/s0/pixel/"))try{let s=JSON.parse(n[1].body);s.t&&(console.log("\u2705 Turnstile Token Captured:",s.t),window.postMessage({source:"turnstile-capture",token:s.t},"*"))}catch{}if((o.headers.get("content-type")||"").includes("image/png")&&r.includes(".png")){let s=o.clone();return new Promise(async d=>{let h=crypto.randomUUID(),p=await s.blob();t.set(h,m=>{d(new Response(m,{headers:s.headers,status:s.status,statusText:s.statusText}))}),window.postMessage({source:"auto-image-tile",endpoint:r,blobID:h,blobData:p},"*")})}}return o}}),window.addEventListener("message",t=>{var s;let{source:a,endpoint:n,blobID:o,blobData:r,token:l}=t.data;a==="auto-image-tile"&&n&&o&&r&&Te.processAndRespondToTileRequest(t.data),a==="turnstile-capture"&&l&&(kt(l),(s=document.querySelector("#statusText"))!=null&&s.textContent.includes("CAPTCHA")&&(i.showAlert(i.t("tokenCapturedSuccess"),"success"),N("colorsFound","success",{count:e.availableColors.length})))});async function Ka(){try{let a=await(await fetch("https://backend.wplace.live/me",{credentials:"include"})).json();e.language=a.language==="pt"?"pt":"en"}catch{e.language=navigator.language.startsWith("pt")?"pt":"en"}}let i={sleep:t=>new Promise(a=>setTimeout(a,t)),waitForSelector:async(t,a=200,n=5e3)=>{let o=Date.now();for(;Date.now()-o<n;){let r=document.querySelector(t);if(r)return r;await i.sleep(a)}return null},turnstileLoaded:!1,_turnstileContainer:null,_turnstileOverlay:null,_turnstileWidgetId:null,_lastSitekey:null,async loadTurnstile(){return window.turnstile?(this.turnstileLoaded=!0,Promise.resolve()):new Promise((t,a)=>{if(document.querySelector('script[src^="https://challenges.cloudflare.com/turnstile/v0/api.js"]')){let o=()=>{window.turnstile?(this.turnstileLoaded=!0,t()):setTimeout(o,100)};return o()}let n=document.createElement("script");n.src="https://challenges.cloudflare.com/turnstile/v0/api.js?render=explicit",n.async=!0,n.defer=!0,n.onload=()=>{this.turnstileLoaded=!0,console.log("\u2705 Turnstile script loaded successfully"),t()},n.onerror=()=>{console.error("\u274C Failed to load Turnstile script"),a(new Error("Failed to load Turnstile"))},document.head.appendChild(n)})},ensureTurnstileContainer(){return(!this._turnstileContainer||!document.body.contains(this._turnstileContainer))&&(this._turnstileContainer&&this._turnstileContainer.remove(),this._turnstileContainer=document.createElement("div"),this._turnstileContainer.className="wplace-turnstile-hidden",this._turnstileContainer.setAttribute("aria-hidden","true"),this._turnstileContainer.id="turnstile-widget-container",document.body.appendChild(this._turnstileContainer)),this._turnstileContainer},ensureTurnstileOverlayContainer(){if(this._turnstileOverlay&&document.body.contains(this._turnstileOverlay))return this._turnstileOverlay;let t=document.createElement("div");t.id="turnstile-overlay-container",t.className="wplace-turnstile-overlay wplace-overlay-hidden";let a=document.createElement("div");a.textContent=i.t("turnstileInstructions"),a.style.cssText='font: 600 12px/1.3 "Segoe UI",sans-serif; margin-bottom: 8px; opacity: 0.9;';let n=document.createElement("div");n.id="turnstile-overlay-host",n.className="wplace-turnstile-host";let o=document.createElement("button");return o.textContent=i.t("hideTurnstileBtn"),o.className="wplace-turnstile-hide-btn",o.addEventListener("click",()=>t.remove()),t.appendChild(a),t.appendChild(n),t.appendChild(o),document.body.appendChild(t),this._turnstileOverlay=t,t},async executeTurnstile(t,a="paint"){var o;if(await this.loadTurnstile(),this._turnstileWidgetId&&this._lastSitekey===t&&((o=window.turnstile)!=null&&o.execute))try{console.log("\u{1F504} Reusing existing Turnstile widget...");let r=await Promise.race([window.turnstile.execute(this._turnstileWidgetId,{action:a}),new Promise((l,s)=>setTimeout(()=>s(new Error("Execute timeout")),15e3))]);if(r&&r.length>20)return console.log("\u2705 Token generated via widget reuse"),r}catch(r){console.log("\uFFFD Widget reuse failed, will create a fresh widget:",r.message)}let n=await this.createTurnstileWidget(t,a);return n&&n.length>20?n:(console.log("\uFFFD Falling back to interactive Turnstile (visible)."),await this.createTurnstileWidgetInteractive(t,a))},async createTurnstileWidget(t,a){return new Promise(n=>{var o,r;try{if(this._turnstileWidgetId&&((o=window.turnstile)!=null&&o.remove))try{window.turnstile.remove(this._turnstileWidgetId),console.log("\u{1F9F9} Cleaned up existing Turnstile widget")}catch(d){console.warn("\u26A0\uFE0F Widget cleanup warning:",d.message)}let l=this.ensureTurnstileContainer();if(l.innerHTML="",!((r=window.turnstile)!=null&&r.render)){console.error("\u274C Turnstile not available for rendering"),n(null);return}console.log("\u{1F527} Creating invisible Turnstile widget...");let s=window.turnstile.render(l,{sitekey:t,action:a,size:"invisible",retry:"auto","retry-interval":8e3,callback:d=>{console.log("\u2705 Invisible Turnstile callback"),n(d)},"error-callback":()=>n(null),"timeout-callback":()=>n(null)});if(this._turnstileWidgetId=s,this._lastSitekey=t,!s)return n(null);Promise.race([window.turnstile.execute(s,{action:a}),new Promise((d,h)=>setTimeout(()=>h(new Error("Invisible execute timeout")),12e3))]).then(n).catch(()=>n(null))}catch(l){console.error("\u274C Invisible Turnstile creation failed:",l),n(null)}})},async createTurnstileWidgetInteractive(t,a){return console.log("\u{1F504} Creating interactive Turnstile widget (visible)"),new Promise(n=>{var o;try{if(this._turnstileWidgetId&&((o=window.turnstile)!=null&&o.remove))try{window.turnstile.remove(this._turnstileWidgetId)}catch(h){console.warn("\u26A0\uFE0F Widget cleanup warning:",h.message)}let r=this.ensureTurnstileOverlayContainer();r.classList.remove("wplace-overlay-hidden"),r.style.display="block";let l=r.querySelector("#turnstile-overlay-host");l.innerHTML="";let s=setTimeout(()=>{console.warn("\u23F0 Interactive Turnstile widget timeout"),r.classList.add("wplace-overlay-hidden"),r.style.display="none",n(null)},6e4),d=window.turnstile.render(l,{sitekey:t,action:a,size:"normal",theme:"light",callback:h=>{clearTimeout(s),r.classList.add("wplace-overlay-hidden"),r.style.display="none",console.log("\u2705 Interactive Turnstile completed successfully"),typeof h=="string"&&h.length>20?n(h):(console.warn("\u274C Invalid token from interactive widget"),n(null))},"error-callback":h=>{clearTimeout(s),r.classList.add("wplace-overlay-hidden"),r.style.display="none",console.warn("\u274C Interactive Turnstile error:",h),n(null)}});this._turnstileWidgetId=d,this._lastSitekey=t,d?console.log("\u2705 Interactive Turnstile widget created, waiting for user interaction..."):(clearTimeout(s),r.classList.add("wplace-overlay-hidden"),r.style.display="none",console.warn("\u274C Failed to create interactive Turnstile widget"),n(null))}catch(r){console.error("\u274C Interactive Turnstile creation failed:",r),n(null)}})},async generatePaintToken(t){return this.executeTurnstile(t,"paint")},cleanupTurnstile(){var t;if(this._turnstileWidgetId&&((t=window.turnstile)!=null&&t.remove))try{window.turnstile.remove(this._turnstileWidgetId)}catch(a){console.warn("Failed to cleanup Turnstile widget:",a)}this._turnstileContainer&&document.body.contains(this._turnstileContainer)&&this._turnstileContainer.remove(),this._turnstileOverlay&&document.body.contains(this._turnstileOverlay)&&this._turnstileOverlay.remove(),this._turnstileWidgetId=null,this._turnstileContainer=null,this._turnstileOverlay=null,this._lastSitekey=null},detectSitekey(t="0x4AAAAAABpqJe8FO0N84q0F"){var n;if(this._cachedSitekey)return console.log("\u{1F50D} Using cached sitekey:",this._cachedSitekey),this._cachedSitekey;let a=["0x4AAAAAABpqJe8FO0N84q0F","0x4AAAAAAAJ7xjKAp6Mt_7zw","0x4AAAAAADm5QWx6Ov2LNF2g"];try{let o=document.querySelector("[data-sitekey]");if(o){let d=o.getAttribute("data-sitekey");if(d&&d.length>10)return this._cachedSitekey=d,console.log("\u{1F50D} Sitekey detected from data attribute:",d),d}let r=document.querySelector(".cf-turnstile");if((n=r==null?void 0:r.dataset)!=null&&n.sitekey&&r.dataset.sitekey.length>10)return this._cachedSitekey=r.dataset.sitekey,console.log("\u{1F50D} Sitekey detected from turnstile element:",this._cachedSitekey),this._cachedSitekey;let l=document.querySelectorAll('meta[name*="turnstile"], meta[property*="turnstile"]');for(let d of l){let h=d.getAttribute("content");if(h&&h.length>10)return this._cachedSitekey=h,console.log("\u{1F50D} Sitekey detected from meta tag:",this._cachedSitekey),this._cachedSitekey}if(typeof window<"u"&&window.__TURNSTILE_SITEKEY&&window.__TURNSTILE_SITEKEY.length>10)return this._cachedSitekey=window.__TURNSTILE_SITEKEY,console.log("\u{1F50D} Sitekey detected from global variable:",this._cachedSitekey),this._cachedSitekey;let s=document.querySelectorAll("script");for(let d of s){let p=(d.textContent||d.innerHTML).match(/sitekey['":\s]+(['"0-9a-zA-X_-]{20,})/i);if(p&&p[1]&&p[1].length>10)return this._cachedSitekey=p[1].replace(/['"]/g,""),console.log("\u{1F50D} Sitekey detected from script content:",this._cachedSitekey),this._cachedSitekey}console.log("\u{1F50D} No sitekey detected, trying known working sitekeys...");for(let d of a)return console.log("\u{1F50D} Trying sitekey:",d),this._cachedSitekey=d,d}catch(o){console.warn("Error detecting sitekey:",o)}return console.log("\u{1F50D} Using fallback sitekey:",t),this._cachedSitekey=t,t},createElement:(t,a={},n=[])=>{let o=document.createElement(t);return Object.entries(a).forEach(([r,l])=>{r==="style"&&typeof l=="object"?Object.assign(o.style,l):r==="className"?o.className=l:r==="innerHTML"?o.innerHTML=l:o.setAttribute(r,l)}),typeof n=="string"?o.textContent=n:Array.isArray(n)&&n.forEach(r=>{typeof r=="string"?o.appendChild(document.createTextNode(r)):o.appendChild(r)}),o},createButton:(t,a,n,o,r=y.CSS_CLASSES.BUTTON_PRIMARY)=>{let l=i.createElement("button",{id:t,style:r,innerHTML:`${n?`<i class="${n}"></i>`:""}<span>${a}</span>`});return o&&l.addEventListener("click",o),l},t:(t,a={})=>{var r,l,s,d;let n=`${e.language}_${t}`;if(Yt.has(n)){let h=Yt.get(n);return Object.keys(a).forEach(p=>{h=h.replace(`{${p}}`,a[p])}),h}if((r=Re[e.language])!=null&&r[t]){let h=Re[e.language][t];return Yt.set(n,h),Object.keys(a).forEach(p=>{h=h.replace(`{${p}}`,a[p])}),h}if(e.language!=="en"&&((l=Re.en)!=null&&l[t])){let h=Re.en[t];return Object.keys(a).forEach(p=>{h=h.replace(`{${p}}`,a[p])}),h}let o=((s=Xt[e.language])==null?void 0:s[t])||((d=Xt.en)==null?void 0:d[t])||t;return Object.keys(a).forEach(h=>{o=o.replace(new RegExp(`\\{${h}\\}`,"g"),a[h])}),o===t&&t!=="undefined"&&console.warn(`\u26A0\uFE0F Missing translation for key: ${t} (language: ${e.language})`),o},showAlert:(t,a="info")=>{let n=document.createElement("div");n.className=`wplace-alert-base wplace-alert-${a}`,n.textContent=t,document.body.appendChild(n),setTimeout(()=>{n.style.animation="slideDown 0.3s ease-out reverse",setTimeout(()=>{document.body.removeChild(n)},300)},4e3)},colorDistance:(t,a)=>Math.sqrt(Math.pow(t[0]-a[0],2)+Math.pow(t[1]-a[1],2)+Math.pow(t[2]-a[2],2)),_labCache:new Map,_rgbToLab:(t,a,n)=>{let o=T=>(T/=255,T<=.04045?T/12.92:Math.pow((T+.055)/1.055,2.4)),r=o(t),l=o(a),s=o(n),d=r*.4124+l*.3576+s*.1805,h=r*.2126+l*.7152+s*.0722,p=r*.0193+l*.1192+s*.9505;d/=.95047,h/=1,p/=1.08883;let m=T=>T>.008856?Math.cbrt(T):7.787*T+16/116,g=m(d),S=m(h),w=m(p),u=116*S-16,z=500*(g-S),C=200*(S-w);return[u,z,C]},_lab:(t,a,n)=>{let o=t<<16|a<<8|n,r=i._labCache.get(o);return r||(r=i._rgbToLab(t,a,n),i._labCache.set(o,r)),r},findClosestPaletteColor:(t,a,n,o)=>{if((!o||o.length===0)&&(o=Object.values(y.COLOR_MAP).filter(m=>m.rgb).map(m=>[m.rgb.r,m.rgb.g,m.rgb.b])),e.colorMatchingAlgorithm==="legacy"){let m=1/0,g=[0,0,0];for(let S=0;S<o.length;S++){let[w,u,z]=o[S],C=(w+t)/2,T=w-t,P=u-a,B=z-n,O=Math.sqrt(((512+C)*T*T>>8)+4*P*P+((767-C)*B*B>>8));O<m&&(m=O,g=[w,u,z])}return g}let[r,l,s]=i._lab(t,a,n),d=Math.sqrt(l*l+s*s),h=null,p=1/0;for(let m=0;m<o.length;m++){let[g,S,w]=o[m],[u,z,C]=i._lab(g,S,w),T=r-u,P=l-z,B=s-C,O=T*T+P*P+B*B;if(e.enableChromaPenalty&&d>20){let V=Math.sqrt(z*z+C*C);if(V<d){let j=d-V;O+=j*j*e.chromaPenaltyWeight}}if(O<p&&(p=O,h=o[m],p===0))break}return h||[0,0,0]},isWhitePixel:(t,a,n)=>{let o=e.customWhiteThreshold||y.WHITE_THRESHOLD;return t>=o&&a>=o&&n>=o},createImageUploader:()=>new Promise(t=>{let a=document.createElement("input");a.type="file",a.accept="image/png,image/jpeg",a.onchange=()=>{let n=new FileReader;n.onload=()=>t(n.result),n.readAsDataURL(a.files[0])},a.click()}),createFileDownloader:(t,a)=>{let n=new Blob([t],{type:"application/json"}),o=URL.createObjectURL(n),r=document.createElement("a");r.href=o,r.download=a,document.body.appendChild(r),r.click(),document.body.removeChild(r),URL.revokeObjectURL(o)},createFileUploader:()=>new Promise((t,a)=>{let n=document.createElement("input");n.type="file",n.accept=".json",n.onchange=o=>{let r=o.target.files[0];if(r){let l=new FileReader;l.onload=()=>{try{let s=JSON.parse(l.result);t(s)}catch{a(new Error("Invalid JSON file"))}},l.onerror=()=>a(new Error("File reading error")),l.readAsText(r)}else a(new Error("No file selected"))},n.click()}),extractAvailableColors:()=>{let t=document.querySelectorAll('[id^="color-"]'),a=[],n=[];return Array.from(t).forEach(o=>{let r=Number.parseInt(o.id.replace("color-",""));if(r===0)return;let l=o.style.backgroundColor.match(/\d+/g),s=l?l.map(Number):[0,0,0],d=Object.values(y.COLOR_MAP).find(m=>m.id===r),h=d?d.name:`Unknown Color ${r}`,p={id:r,name:h,rgb:s};o.querySelector("svg")?n.push(p):a.push(p)}),console.log("=== CAPTURED COLORS STATUS ==="),console.log(`Total available colors: ${a.length}`),console.log(`Total unavailable colors: ${n.length}`),console.log(`Total colors scanned: ${a.length+n.length}`),a.length>0&&(console.log(`
--- AVAILABLE COLORS ---`),a.forEach((o,r)=>{console.log(`${r+1}. ID: ${o.id}, Name: "${o.name}", RGB: (${o.rgb[0]}, ${o.rgb[1]}, ${o.rgb[2]})`)})),n.length>0&&(console.log(`
--- UNAVAILABLE COLORS ---`),n.forEach((o,r)=>{console.log(`${r+1}. ID: ${o.id}, Name: "${o.name}", RGB: (${o.rgb[0]}, ${o.rgb[1]}, ${o.rgb[2]}) [LOCKED]`)})),console.log("=== END COLOR STATUS ==="),a},formatTime:t=>{let a=Math.floor(t/1e3%60),n=Math.floor(t/(1e3*60)%60),o=Math.floor(t/(1e3*60*60)%24),r=Math.floor(t/(1e3*60*60*24)),l="";return r>0&&(l+=`${r}d `),(o>0||r>0)&&(l+=`${o}h `),(n>0||o>0||r>0)&&(l+=`${n}m `),l+=`${a}s`,l},calculateEstimatedTime:(t,a,n)=>{if(t<=0)return 0;let o=e.paintingSpeed>0?1e3/e.paintingSpeed:1e3,r=t*o,s=Math.ceil(t/Math.max(a,1))*n;return r+s},initializePaintedMap:(t,a)=>{(!e.paintedMap||e.paintedMap.length!==a)&&(e.paintedMap=Array(a).fill().map(()=>Array(t).fill(!1)),console.log(`\u{1F4CB} Initialized painted map: ${t}x${a}`))},markPixelPainted:(t,a,n=0,o=0)=>{let r=t+n,l=a+o;e.paintedMap&&e.paintedMap[l]&&r>=0&&r<e.paintedMap[l].length&&(e.paintedMap[l][r]=!0)},isPixelPainted:(t,a,n=0,o=0)=>{let r=t+n,l=a+o;return e.paintedMap&&e.paintedMap[l]&&r>=0&&r<e.paintedMap[l].length?e.paintedMap[l][r]:!1},shouldAutoSave:()=>{let t=Date.now(),a=e.paintedPixels-e._lastSavePixelCount,n=t-e._lastSaveTime;return!e._saveInProgress&&a>=25&&n>=3e4},performSmartSave:()=>{if(!i.shouldAutoSave())return!1;e._saveInProgress=!0;let t=i.saveProgress();return t&&(e._lastSavePixelCount=e.paintedPixels,e._lastSaveTime=Date.now(),console.log(`\u{1F4BE} Auto-saved at ${e.paintedPixels} pixels`)),e._saveInProgress=!1,t},packPaintedMapToBase64:(t,a,n)=>{if(!t||!a||!n)return null;let o=a*n,r=Math.ceil(o/8),l=new Uint8Array(r),s=0;for(let p=0;p<n;p++){let m=t[p];for(let g=0;g<a;g++){let S=m&&m[g]?1:0,w=s>>3,u=s&7;S&&(l[w]|=1<<u),s++}}let d="",h=32768;for(let p=0;p<l.length;p+=h)d+=String.fromCharCode.apply(null,l.subarray(p,Math.min(p+h,l.length)));return btoa(d)},unpackPaintedMapFromBase64:(t,a,n)=>{if(!t||!a||!n)return null;let o=atob(t),r=new Uint8Array(o.length);for(let d=0;d<o.length;d++)r[d]=o.charCodeAt(d);let l=Array(n).fill().map(()=>Array(a).fill(!1)),s=0;for(let d=0;d<n;d++)for(let h=0;h<a;h++){let p=s>>3,m=s&7;l[d][h]=(r[p]>>m&1)===1,s++}return l},migrateProgressToV2:t=>{var n,o;if(!t||!(!t.version||t.version==="1"||t.version==="1.0"||t.version==="1.1"))return t;try{let r={...t},l=(n=r.imageData)==null?void 0:n.width,s=(o=r.imageData)==null?void 0:o.height;if(r.paintedMap&&l&&s){let d=i.packPaintedMapToBase64(r.paintedMap,l,s);r.paintedMapPacked={width:l,height:s,data:d}}return delete r.paintedMap,r.version="2",r}catch(r){return console.warn("Migration to v2 failed, using original data:",r),t}},migrateProgressToV21:t=>{var o,r;if(!t||t.version==="2.1")return t;let a=t.version==="2"||t.version==="2.0",n=!t.version||t.version==="1"||t.version==="1.0"||t.version==="1.1";if(!a&&!n)return t;try{let l={...t};if(n){let s=(o=l.imageData)==null?void 0:o.width,d=(r=l.imageData)==null?void 0:r.height;if(l.paintedMap&&s&&d){let h=i.packPaintedMapToBase64(l.paintedMap,s,d);l.paintedMapPacked={width:s,height:d,data:h}}delete l.paintedMap}return l.version="2.1",l}catch(l){return console.warn("Migration to v2.1 failed, using original data:",l),t}},saveProgress:()=>{try{let t=null;if(e.paintedMap&&e.imageData){let n=i.packPaintedMapToBase64(e.paintedMap,e.imageData.width,e.imageData.height);n&&(t={width:e.imageData.width,height:e.imageData.height,data:n})}let a={timestamp:Date.now(),version:"2.1",state:{totalPixels:e.totalPixels,paintedPixels:e.paintedPixels,lastPosition:e.lastPosition,startPosition:e.startPosition,region:e.region,imageLoaded:e.imageLoaded,colorsChecked:e.colorsChecked,availableColors:e.availableColors},imageData:e.imageData?{width:e.imageData.width,height:e.imageData.height,pixels:Array.from(e.imageData.pixels),totalPixels:e.imageData.totalPixels}:null,paintedMapPacked:t};return localStorage.setItem("wplace-bot-progress",JSON.stringify(a)),!0}catch(t){return console.error("Error saving progress:",t),!1}},loadProgress:()=>{try{let t=localStorage.getItem("wplace-bot-progress");if(!t)return null;let a=JSON.parse(t),n=a.version,o=a;if(n==="2.1"||(o=i.migrateProgressToV21(a)),o&&o!==a){try{localStorage.setItem("wplace-bot-progress",JSON.stringify(o))}catch{}a=o}return a}catch(t){return console.error("Error loading progress:",t),null}},clearProgress:()=>{try{return localStorage.removeItem("wplace-bot-progress"),e.paintedMap=null,e._lastSavePixelCount=0,e._lastSaveTime=0,console.log("\u{1F4CB} Progress and painted map cleared"),!0}catch(t){return console.error("Error clearing progress:",t),!1}},restoreProgress:t=>{try{if(Object.assign(e,t.state),t.imageData){e.imageData={...t.imageData,pixels:new Uint8ClampedArray(t.imageData.pixels)};try{let a=document.createElement("canvas");a.width=e.imageData.width,a.height=e.imageData.height;let n=a.getContext("2d"),o=new ImageData(e.imageData.pixels,e.imageData.width,e.imageData.height);n.putImageData(o,0,0);let r=new Zt("");r.img=a,r.canvas=a,r.ctx=n,e.imageData.processor=r}catch(a){console.warn("Could not rebuild processor from saved image data:",a)}}if(t.paintedMapPacked&&t.paintedMapPacked.data){let{width:a,height:n,data:o}=t.paintedMapPacked;e.paintedMap=i.unpackPaintedMapFromBase64(o,a,n)}else t.paintedMap&&(e.paintedMap=t.paintedMap.map(a=>Array.from(a)));return!0}catch(a){return console.error("Error restoring progress:",a),!1}},saveProgressToFile:()=>{try{let t=null;if(e.paintedMap&&e.imageData){let o=i.packPaintedMapToBase64(e.paintedMap,e.imageData.width,e.imageData.height);o&&(t={width:e.imageData.width,height:e.imageData.height,data:o})}let a={timestamp:Date.now(),version:"2.1",state:{totalPixels:e.totalPixels,paintedPixels:e.paintedPixels,lastPosition:e.lastPosition,startPosition:e.startPosition,region:e.region,imageLoaded:e.imageLoaded,colorsChecked:e.colorsChecked,availableColors:e.availableColors},imageData:e.imageData?{width:e.imageData.width,height:e.imageData.height,pixels:Array.from(e.imageData.pixels),totalPixels:e.imageData.totalPixels}:null,paintedMapPacked:t},n=`wplace-bot-progress-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.json`;return i.createFileDownloader(JSON.stringify(a,null,2),n),!0}catch(t){return console.error("Error saving to file:",t),!1}},loadProgressFromFile:async()=>{try{let t=await i.createFileUploader();if(!t||!t.state)throw new Error("Invalid file format");let a=t.version,n=t;return a==="2.1"||(n=i.migrateProgressToV21(t)||t),i.restoreProgress(n)}catch(t){throw console.error("Error loading from file:",t),t}},restoreOverlayFromData:async()=>{if(!e.imageLoaded||!e.imageData||!e.startPosition||!e.region)return!1;try{let t=new ImageData(e.imageData.pixels,e.imageData.width,e.imageData.height),a=new OffscreenCanvas(e.imageData.width,e.imageData.height);a.getContext("2d").putImageData(t,0,0);let o=await a.transferToImageBitmap();await Te.setImage(o),await Te.setPosition(e.startPosition,e.region),Te.enable();let r=document.getElementById("toggleOverlayBtn");return r&&(r.disabled=!1,r.classList.add("active")),console.log("Overlay restored from data"),!0}catch(t){return console.error("Failed to restore overlay from data:",t),!1}}};class Zt{constructor(a){this.imageSrc=a,this.img=null,this.canvas=null,this.ctx=null}async load(){return new Promise((a,n)=>{this.img=new Image,this.img.crossOrigin="anonymous",this.img.onload=()=>{this.canvas=document.createElement("canvas"),this.ctx=this.canvas.getContext("2d"),this.canvas.width=this.img.width,this.canvas.height=this.img.height,this.ctx.drawImage(this.img,0,0),a()},this.img.onerror=n,this.img.src=this.imageSrc})}getDimensions(){return{width:this.canvas.width,height:this.canvas.height}}getPixelData(){return this.ctx.getImageData(0,0,this.canvas.width,this.canvas.height).data}resize(a,n){let o=document.createElement("canvas"),r=o.getContext("2d");return o.width=a,o.height=n,r.imageSmoothingEnabled=!1,r.drawImage(this.canvas,0,0,a,n),this.canvas.width=a,this.canvas.height=n,this.ctx.imageSmoothingEnabled=!1,this.ctx.drawImage(o,0,0),this.ctx.getImageData(0,0,a,n).data}generatePreview(a,n){let o=document.createElement("canvas"),r=o.getContext("2d");return o.width=a,o.height=n,r.imageSmoothingEnabled=!1,r.drawImage(this.img,0,0,a,n),o.toDataURL()}}let Qt={async paintPixelInRegion(t,a,n,o,r){try{if(await ba(),!Se)return"token_error";let l={coords:[n,o],colors:[r],t:Se},s=await fetch(`https://backend.wplace.live/s0/pixel/${t}/${a}`,{method:"POST",headers:{"Content-Type":"text/plain;charset=UTF-8"},credentials:"include",body:JSON.stringify(l)});if(s.status===403)return console.error("\u274C 403 Forbidden. Turnstile token might be invalid or expired."),Se=null,nt=new Promise(h=>{$e=h}),"token_error";let d=await s.json();return(d==null?void 0:d.painted)===1}catch(l){return console.error("Paint request failed:",l),!1}},async getCharges(){var t,a,n;try{let r=await(await fetch("https://backend.wplace.live/me",{credentials:"include"})).json();return{charges:((t=r.charges)==null?void 0:t.count)||0,max:((a=r.charges)==null?void 0:a.max)||1,cooldown:((n=r.charges)==null?void 0:n.next)||y.COOLDOWN_DEFAULT}}catch(o){return console.error("Failed to get charges:",o),{charges:0,max:1,cooldown:y.COOLDOWN_DEFAULT}}}},He={pollTimer:null,pollIntervalMs:6e4,icon(){let t=document.querySelector("link[rel~='icon']");return(t==null?void 0:t.href)||location.origin+"/favicon.ico"},async requestPermission(){if(!("Notification"in window))return i.showAlert(i.t("notificationsNotSupported"),"warning"),"denied";if(Notification.permission==="granted")return"granted";try{return await Notification.requestPermission()}catch{return Notification.permission}},canNotify(){return e.notificationsEnabled&&typeof Notification<"u"&&Notification.permission==="granted"},notify(t,a,n="wplace-charges",o=!1){if(!this.canNotify()||!o&&e.notifyOnlyWhenUnfocused&&document.hasFocus())return!1;try{return new Notification(t,{body:a,tag:n,renotify:!0,icon:this.icon(),badge:this.icon(),silent:!1}),!0}catch{return i.showAlert(a,"info"),!1}},resetEdgeTracking(){e._lastChargesBelow=e.currentCharges<e.cooldownChargeThreshold,e._lastChargesNotifyAt=0},maybeNotifyChargesReached(t=!1){if(!e.notificationsEnabled||!e.notifyOnChargesReached)return;let a=e.currentCharges>=e.cooldownChargeThreshold,n=Date.now(),o=Math.max(1,Number(e.notificationIntervalMinutes||5))*6e4;if(a){let r=e._lastChargesBelow||t,l=n-(e._lastChargesNotifyAt||0)>=o;if(r||l){let s=i.t("chargesReadyMessage",{current:Math.floor(e.currentCharges),max:e.maxCharges,threshold:e.cooldownChargeThreshold});this.notify(i.t("chargesReadyNotification"),s,"wplace-notify-charges"),e._lastChargesNotifyAt=n}e._lastChargesBelow=!1}else e._lastChargesBelow=!0},startPolling(){this.stopPolling(),!(!e.notificationsEnabled||!e.notifyOnChargesReached)&&(this.pollTimer=setInterval(async()=>{try{let{charges:t,cooldown:a,max:n}=await Qt.getCharges();e.currentCharges=Math.floor(t),e.cooldown=a,e.maxCharges=Math.max(1,Math.floor(n)),this.maybeNotifyChargesReached()}catch{}},this.pollIntervalMs))},stopPolling(){this.pollTimer&&(clearInterval(this.pollTimer),this.pollTimer=null)},syncFromState(){this.resetEdgeTracking(),e.notificationsEnabled&&e.notifyOnChargesReached?this.startPolling():this.stopPolling()}},Je=new Map;function ya(t,a){if(!a||a.length===0)return 1;let n=`${t[0]},${t[1]},${t[2]}|${e.colorMatchingAlgorithm}|${e.enableChromaPenalty?"c":"nc"}|${e.chromaPenaltyWeight}`;if(Je.has(n))return Je.get(n);let o=e.customWhiteThreshold||y.WHITE_THRESHOLD;if(t[0]>=o&&t[1]>=o&&t[2]>=o){let s=a.find(d=>d.rgb[0]>=o&&d.rgb[1]>=o&&d.rgb[2]>=o);if(s)return Je.set(n,s.id),s.id}let r=a[0].id,l=1/0;if(e.colorMatchingAlgorithm==="legacy")for(let s=0;s<a.length;s++){let d=a[s],[h,p,m]=d.rgb,g=(h+t[0])/2,S=h-t[0],w=p-t[1],u=m-t[2],z=Math.sqrt(((512+g)*S*S>>8)+4*w*w+((767-g)*u*u>>8));if(z<l&&(l=z,r=d.id,z===0))break}else{let[s,d,h]=i._lab(t[0],t[1],t[2]),p=Math.sqrt(d*d+h*h),m=e.enableChromaPenalty?e.chromaPenaltyWeight||.15:0;for(let g=0;g<a.length;g++){let S=a[g],[w,u,z]=S.rgb,[C,T,P]=i._lab(w,u,z),B=s-C,O=d-T,V=h-P,j=B*B+O*O+V*V;if(m>0&&p>20){let le=Math.sqrt(T*T+P*P);if(le<p){let te=p-le;j+=te*te*m}}if(j<l&&(l=j,r=S.id,j===0))break}}if(Je.set(n,r),Je.size>15e3){let s=Je.keys().next().value;Je.delete(s)}return r}let N=()=>{},Ee=()=>{},dt=()=>{};function St(){var a;e.activeColorPalette=[];let t=document.querySelectorAll(".wplace-color-swatch.active");t&&t.forEach(n=>{let o=n.getAttribute("data-rgb");if(o){let r=o.split(",").map(Number);e.activeColorPalette.push(r)}}),((a=document.querySelector(".resize-container"))==null?void 0:a.style.display)==="block"&&ge()}function xa(t,a=!1){let n=document.querySelectorAll(".wplace-color-swatch");n&&n.forEach(o=>{let r=o.classList.contains("unavailable");(!r||a)&&(r||o.classList.toggle("active",t))}),St()}function Ja(){let t=document.querySelectorAll(".wplace-color-swatch");t&&t.forEach(a=>{let n=parseInt(a.getAttribute("data-color-id"),10);!isNaN(n)&&n>=32&&a.classList.toggle("active",!1)}),St()}function Za(t){var r,l,s;let a=t.querySelector("#colors-container"),n=t.querySelector("#showAllColorsToggle");if(!a)return;if(!e.availableColors||e.availableColors.length===0){a.innerHTML=`<div class="wplace-colors-placeholder">${i.t("uploadImageFirst")}</div>`;return}function o(d=!1){a.innerHTML="";let h=0,p=0;Object.values(y.COLOR_MAP).filter(g=>g.rgb!==null).forEach(g=>{let{id:S,name:w,rgb:u}=g,z=`${u.r},${u.g},${u.b}`;p++;let C=e.availableColors.some(O=>O.rgb[0]===u.r&&O.rgb[1]===u.g&&O.rgb[2]===u.b);if(!d&&!C)return;C&&h++;let T=i.createElement("div",{className:"wplace-color-item"}),P=i.createElement("button",{className:`wplace-color-swatch ${C?"":"unavailable"}`,title:`${w} (ID: ${S})${C?"":" (Unavailable)"}`,"data-rgb":z,"data-color-id":S});P.style.backgroundColor=`rgb(${u.r}, ${u.g}, ${u.b})`,C?P.classList.add("active"):(P.style.opacity="0.4",P.style.filter="grayscale(50%)",P.disabled=!0);let B=i.createElement("span",{className:"wplace-color-item-name",style:C?"":"color: #888; font-style: italic;"},w+(C?"":" (N/A)"));C&&P.addEventListener("click",()=>{P.classList.toggle("active"),St()}),T.appendChild(P),T.appendChild(B),a.appendChild(T)}),St()}o(!1),n&&n.addEventListener("change",d=>{o(d.target.checked)}),(r=t.querySelector("#selectAllBtn"))==null||r.addEventListener("click",()=>xa(!0,n==null?void 0:n.checked)),(l=t.querySelector("#unselectAllBtn"))==null||l.addEventListener("click",()=>xa(!1,n==null?void 0:n.checked)),(s=t.querySelector("#unselectPaidBtn"))==null||s.addEventListener("click",()=>Ja())}async function ea(){let t=performance.now();if(e.tokenSource==="manual")return console.log("\u{1F3AF} Manual token source selected - using pixel placement automation"),await Tt();try{let a=i.detectSitekey();console.log("\u{1F511} Generating Turnstile token for sitekey:",a),console.log("\u{1F9ED} UA:",navigator.userAgent.substring(0,50)+"...","Platform:",navigator.platform),window.turnstile||await i.loadTurnstile();let n=await i.generatePaintToken(a);if(console.log(`\u{1F50D} Token received - Type: ${typeof n}, Value: ${n?typeof n=="string"?n.length>50?n.substring(0,50)+"...":n:JSON.stringify(n):"null/undefined"}, Length: ${(n==null?void 0:n.length)||0}`),typeof n=="string"&&n.length>20){let o=Math.round(performance.now()-t);return console.log(`\u2705 Turnstile token generated successfully in ${o}ms`),n}else throw new Error(`Invalid or empty token received - Type: ${typeof n}, Value: ${JSON.stringify(n)}, Length: ${(n==null?void 0:n.length)||0}`)}catch(a){let n=Math.round(performance.now()-t);if(console.error(`\u274C Turnstile token generation failed after ${n}ms:`,a),e.tokenSource==="hybrid")return console.log("\u{1F504} Hybrid mode: Generator failed, automatically switching to manual pixel placement..."),await Tt();throw a}}async function Tt(){return new Promise(async(t,a)=>{try{$e||(nt=new Promise(r=>{$e=r}));let n=i.sleep(2e4).then(()=>a(new Error("Auto-CAPTCHA timed out."))),o=(async()=>{let r=await i.waitForSelector("button.btn.btn-primary.btn-lg, button.btn-primary.sm\\:btn-xl",200,1e4);if(!r)throw new Error("Could not find the main paint button.");r.click(),await i.sleep(500);let l=await i.waitForSelector("button#color-0",200,5e3);if(!l)throw new Error("Could not find the transparent color button.");l.click(),await i.sleep(500);let s=await i.waitForSelector("canvas",200,5e3);if(!s)throw new Error("Could not find the canvas element.");s.setAttribute("tabindex","0"),s.focus();let d=s.getBoundingClientRect(),h=Math.round(d.left+d.width/2),p=Math.round(d.top+d.height/2);s.dispatchEvent(new MouseEvent("mousemove",{clientX:h,clientY:p,bubbles:!0})),s.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",bubbles:!0})),await i.sleep(50),s.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",bubbles:!0})),await i.sleep(500),await i.sleep(800),(async()=>{for(;!Se;){let S=await i.waitForSelector("button.btn.btn-primary.btn-lg, button.btn.btn-primary.sm\\:btn-xl");if(!S){let w=Array.from(document.querySelectorAll("button.btn-primary"));S=w.length?w[w.length-1]:null}S&&S.click(),await i.sleep(500)}})();let g=await nt;await i.sleep(300),t(g)})();await Promise.race([o,n])}catch(n){console.error("Auto-CAPTCHA process failed:",n),a(n)}})}async function ta(){var Ma,Aa;await Ka();let t=document.getElementById("wplace-image-bot-container"),a=document.getElementById("wplace-stats-container"),n=document.getElementById("wplace-settings-container"),o=document.querySelector(".resize-container"),r=document.querySelector(".resize-overlay");t&&t.remove(),a&&a.remove(),n&&n.remove(),o&&o.remove(),r&&r.remove(),ma(),await Ya();let l=ua(),s=ct[l]||{};qt();let d=document.createElement("link");if(d.rel="stylesheet",d.href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css",document.head.appendChild(d),s.fontFamily&&s.fontFamily.includes("Press Start 2P")){let x=document.createElement("link");x.rel="stylesheet",x.href="https://fonts.googleapis.com/css2?family=Press+Start+2P&display=swap",document.head.appendChild(x)}let h=document.createElement("style");h.textContent=_a,h.setAttribute("data-wplace-theme","true"),document.head.appendChild(h);let p=document.createElement("div");p.id="wplace-image-bot-container",p.innerHTML=`
    ...
    `;let m=document.createElement("div");m.id="wplace-stats-container",m.style.display="none",m.innerHTML=`
      <div class="wplace-header">
        <div class="wplace-header-title">
          <i class="fas fa-chart-bar"></i>
    ...
    `;let g=document.createElement("div");g.id="wplace-settings-container";let S=s.primary?`linear-gradient(135deg, ${s.primary} 0%, ${s.secondary||s.primary} 100%)`:"linear-gradient(135deg, #667eea 0%, #764ba2 100%)";g.className="wplace-settings-container-base",g.style.background=S,g.style.cssText+=`
      min-width: 420px;
      max-width: 480px;
      z-index: 99999;
      color: ${s.text||"white"};
        ...
        <div class="wplace-settings-section">
          ...
          <div id="normalBatchControls" class="wplace-batch-controls wplace-normal-batch-controls">
            <div class="wplace-speed-slider-container">
              <input type="range" id="speedSlider" min="${y.PAINTING_SPEED.MIN}" max="${y.PAINTING_SPEED.MAX}" value="${y.PAINTING_SPEED.DEFAULT}" class="wplace-speed-slider">
              <div id="speedValue" class="wplace-speed-value">${y.PAINTING_SPEED.DEFAULT} (batch size)</div>
            </div>
            <div class="wplace-speed-labels">
              <span class="wplace-speed-min"><i class="fas fa-turtle"></i> ${y.PAINTING_SPEED.MIN}</span>
              <span class="wplace-speed-max"><i class="fas fa-rabbit"></i> ${y.PAINTING_SPEED.MAX}</span>
            </div>
          </div>
          ...
          <div id="randomBatchControls" class="wplace-batch-controls wplace-random-batch-controls">
            <div class="wplace-random-batch-grid">
              <div>
                ...
                <input type="number" id="randomBatchMin" min="1" max="1000" value="${y.RANDOM_BATCH_RANGE.MIN}" class="wplace-random-batch-input">
              </div>
              <div>
                <label class="wplace-random-batch-label">
                ...
                <input type="number" id="randomBatchMax" min="1" max="1000" value="${y.RANDOM_BATCH_RANGE.MAX}" class="wplace-random-batch-input">
              </div>
            </div>
          ...
          <label class="wplace-speed-control-toggle">
            <input type="checkbox" id="enableSpeedToggle" ${y.PAINTING_SPEED_ENABLED?"checked":""} class="wplace-speed-checkbox"/>
        ...
        <div class="wplace-settings-section">
          ...
          <div class="wplace-settings-section-wrapper">
            <select id="themeSelect" class="wplace-settings-select">
              ${Wa().map(x=>`<option value="${x}" ${y.currentTheme===x?"selected":""} class="wplace-settings-option">${x}</option>`).join("")}
            </select>
          </div>
        </div>
    ...
    `;let w=document.createElement("div");w.className="resize-container",w.innerHTML=`
    ...
    `;let u=document.createElement("div");u.className="resize-overlay",document.body.appendChild(p),document.body.appendChild(u),document.body.appendChild(w),document.body.appendChild(m),document.body.appendChild(g),p.style.display="block";let z=p.querySelector("#uploadBtn"),C=p.querySelector("#resizeBtn"),T=p.querySelector("#selectPosBtn"),P=p.querySelector("#startBtn"),B=p.querySelector("#stopBtn"),O=p.querySelector("#saveBtn"),V=p.querySelector("#loadBtn"),j=p.querySelector("#saveToFileBtn"),le=p.querySelector("#loadFromFileBtn");V&&(V.disabled=!e.initialSetupComplete,V.title=e.initialSetupComplete?"":"\u{1F504} Waiting for initial setup to complete..."),le&&(le.disabled=!e.initialSetupComplete,le.title=e.initialSetupComplete?"":"\u{1F504} Waiting for initial setup to complete..."),z&&(z.disabled=!e.initialSetupComplete,z.title=e.initialSetupComplete?"":"\u{1F504} Waiting for initial setup to complete...");let te=p.querySelector("#minimizeBtn"),ze=p.querySelector("#compactBtn"),he=p.querySelector("#statsBtn"),we=p.querySelector("#toggleOverlayBtn"),be=p.querySelector("#statusText"),Ze=p.querySelector("#progressBar"),it=m.querySelector("#statsArea"),Ue=p.querySelector(".wplace-content"),ot=m.querySelector("#closeStatsBtn"),Ce=m.querySelector("#refreshChargesBtn"),Me=p.querySelector("#cooldownSlider"),Le=p.querySelector("#cooldownValue");(!z||!T||!P||!B)&&console.error("Some UI elements not found:",{uploadBtn:!!z,selectPosBtn:!!T,startBtn:!!P,stopBtn:!!B});let rt=p.querySelector(".wplace-header");st(p);function st(x){let A=0,R=0,F=0,re=0,U=!1,ce=x.querySelector(".wplace-header")||x.querySelector(".wplace-settings-header");if(!ce){console.warn("No draggable header found for element:",x);return}ce.onmousedown=ve;function ve(se){if(se.target.closest(".wplace-header-btn")||se.target.closest("button"))return;se.preventDefault(),U=!0;let ie=x.getBoundingClientRect();x.style.transform="none",x.style.top=ie.top+"px",x.style.left=ie.left+"px",F=se.clientX,re=se.clientY,x.classList.add("wplace-dragging"),document.onmouseup=ye,document.onmousemove=ne,document.body.style.userSelect="none"}function ne(se){if(!U)return;se.preventDefault(),A=F-se.clientX,R=re-se.clientY,F=se.clientX,re=se.clientY;let ie=x.offsetTop-R,Ne=x.offsetLeft-A,_e=x.getBoundingClientRect(),et=window.innerHeight-_e.height,xe=window.innerWidth-_e.width;ie=Math.max(0,Math.min(ie,et)),Ne=Math.max(0,Math.min(Ne,xe)),x.style.top=ie+"px",x.style.left=Ne+"px"}function ye(){U=!1,x.classList.remove("wplace-dragging"),document.onmouseup=null,document.onmousemove=null,document.body.style.userSelect=""}}st(m),st(p),he&&ot&&(he.addEventListener("click",()=>{m.style.display!=="none"?(m.style.display="none",he.innerHTML='<i class="fas fa-chart-bar"></i>',he.title=i.t("showStats")):(m.style.display="block",he.innerHTML='<i class="fas fa-chart-line"></i>',he.title=i.t("hideStats"))}),ot.addEventListener("click",()=>{m.style.display="none",he.innerHTML='<i class="fas fa-chart-bar"></i>',he.title=i.t("showStats")}),Ce&&Ce.addEventListener("click",async()=>{Ce.innerHTML='<i class="fas fa-spinner fa-spin"></i>',Ce.disabled=!0;try{await Ee()}catch(x){console.error("Error refreshing charges:",x)}finally{Ce.innerHTML='<i class="fas fa-sync"></i>',Ce.disabled=!1}})),m&&he&&(he.innerHTML='<i class="fas fa-chart-bar"></i>',he.title=i.t("showStats"));let It=p.querySelector("#settingsBtn"),pt=g.querySelector("#closeSettingsBtn"),aa=g.querySelector("#applySettingsBtn");if(It&&pt&&aa){It.addEventListener("click",()=>{g.classList.contains("show")?(g.style.animation="settingsFadeOut 0.3s ease-out forwards",g.classList.remove("show"),setTimeout(()=>{g.style.animation=""},300)):(g.style.top="50%",g.style.left="50%",g.style.transform="translate(-50%, -50%)",g.classList.add("show"),g.style.animation="settingsSlideIn 0.4s ease-out")}),pt.addEventListener("click",()=>{g.style.animation="settingsFadeOut 0.3s ease-out forwards",g.classList.remove("show"),setTimeout(()=>{g.style.animation="",g.style.top="50%",g.style.left="50%",g.style.transform="translate(-50%, -50%)"},300)}),aa.addEventListener("click",()=>{let M=document.getElementById("colorAlgorithmSelect");M&&(e.colorMatchingAlgorithm=M.value);let W=document.getElementById("enableChromaPenaltyToggle");W&&(e.enableChromaPenalty=W.checked);let Ye=document.getElementById("chromaPenaltyWeightSlider");Ye&&(e.chromaPenaltyWeight=parseFloat(Ye.value)||.15);let zt=document.getElementById("transparencyThresholdInput");if(zt){let G=parseInt(zt.value,10);!isNaN(G)&&G>=0&&G<=255&&(e.customTransparencyThreshold=G)}let lt=document.getElementById("whiteThresholdInput");if(lt){let G=parseInt(lt.value,10);!isNaN(G)&&G>=200&&G<=255&&(e.customWhiteThreshold=G)}y.TRANSPARENCY_THRESHOLD=e.customTransparencyThreshold,y.WHITE_THRESHOLD=e.customWhiteThreshold;let Mt=document.getElementById("notifEnabledToggle"),At=document.getElementById("notifOnChargesToggle"),Dt=document.getElementById("notifOnlyUnfocusedToggle"),me=document.getElementById("notifIntervalInput");if(Mt&&(e.notificationsEnabled=!!Mt.checked),At&&(e.notifyOnChargesReached=!!At.checked),Dt&&(e.notifyOnlyWhenUnfocused=!!Dt.checked),me){let G=parseInt(me.value,10);!isNaN(G)&&G>=1&&G<=60&&(e.notificationIntervalMinutes=G)}Z(),i.showAlert(i.t("settingsSaved"),"success"),pt.click(),He.syncFromState()}),st(g);let x=g.querySelector("#tokenSourceSelect");x&&x.addEventListener("change",M=>{e.tokenSource=M.target.value,Z(),console.log(`\u{1F511} Token source changed to: ${e.tokenSource}`);let W={generator:"Automatic Generator",hybrid:"Generator + Auto Fallback",manual:"Manual Pixel Placement"};i.showAlert(i.t("tokenSourceSet",{source:W[e.tokenSource]}),"success")});let A=g.querySelector("#batchModeSelect"),R=g.querySelector("#normalBatchControls"),F=g.querySelector("#randomBatchControls"),re=g.querySelector("#randomBatchMin"),U=g.querySelector("#randomBatchMax");A&&A.addEventListener("change",M=>{e.batchMode=M.target.value,R&&F&&(M.target.value==="random"?(R.style.display="none",F.style.display="block"):(R.style.display="block",F.style.display="none")),Z(),console.log(`\u{1F4E6} Batch mode changed to: ${e.batchMode}`),i.showAlert(i.t("batchModeSet",{mode:e.batchMode==="random"?i.t("randomRange"):i.t("normalFixedSize")}),"success")}),re&&re.addEventListener("input",M=>{let W=parseInt(M.target.value);W>=1&&W<=1e3&&(e.randomBatchMin=W,U&&W>e.randomBatchMax&&(e.randomBatchMax=W,U.value=W),Z())}),U&&U.addEventListener("input",M=>{let W=parseInt(M.target.value);W>=1&&W<=1e3&&(e.randomBatchMax=W,re&&W<e.randomBatchMin&&(e.randomBatchMin=W,re.value=W),Z())});let ce=g.querySelector("#languageSelect");ce&&ce.addEventListener("change",async M=>{let W=M.target.value;e.language=W,localStorage.setItem("wplace_language",W),await Vt(W),setTimeout(()=>{g.style.display="none",ta()},100)});let ve=g.querySelector("#themeSelect");ve&&ve.addEventListener("change",M=>{let W=M.target.value;Ha(W)});let ne=g.querySelector("#overlayOpacitySlider"),ye=g.querySelector("#overlayOpacityValue"),se=g.querySelector("#enableBlueMarbleToggle"),ie=g.querySelector("#settingsPaintWhiteToggle"),Ne=g.querySelector("#settingsPaintTransparentToggle");ne&&ye&&ne.addEventListener("input",M=>{let W=parseFloat(M.target.value);e.overlayOpacity=W,ye.textContent=`${Math.round(W*100)}%`}),ie&&ie.addEventListener("change",M=>{e.paintWhitePixels=M.target.checked,Z()}),Ne&&Ne.addEventListener("change",M=>{e.paintTransparentPixels=M.target.checked,Z()});let _e=g.querySelector("#speedSlider"),et=g.querySelector("#speedValue");_e&&et&&_e.addEventListener("input",M=>{let W=parseInt(M.target.value,10);e.paintingSpeed=W,et.textContent=`${W} (batch size)`,Z()}),se&&se.addEventListener("click",async()=>{e.blueMarbleEnabled=se.checked,e.imageLoaded&&Te.imageBitmap&&(i.showAlert(i.t("reprocessingOverlay"),"info"),await Te.processImageIntoChunks(),i.showAlert(i.t("overlayUpdated"),"success"))});let xe=g.querySelector("#notifRequestPermBtn"),_=g.querySelector("#notifTestBtn");xe&&xe.addEventListener("click",async()=>{await He.requestPermission()==="granted"?i.showAlert(i.t("notificationsEnabled"),"success"):i.showAlert(i.t("notificationsPermissionDenied"),"warning")}),_&&_.addEventListener("click",()=>{He.notify(i.t("testNotificationTitle"),i.t("testNotificationMessage"),"wplace-notify-test",!0)})}let Ae=w.querySelector("#widthSlider"),De=w.querySelector("#heightSlider"),ka=w.querySelector("#widthValue"),Sa=w.querySelector("#heightValue"),Ta=w.querySelector("#keepAspect"),Ca=w.querySelector("#paintWhiteToggle"),Pa=w.querySelector("#paintTransparentToggle"),We=w.querySelector("#zoomSlider"),Et=w.querySelector("#zoomValue"),gt=w.querySelector("#zoomInBtn"),ht=w.querySelector("#zoomOutBtn"),Ia=w.querySelector("#zoomFitBtn"),Ea=w.querySelector("#zoomActualBtn"),ut=w.querySelector("#panModeBtn"),de=w.querySelector("#resizePanStage"),mt=w.querySelector("#resizeCanvasStack"),q=w.querySelector("#resizeCanvas"),ue=w.querySelector("#maskCanvas"),Qe=q.getContext("2d"),qe=ue.getContext("2d"),on=w.querySelector("#confirmResize"),rn=w.querySelector("#cancelResize"),sn=w.querySelector("#downloadPreviewBtn"),Sn=w.querySelector("#clearIgnoredBtn");ze&&ze.addEventListener("click",()=>{p.classList.toggle("wplace-compact"),p.classList.contains("wplace-compact")?(ze.innerHTML='<i class="fas fa-expand"></i>',ze.title=i.t("expandMode")):(ze.innerHTML='<i class="fas fa-compress"></i>',ze.title=i.t("compactMode"))}),te&&te.addEventListener("click",()=>{e.minimized=!e.minimized,e.minimized?(p.classList.add("wplace-minimized"),Ue.classList.add("wplace-hidden"),te.innerHTML='<i class="fas fa-expand"></i>',te.title=i.t("restore")):(p.classList.remove("wplace-minimized"),Ue.classList.remove("wplace-hidden"),te.innerHTML='<i class="fas fa-minus"></i>',te.title=i.t("minimize")),Z()}),we&&we.addEventListener("click",()=>{let x=Te.toggle();we.classList.toggle("active",x),we.setAttribute("aria-pressed",x?"true":"false"),i.showAlert(x?i.t("overlayEnabled"):i.t("overlayDisabled"),"info")}),e.minimized?(p.classList.add("wplace-minimized"),Ue.classList.add("wplace-hidden"),te&&(te.innerHTML='<i class="fas fa-expand"></i>',te.title=i.t("restore"))):(p.classList.remove("wplace-minimized"),Ue.classList.remove("wplace-hidden"),te&&(te.innerHTML='<i class="fas fa-minus"></i>',te.title=i.t("minimize"))),O&&O.addEventListener("click",()=>{if(!e.imageLoaded){i.showAlert(i.t("missingRequirements"),"error");return}i.saveProgress()?(N("autoSaved","success"),i.showAlert(i.t("autoSaved"),"success")):i.showAlert(i.t("errorSavingProgress"),"error")}),V&&V.addEventListener("click",()=>{if(!e.initialSetupComplete){i.showAlert(i.t("pleaseWaitInitialSetup"),"warning");return}let x=i.loadProgress();if(!x){N("noSavedData","warning"),i.showAlert(i.t("noSavedData"),"warning");return}confirm(`${i.t("savedDataFound")}

Saved: ${new Date(x.timestamp).toLocaleString()}
Progress: ${x.state.paintedPixels}/${x.state.totalPixels} pixels`)&&(i.restoreProgress(x)?(N("dataLoaded","success"),i.showAlert(i.t("dataLoaded"),"success"),dt(),Ee(),i.restoreOverlayFromData().catch(F=>{console.error("Failed to restore overlay from localStorage:",F)}),e.colorsChecked?(z.disabled=!1,T.disabled=!1):z.disabled=!1,e.imageLoaded&&e.startPosition&&e.region&&e.colorsChecked&&(P.disabled=!1)):i.showAlert(i.t("errorLoadingProgress"),"error"))}),j&&j.addEventListener("click",()=>{i.saveProgressToFile()?(N("fileSaved","success"),i.showAlert(i.t("fileSaved"),"success")):i.showAlert(i.t("fileError"),"error")}),le&&le.addEventListener("click",async()=>{if(!e.initialSetupComplete){i.showAlert(i.t("pleaseWaitFileSetup"),"warning");return}try{await i.loadProgressFromFile()&&(N("fileLoaded","success"),i.showAlert(i.t("fileLoaded"),"success"),dt(),await Ee(),await i.restoreOverlayFromData().catch(A=>{console.error("Failed to restore overlay from file:",A)}),e.colorsChecked?(z.disabled=!1,T.disabled=!1,C.disabled=!1):z.disabled=!1,e.imageLoaded&&e.startPosition&&e.region&&e.colorsChecked&&(P.disabled=!1))}catch(x){x.message==="Invalid JSON file"?i.showAlert(i.t("invalidFileFormat"),"error"):i.showAlert(i.t("fileError"),"error")}}),N=(x,A="default",R={})=>{let F=i.t(x,R);be.textContent=F,be.className=`wplace-status status-${A}`,be.style.animation="none",be.offsetWidth,be.style.animation="slideIn 0.3s ease-out"},Ee=async()=>{let{charges:x,cooldown:A,max:R}=await Qt.getCharges();e.currentCharges=Math.floor(x),e.cooldown=A,e.maxCharges=Math.floor(R)>1?Math.floor(R):e.maxCharges,He.maybeNotifyChargesReached(),Me.max!=e.maxCharges&&(Me.max=e.maxCharges);let F="";if(e.imageLoaded){let U=e.totalPixels>0?Math.round(e.paintedPixels/e.totalPixels*100):0,ce=e.totalPixels-e.paintedPixels;e.estimatedTime=i.calculateEstimatedTime(ce,e.currentCharges,e.cooldown),Ze.style.width=`${U}%`,F=`
                <div class="wplace-stat-item">
                <div class="wplace-stat-label"><i class="fas fa-image"></i> ${i.t("progress")}</div>
                <div class="wplace-stat-value">${U}%</div>
                </div>
                <div class="wplace-stat-item">
            ...
            `}let re="";e.colorsChecked&&(re=e.availableColors.map(U=>`<div class="wplace-stat-color-swatch" style="background-color: ${`rgb(${U.rgb.join(",")})`};" title="${i.t("colorTooltip",{id:U.id,rgb:U.rgb.join(", ")})}"></div>`).join("")),it.innerHTML=`
            ${F}
            <div class="wplace-stat-item">
            ...
            `:""}
        `},dt=()=>{let x=e.imageLoaded&&e.imageData;O.disabled=!x,j.disabled=!x},dt();function ln(x){var $a;let A=x,R,F;if(($a=e.originalImage)!=null&&$a.dataUrl)A=new Zt(e.originalImage.dataUrl),R=e.originalImage.width,F=e.originalImage.height;else{let c=x.getDimensions();R=c.width,F=c.height}let re=R/F,U=e.resizeSettings;Ae.max=R*2,De.max=F*2;let ce=R,ve=F;U&&Number.isFinite(U.width)&&Number.isFinite(U.height)&&U.width>0&&U.height>0&&(ce=U.width,ve=U.height),ce=Math.max(parseInt(Ae.min,10)||10,Math.min(ce,parseInt(Ae.max,10))),ve=Math.max(parseInt(De.min,10)||10,Math.min(ve,parseInt(De.max,10))),Ae.value=ce,De.value=ve,ka.textContent=ce,Sa.textContent=ve,We.value=1,Et&&(Et.textContent="100%"),Ca.checked=e.paintWhitePixels,Pa.checked=e.paintTransparentPixels;let ne=null,ye=0,se=!1,ie=1,Ne=null,_e=null,et=c=>((!Ne||Ne.length!==c*3)&&(Ne=new Float32Array(c*3)),(!_e||_e.length!==c)&&(_e=new Uint8Array(c)),{work:Ne,eligible:_e}),xe=null,_=null,M=null,W=()=>{M={minX:1/0,minY:1/0,maxX:-1,maxY:-1}},Ye=(c,f)=>{M||W(),c<M.minX&&(M.minX=c),f<M.minY&&(M.minY=f),c>M.maxX&&(M.maxX=c),f>M.maxY&&(M.maxY=f)},zt=()=>{if(!M||M.maxX<M.minX||M.maxY<M.minY)return;let c=Math.max(0,M.minX),f=Math.max(0,M.minY),b=Math.min(ue.width-c,M.maxX-c+1),v=Math.min(ue.height-f,M.maxY-f+1);b>0&&v>0&&qe.putImageData(xe,0,0,c,f,b,v),W()},lt=(c,f,b=!1)=>{if((!xe||xe.width!==c||xe.height!==f)&&(xe=qe.createImageData(c,f),_=xe.data,b=!0),b){let v=e.resizeIgnoreMask,k=_;if(k.fill(0),v){for(let I=0;I<v.length;I++)if(v[I]){let K=I*4;k[K]=255,k[K+1]=0,k[K+2]=0,k[K+3]=150}}qe.putImageData(xe,0,0),W()}},Mt=(c,f)=>{(!e.resizeIgnoreMask||e.resizeIgnoreMask.length!==c*f)&&(e.resizeIgnoreMask=new Uint8Array(c*f)),q.width=c,q.height=f,ue.width=c,ue.height=f,qe.clearRect(0,0,ue.width,ue.height),lt(c,f,!0)};ge=async()=>{let c=++ye,f=parseInt(Ae.value,10),b=parseInt(De.value,10);if(ie=parseFloat(We.value),ka.textContent=f,Sa.textContent=b,Mt(f,b),mt.style.width=f+"px",mt.style.height=b+"px",Qe.imageSmoothingEnabled=!1,!e.availableColors||e.availableColors.length===0){A!==x&&(!A.img||!A.canvas)&&await A.load(),Qe.clearRect(0,0,f,b),Qe.drawImage(A.img,0,0,f,b),qe.clearRect(0,0,ue.width,ue.height),xe&&qe.putImageData(xe,0,0),ia();return}A!==x&&(!A.img||!A.canvas)&&await A.load(),Qe.clearRect(0,0,f,b),Qe.drawImage(A.img,0,0,f,b);let v=Qe.getImageData(0,0,f,b),k=v.data,I=e.customTransparencyThreshold||y.TRANSPARENCY_THRESHOLD,K=()=>{let E=f,$=b,ae=E*$,{work:D,eligible:Y}=et(ae);for(let H=0;H<$;H++)for(let oe=0;oe<E;oe++){let J=H*E+oe,fe=J*4,Pe=k[fe],X=k[fe+1],Q=k[fe+2],ee=k[fe+3],pe=(e.paintTransparentPixels||ee>=I)&&(e.paintWhitePixels||!i.isWhitePixel(Pe,X,Q));Y[J]=pe?1:0,D[J*3]=Pe,D[J*3+1]=X,D[J*3+2]=Q,pe||(k[fe+3]=0)}let L=(H,oe,J,fe,Pe,X)=>{if(H<0||H>=E||oe<0||oe>=$)return;let Q=oe*E+H;if(!Y[Q])return;let ee=Q*3;D[ee]=Math.min(255,Math.max(0,D[ee]+J*X)),D[ee+1]=Math.min(255,Math.max(0,D[ee+1]+fe*X)),D[ee+2]=Math.min(255,Math.max(0,D[ee+2]+Pe*X))};for(let H=0;H<$;H++)for(let oe=0;oe<E;oe++){let J=H*E+oe;if(!Y[J])continue;let fe=J*3,Pe=D[fe],X=D[fe+1],Q=D[fe+2],[ee,pe,Oe]=i.findClosestPaletteColor(Pe,X,Q,e.activeColorPalette),Ie=J*4;k[Ie]=ee,k[Ie+1]=pe,k[Ie+2]=Oe,k[Ie+3]=255;let Be=Pe-ee,ke=X-pe,Ke=Q-Oe;L(oe+1,H,Be,ke,Ke,7/16),L(oe-1,H+1,Be,ke,Ke,3/16),L(oe,H+1,Be,ke,Ke,5/16),L(oe+1,H+1,Be,ke,Ke,1/16)}};if(e.ditheringEnabled&&!se)K();else for(let E=0;E<k.length;E+=4){let $=k[E],ae=k[E+1],D=k[E+2],Y=k[E+3];if(!e.paintTransparentPixels&&Y<I||!e.paintWhitePixels&&i.isWhitePixel($,ae,D)){k[E+3]=0;continue}let[L,H,oe]=i.findClosestPaletteColor($,ae,D,e.activeColorPalette);k[E]=L,k[E+1]=H,k[E+2]=oe,k[E+3]=255}c===ye&&(Qe.putImageData(v,0,0),qe.clearRect(0,0,ue.width,ue.height),xe&&qe.putImageData(xe,0,0),ia())};let At=()=>{Ta.checked&&(De.value=Math.round(parseInt(Ae.value,10)/re)),ge();let c=parseInt(Ae.value,10),f=parseInt(De.value,10);e.resizeSettings={baseWidth:R,baseHeight:F,width:c,height:f},Z();let b=typeof Ge=="function"?Ge():1;!isNaN(b)&&isFinite(b)&&Fe(b)},Dt=()=>{Ta.checked&&(Ae.value=Math.round(parseInt(De.value,10)*re)),ge();let c=parseInt(Ae.value,10),f=parseInt(De.value,10);e.resizeSettings={baseWidth:R,baseHeight:F,width:c,height:f},Z();let b=typeof Ge=="function"?Ge():1;!isNaN(b)&&isFinite(b)&&Fe(b)};Ca.onchange=c=>{e.paintWhitePixels=c.target.checked,ge(),Z()},Pa.onchange=c=>{e.paintTransparentPixels=c.target.checked,ge(),Z()};let me=0,G=0,dn=()=>{let c=(de==null?void 0:de.getBoundingClientRect())||{width:0,height:0},f=(q.width||1)*ie,b=(q.height||1)*ie;if(f<=c.width)me=Math.floor((c.width-f)/2);else{let v=c.width-f;me=Math.min(0,Math.max(v,me))}if(b<=c.height)G=Math.floor((c.height-b)/2);else{let v=c.height-b;G=Math.min(0,Math.max(v,G))}},na=0,Bt=()=>{na||(na=requestAnimationFrame(()=>{dn(),mt.style.transform=`translate3d(${Math.round(me)}px, ${Math.round(G)}px, 0) scale(${ie})`,na=0}))},ia=()=>{let c=q.width||1,f=q.height||1;q.style.width=c+"px",q.style.height=f+"px",ue.style.width=c+"px",ue.style.height=f+"px",mt.style.width=c+"px",mt.style.height=f+"px",Bt()},Fe=c=>{ie=Math.max(.05,Math.min(20,c||1)),We.value=ie,ia(),Et&&(Et.textContent=`${Math.round(ie*100)}%`)};We.addEventListener("input",()=>{Fe(parseFloat(We.value))}),gt&&gt.addEventListener("click",()=>Fe(parseFloat(We.value)+.1)),ht&&ht.addEventListener("click",()=>Fe(parseFloat(We.value)-.1));let Ge=()=>{let c=de==null?void 0:de.getBoundingClientRect();if(!c)return 1;let f=q.width||1,b=q.height||1,v=10,k=(c.width-v)/f,I=(c.height-v)/b;return Math.max(.05,Math.min(20,Math.min(k,I)))};Ia&&Ia.addEventListener("click",()=>{Fe(Ge()),wt()}),Ea&&Ea.addEventListener("click",()=>{Fe(1),wt()});let wt=()=>{if(!de)return;let c=de.getBoundingClientRect(),f=(q.width||1)*ie,b=(q.height||1)*ie;me=Math.floor((c.width-f)/2),G=Math.floor((c.height-b)/2),Bt()},Ve=!1,Lt=0,Ot=0,Rt=0,Nt=0,Xe=!1,tt=!1,pn=c=>c.button===1||c.button===2,at=c=>{de&&(de.style.cursor=c)},gn=c=>tt||Xe||pn(c),Da=()=>{ut&&(ut.classList.toggle("active",tt),ut.setAttribute("aria-pressed",tt?"true":"false"))};if(ut&&(Da(),ut.addEventListener("click",()=>{tt=!tt,Da(),at(tt?"grab":"")})),de){de.addEventListener("contextmenu",v=>{Xe&&v.preventDefault()}),window.addEventListener("keydown",v=>{v.code==="Space"&&(Xe=!0,at("grab"))}),window.addEventListener("keyup",v=>{v.code==="Space"&&(Xe=!1,Ve||at(""))}),de.addEventListener("mousedown",v=>{gn(v)&&(v.preventDefault(),Ve=!0,Lt=v.clientX,Ot=v.clientY,Rt=me,Nt=G,at("grabbing"))}),window.addEventListener("mousemove",v=>{if(!Ve)return;let k=v.clientX-Lt,I=v.clientY-Ot;me=Rt+k,G=Nt+I,Bt()}),window.addEventListener("mouseup",()=>{Ve&&(Ve=!1,at(Xe?"grab":""))}),de.addEventListener("wheel",v=>{if(!v.ctrlKey&&!v.metaKey)return;v.preventDefault();let k=de.getBoundingClientRect(),I=v.clientX-k.left-me,K=v.clientY-k.top-G,E=ie,$=Math.max(.05,Math.min(.5,Math.abs(v.deltaY)>20?.2:.1)),ae=Math.max(.05,Math.min(20,E+(v.deltaY>0?-$:$)));if(ae===E)return;let D=ae/E;me=me-I*(D-1),G=G-K*(D-1),Fe(ae)},{passive:!1});let c=null,f=0,b=null;de.addEventListener("touchstart",v=>{if(v.touches.length===1){let k=v.touches[0];Ve=!0,Lt=k.clientX,Ot=k.clientY,Rt=me,Nt=G,at("grabbing");let I=Date.now();if(I-f<300){let K=Math.abs(ie-1)<.01?Ge():1;Fe(K),wt(),b&&clearTimeout(b)}else f=I,b=setTimeout(()=>{b=null},320)}else if(v.touches.length===2){let[k,I]=v.touches;c=Math.hypot(I.clientX-k.clientX,I.clientY-k.clientY)}},{passive:!0}),de.addEventListener("touchmove",v=>{if(v.touches.length===1&&Ve){let k=v.touches[0],I=k.clientX-Lt,K=k.clientY-Ot;me=Rt+I,G=Nt+K,Bt()}else if(v.touches.length===2&&c!=null){v.preventDefault();let[k,I]=v.touches,K=Math.hypot(I.clientX-k.clientX,I.clientY-k.clientY),E=de.getBoundingClientRect(),$=(k.clientX+I.clientX)/2-E.left-me,ae=(k.clientY+I.clientY)/2-E.top-G,D=ie,Y=K/(c||K),L=Math.max(.05,Math.min(20,D*Y));L!==D&&(me=me-$*(L/D-1),G=G-ae*(L/D-1),Fe(L)),c=K}},{passive:!1}),de.addEventListener("touchend",()=>{Ve=!1,c=null,at(tt||Xe?"grab":"")})}let oa=()=>{ne&&clearTimeout(ne);let c=()=>{ne=null,ge()};window.requestIdleCallback?ne=setTimeout(()=>requestIdleCallback(c,{timeout:150}),50):ne=setTimeout(()=>requestAnimationFrame(c),50)},Ba=()=>{se=!0},La=()=>{se=!1,oa()};Ae.addEventListener("pointerdown",Ba),De.addEventListener("pointerdown",Ba),Ae.addEventListener("pointerup",La),De.addEventListener("pointerup",La),Ae.addEventListener("input",()=>{At(),oa()}),De.addEventListener("input",()=>{Dt(),oa()});let Ft=!1,hn=-1,un=-1,$t=1,ft=1,je="ignore",bt=w.querySelector("#maskBrushSize"),ra=w.querySelector("#maskBrushSizeValue"),sa=w.querySelector("#maskModeIgnore"),la=w.querySelector("#maskModeUnignore"),ca=w.querySelector("#maskModeToggle"),Oa=w.querySelector("#clearIgnoredBtn"),Ra=w.querySelector("#invertMaskBtn"),vt=w.querySelector("#rowColSize"),da=w.querySelector("#rowColSizeValue"),Na=()=>{let c=[[sa,"ignore"],[la,"unignore"],[ca,"toggle"]];for(let[f,b]of c){if(!f)continue;let v=je===b;f.classList.toggle("active",v),f.setAttribute("aria-pressed",v?"true":"false")}},pa=c=>{je=c,Na()};bt&&ra&&(bt.addEventListener("input",()=>{$t=parseInt(bt.value,10)||1,ra.textContent=$t}),ra.textContent=bt.value,$t=parseInt(bt.value,10)||1),vt&&da&&(vt.addEventListener("input",()=>{ft=parseInt(vt.value,10)||1,da.textContent=ft}),da.textContent=vt.value,ft=parseInt(vt.value,10)||1),sa&&sa.addEventListener("click",()=>pa("ignore")),la&&la.addEventListener("click",()=>pa("unignore")),ca&&ca.addEventListener("click",()=>pa("toggle")),Na();let mn=(c,f)=>{let b=q.getBoundingClientRect(),v=b.width/q.width,k=b.height/q.height,I=(c-b.left)/v,K=(f-b.top)/k,E=Math.floor(I),$=Math.floor(K);return{x:E,y:$}},ga=(c,f)=>{(!e.resizeIgnoreMask||e.resizeIgnoreMask.length!==c*f)&&(e.resizeIgnoreMask=new Uint8Array(c*f))},wn=(c,f,b,v)=>{let k=q.width,I=q.height;ga(k,I);let K=b*b;for(let E=f-b;E<=f+b;E++)if(!(E<0||E>=I))for(let $=c-b;$<=c+b;$++){if($<0||$>=k)continue;let ae=$-c,D=E-f;if(ae*ae+D*D<=K){let Y=E*k+$,L=e.resizeIgnoreMask[Y];if(je==="toggle"?L=L?0:1:je==="ignore"?L=1:L=0,e.resizeIgnoreMask[Y]=L,_){let H=Y*4;L?(_[H]=255,_[H+1]=0,_[H+2]=0,_[H+3]=150):(_[H]=0,_[H+1]=0,_[H+2]=0,_[H+3]=0),Ye($,E)}}}},fn=(c,f)=>{let b=q.width,v=q.height;if(ga(b,v),c<0||c>=v)return;let k=Math.floor(ft/2),I=Math.max(0,c-k),K=Math.min(v-1,c+k);for(let E=I;E<=K;E++){for(let $=0;$<b;$++){let ae=E*b+$,D=e.resizeIgnoreMask[ae];if(je==="toggle"?D=D?0:1:je==="ignore"?D=1:D=0,e.resizeIgnoreMask[ae]=D,_){let Y=ae*4;D?(_[Y]=255,_[Y+1]=0,_[Y+2]=0,_[Y+3]=150):(_[Y]=0,_[Y+1]=0,_[Y+2]=0,_[Y+3]=0)}}_&&(Ye(0,E),Ye(b-1,E))}},bn=(c,f)=>{let b=q.width,v=q.height;if(ga(b,v),c<0||c>=b)return;let k=Math.floor(ft/2),I=Math.max(0,c-k),K=Math.min(b-1,c+k);for(let E=I;E<=K;E++){for(let $=0;$<v;$++){let ae=$*b+E,D=e.resizeIgnoreMask[ae];if(je==="toggle"?D=D?0:1:je==="ignore"?D=1:D=0,e.resizeIgnoreMask[ae]=D,_){let Y=ae*4;D?(_[Y]=255,_[Y+1]=0,_[Y+2]=0,_[Y+3]=150):(_[Y]=0,_[Y+1]=0,_[Y+2]=0,_[Y+3]=0)}}_&&(Ye(E,0),Ye(E,v-1))}},vn=()=>{zt()},Fa=c=>{if((c.buttons&4)===4||(c.buttons&2)===2||Xe)return;let{x:f,y:b}=mn(c.clientX,c.clientY),v=q.width,k=q.height;if(f<0||b<0||f>=v||b>=k)return;let I=Math.max(1,Math.floor($t/2));c.shiftKey?fn(b):c.altKey?bn(f):wn(f,b,I),hn=f,un=b,vn()};ue.addEventListener("mousedown",c=>{c.button===1||c.button===2||Xe||(Ft=!0,Fa(c))}),ue.addEventListener("touchstart",c=>{},{passive:!0}),ue.addEventListener("touchmove",c=>{},{passive:!0}),ue.addEventListener("touchend",c=>{},{passive:!0}),window.addEventListener("mousemove",c=>{Ft&&Fa(c)}),window.addEventListener("mouseup",()=>{Ft&&(Ft=!1,Z())}),Oa&&Oa.addEventListener("click",()=>{let c=q.width,f=q.height;e.resizeIgnoreMask&&e.resizeIgnoreMask.fill(0),lt(c,f,!0),ge(),Z()}),Ra&&Ra.addEventListener("click",()=>{if(!e.resizeIgnoreMask)return;for(let b=0;b<e.resizeIgnoreMask.length;b++)e.resizeIgnoreMask[b]=e.resizeIgnoreMask[b]?0:1;let c=q.width,f=q.height;lt(c,f,!0),ge(),Z()}),on.onclick=async()=>{let c=parseInt(Ae.value,10),f=parseInt(De.value,10),b=document.createElement("canvas"),v=b.getContext("2d");b.width=c,b.height=f,v.imageSmoothingEnabled=!1,A!==x&&(!A.img||!A.canvas)&&await A.load(),v.drawImage(A.img,0,0,c,f);let k=v.getImageData(0,0,c,f),I=k.data,K=e.customTransparencyThreshold||y.TRANSPARENCY_THRESHOLD,E=0,$=e.resizeIgnoreMask&&e.resizeIgnoreMask.length===c*f?e.resizeIgnoreMask:null,ae=async()=>{let L=c,H=f,oe=L*H,{work:J,eligible:fe}=et(oe);for(let X=0;X<H;X++){for(let Q=0;Q<L;Q++){let ee=X*L+Q,pe=ee*4,Oe=I[pe],Ie=I[pe+1],Be=I[pe+2],ke=I[pe+3],yt=!($&&$[ee])&&(e.paintTransparentPixels||ke>=K)&&(e.paintWhitePixels||!i.isWhitePixel(Oe,Ie,Be));fe[ee]=yt?1:0,J[ee*3]=Oe,J[ee*3+1]=Ie,J[ee*3+2]=Be,yt||(I[pe+3]=0)}X&15||await Promise.resolve()}let Pe=(X,Q,ee,pe,Oe,Ie)=>{if(X<0||X>=L||Q<0||Q>=H)return;let Be=Q*L+X;if(!fe[Be])return;let ke=Be*3;J[ke]=Math.min(255,Math.max(0,J[ke]+ee*Ie)),J[ke+1]=Math.min(255,Math.max(0,J[ke+1]+pe*Ie)),J[ke+2]=Math.min(255,Math.max(0,J[ke+2]+Oe*Ie))};for(let X=0;X<H;X++){for(let Q=0;Q<L;Q++){let ee=X*L+Q;if(!fe[ee])continue;let pe=ee*3,Oe=J[pe],Ie=J[pe+1],Be=J[pe+2],[ke,Ke,yt]=i.findClosestPaletteColor(Oe,Ie,Be,e.activeColorPalette),_t=ee*4;I[_t]=ke,I[_t+1]=Ke,I[_t+2]=yt,I[_t+3]=255,E++;let Wt=Oe-ke,Ht=Ie-Ke,Ut=Be-yt;Pe(Q+1,X,Wt,Ht,Ut,7/16),Pe(Q-1,X+1,Wt,Ht,Ut,3/16),Pe(Q,X+1,Wt,Ht,Ut,5/16),Pe(Q+1,X+1,Wt,Ht,Ut,1/16)}await Promise.resolve()}};if(e.ditheringEnabled)await ae();else for(let L=0;L<I.length;L+=4){let H=I[L],oe=I[L+1],J=I[L+2],fe=I[L+3],Pe=$&&$[L>>2],X=!e.paintTransparentPixels&&fe<K||Pe,Q=!e.paintWhitePixels&&i.isWhitePixel(H,oe,J);if(X||Q){I[L+3]=0;continue}E++;let[ee,pe,Oe]=i.findClosestPaletteColor(H,oe,J,e.activeColorPalette);I[L]=ee,I[L+1]=pe,I[L+2]=Oe,I[L+3]=255}v.putImageData(k,0,0);let D=new Uint8ClampedArray(k.data);e.imageData.pixels=D,e.imageData.width=c,e.imageData.height=f,e.imageData.totalPixels=E,e.totalPixels=E,e.paintedPixels=0,e.resizeSettings={baseWidth:R,baseHeight:F,width:c,height:f},Z();let Y=await createImageBitmap(b);await Te.setImage(Y),Te.enable(),we.classList.add("active"),we.setAttribute("aria-pressed","true"),Ee(),N("resizeSuccess","success",{width:c,height:f}),za()},sn.onclick=()=>{try{let c=q.width,f=q.height,b=document.createElement("canvas");b.width=c,b.height=f;let v=b.getContext("2d");v.imageSmoothingEnabled=!1,v.drawImage(q,0,0),v.drawImage(ue,0,0);let k=document.createElement("a");k.download="wplace-preview.png",k.href=b.toDataURL(),k.click()}catch(c){console.warn("Failed to download preview:",c)}},rn.onclick=za,u.style.display="block",w.style.display="block",Za(w),ge(),xt=()=>{try{We.replaceWith(We.cloneNode(!0))}catch{}try{gt&&gt.replaceWith(gt.cloneNode(!0))}catch{}try{ht&&ht.replaceWith(ht.cloneNode(!0))}catch{}},setTimeout(()=>{if(typeof Ge=="function"){let c=Ge();!isNaN(c)&&isFinite(c)&&(Fe(c),wt())}else wt()},0)}function za(){try{typeof xt=="function"&&xt()}catch{}u.style.display="none",w.style.display="none",ge=()=>{};try{typeof cancelAnimationFrame=="function"&&_panRaf&&cancelAnimationFrame(_panRaf)}catch{}try{_previewTimer&&(clearTimeout(_previewTimer),_previewTimer=null)}catch{}_maskImageData=null,_maskData=null,_dirty=null,_ditherWorkBuf=null,_ditherEligibleBuf=null,xt=null}z&&z.addEventListener("click",async()=>{let x=i.extractAvailableColors();if(x.length<10){N("noColorsFound","error"),i.showAlert(i.t("noColorsFound"),"error");return}e.colorsChecked||(e.availableColors=x,e.colorsChecked=!0,N("colorsFound","success",{count:x.length}),Ee(),T.disabled=!1,e.imageLoaded&&(C.disabled=!1));try{N("loadingImage","default");let A=await i.createImageUploader();if(!A){N("colorsFound","success",{count:e.availableColors.length});return}let R=new Zt(A);await R.load();let{width:F,height:re}=R.getDimensions(),U=R.getPixelData(),ce=0;for(let ne=0;ne<U.length;ne+=4){let ye=!e.paintTransparentPixels&&U[ne+3]<(e.customTransparencyThreshold||y.TRANSPARENCY_THRESHOLD),se=!e.paintWhitePixels&&i.isWhitePixel(U[ne],U[ne+1],U[ne+2]);!ye&&!se&&ce++}e.imageData={width:F,height:re,pixels:U,totalPixels:ce,processor:R},e.totalPixels=ce,e.paintedPixels=0,e.imageLoaded=!0,e.lastPosition={x:0,y:0},i.initializePaintedMap(F,re),e.resizeSettings=null,e.resizeIgnoreMask=null,e.originalImage={dataUrl:A,width:F,height:re},Z();let ve=await createImageBitmap(R.img);await Te.setImage(ve),Te.enable(),we.disabled=!1,we.classList.add("active"),we.setAttribute("aria-pressed","true"),e.colorsChecked&&(C.disabled=!1),O.disabled=!1,e.startPosition&&(P.disabled=!1),Ee(),dt(),N("imageLoaded","success",{count:ce})}catch{N("imageError","error")}}),C&&C.addEventListener("click",()=>{e.imageLoaded&&e.imageData.processor&&e.colorsChecked?ln(e.imageData.processor):e.colorsChecked||i.showAlert(i.t("uploadImageFirstColors"),"warning")}),T&&T.addEventListener("click",async()=>{if(e.selectingPosition)return;e.selectingPosition=!0,e.startPosition=null,e.region=null,P.disabled=!0,i.showAlert(i.t("selectPositionAlert"),"info"),N("waitingPosition","default");let x=async(R,F)=>{var re;if(typeof R=="string"&&R.includes("https://backend.wplace.live/s0/pixel/")&&((re=F==null?void 0:F.method)==null?void 0:re.toUpperCase())==="POST")try{let U=await A(R,F),ve=await U.clone().json();if((ve==null?void 0:ve.painted)===1){let ne=R.match(/\/pixel\/(\d+)\/(\d+)/);ne&&ne.length>=3&&(e.region={x:Number.parseInt(ne[1]),y:Number.parseInt(ne[2])});let ye=JSON.parse(F.body);ye!=null&&ye.coords&&Array.isArray(ye.coords)&&(e.startPosition={x:ye.coords[0],y:ye.coords[1]},e.lastPosition={x:0,y:0},await Te.setPosition(e.startPosition,e.region),e.imageLoaded&&(P.disabled=!1),window.fetch=A,e.selectingPosition=!1,N("positionSet","success"))}return U}catch{return A(R,F)}return A(R,F)},A=window.fetch;window.fetch=x,setTimeout(()=>{e.selectingPosition&&(window.fetch=A,e.selectingPosition=!1,N("positionTimeout","error"),i.showAlert(i.t("positionTimeout"),"error"))},12e4)});async function cn(){if(!e.imageLoaded||!e.startPosition||!e.region)return N("missingRequirements","error"),!1;if(await ba(),!Se)return!1;e.running=!0,e.stopFlag=!1,P.disabled=!0,B.disabled=!1,z.disabled=!0,T.disabled=!0,C.disabled=!0,O.disabled=!0,we.disabled=!0,N("startPaintingMsg","success");try{return await Qa(),!0}catch{return N("paintingError","error"),!1}finally{e.running=!1,B.disabled=!0,O.disabled=!1,e.stopFlag?P.disabled=!1:(P.disabled=!0,z.disabled=!1,T.disabled=!1,C.disabled=!1),we.disabled=!1}}P&&P.addEventListener("click",cn),B&&B.addEventListener("click",()=>{e.stopFlag=!0,e.running=!1,B.disabled=!0,N("paintingStopped","warning"),e.imageLoaded&&e.paintedPixels>0&&(i.saveProgress(),i.showAlert(i.t("autoSaved"),"success"))}),setTimeout(()=>{let x=i.loadProgress();if(x&&x.state.paintedPixels>0){let A=new Date(x.timestamp).toLocaleString(),R=Math.round(x.state.paintedPixels/x.state.totalPixels*100);i.showAlert(`${i.t("savedDataFound")}

Saved: ${A}
Progress: ${x.state.paintedPixels}/${x.state.totalPixels} pixels (${R}%)
${i.t("clickLoadToContinue")}`,"info")}},1e3),Me&&Le&&Me.addEventListener("input",x=>{let A=parseInt(x.target.value);e.cooldownChargeThreshold=A,Le.textContent=A,Z(),He.resetEdgeTracking()}),an(),He.syncFromState()}async function Qa(){let{width:t,height:a,pixels:n}=e.imageData,{x:o,y:r}=e.startPosition,{x:l,y:s}=e.region,d=e.customTransparencyThreshold||y.TRANSPARENCY_THRESHOLD,h=(C,T)=>{let P=(T*t+C)*4,B=n[P],O=n[P+1],V=n[P+2],j=n[P+3];return!(!e.paintTransparentPixels&&j<d||!e.paintWhitePixels&&i.isWhitePixel(B,O,V))},p=0,m=0,g=!1,S=0,w=Math.max(0,Math.min(e.paintedPixels||0,t*a));for(let C=0;C<a&&!g;C++)for(let T=0;T<t;T++)if(h(T,C)){if(S===w){p=C,m=T,g=!0;break}S++}g||(p=a,m=0);let u=null,z={transparent:0,white:0,alreadyPainted:0};try{e:for(let C=p;C<a;C++)for(let T=C===p?m:0;T<t;T++){if(e.stopFlag){u&&u.pixels.length>0&&(console.log(`\u{1F3AF} Sending final batch before stop with ${u.pixels.length} pixels`),await Ct(u.pixels,u.regionX,u.regionY)&&(u.pixels.forEach(()=>{e.paintedPixels++}),e.currentCharges-=u.pixels.length,Ee())),e.lastPosition={x:T,y:C},N("paintingPaused","warning",{x:T,y:C});break e}let P=(C*t+T)*4,B=n[P],O=n[P+1],V=n[P+2],j=n[P+3],le=e.customTransparencyThreshold||y.TRANSPARENCY_THRESHOLD;if(!e.paintTransparentPixels&&j<le||!e.paintWhitePixels&&i.isWhitePixel(B,O,V)){!e.paintTransparentPixels&&j<le?z.transparent++:z.white++;continue}let te;i.isWhitePixel(B,O,V)?te=[255,255,255]:te=i.findClosestPaletteColor(B,O,V,e.activeColorPalette);let ze=ya([B,O,V],e.availableColors),he=o+T,we=r+C,be=Math.floor(he/1e3),Ze=Math.floor(we/1e3),it=he%1e3,Ue=we%1e3;if(!u||u.regionX!==l+be||u.regionY!==s+Ze){if(u&&u.pixels.length>0)if(console.log(`\u{1F30D} Sending region-change batch with ${u.pixels.length} pixels (switching to region ${l+be},${s+Ze})`),await Ct(u.pixels,u.regionX,u.regionY)){if(u.pixels.forEach(Me=>{e.paintedPixels++,i.markPixelPainted(Me.x,Me.y,u.regionX,u.regionY)}),e.currentCharges-=u.pixels.length,N("paintingProgress","default",{painted:e.paintedPixels,total:e.totalPixels}),i.performSmartSave(),y.PAINTING_SPEED_ENABLED&&e.paintingSpeed>0&&u.pixels.length>0){let Me=Math.max(1,100/e.paintingSpeed),Le=Math.max(100,Me*u.pixels.length);await i.sleep(Le)}Ee()}else{console.error("\u274C Batch failed permanently after retries. Stopping painting."),e.stopFlag=!0;break e}u={regionX:l+be,regionY:s+Ze,pixels:[]}}try{let Ce=u?u.regionX:l+be,Me=u?u.regionY:s+Ze,Le=[l+be,s+Ze],rt=await Te.getTilePixelColor(Le[0],Le[1],it,Ue).catch(()=>null);if(rt&&Array.isArray(rt)){let[st,It,pt]=rt;if(ya([st,It,pt],e.availableColors)===ze){z.alreadyPainted++,console.log(`Skipped already painted pixel at (${it}, ${Ue})`);continue}}}catch{}u.pixels.push({x:it,y:Ue,color:ze,localX:T,localY:C});let ot=en();if(u.pixels.length>=ot){let Ce=e.batchMode==="random"?`random (${e.randomBatchMin}-${e.randomBatchMax})`:"normal";if(console.log(`\u{1F4E6} Sending batch with ${u.pixels.length} pixels (mode: ${Ce}, target: ${ot})`),await Ct(u.pixels,u.regionX,u.regionY)){if(u.pixels.forEach(Le=>{e.paintedPixels++,i.markPixelPainted(Le.x,Le.y,u.regionX,u.regionY)}),e.currentCharges-=u.pixels.length,Ee(),N("paintingProgress","default",{painted:e.paintedPixels,total:e.totalPixels}),i.performSmartSave(),y.PAINTING_SPEED_ENABLED&&e.paintingSpeed>0&&u.pixels.length>0){let Le=1e3/e.paintingSpeed,rt=Math.max(100,Le*u.pixels.length);await i.sleep(rt)}}else{console.error("\u274C Batch failed permanently after retries. Stopping painting."),e.stopFlag=!0;break e}u.pixels=[]}for(;e.currentCharges<e.cooldownChargeThreshold&&!e.stopFlag;){let{charges:Ce,cooldown:Me}=await Qt.getCharges();if(e.currentCharges=Math.floor(Ce),e.cooldown=Me,e.currentCharges>=e.cooldownChargeThreshold){He.maybeNotifyChargesReached(!0),Ee();break}saveBtn.disabled=!1,N("noChargesThreshold","warning",{time:i.formatTime(e.cooldown),threshold:e.cooldownChargeThreshold,current:e.currentCharges}),await Ee(),i.performSmartSave(),await i.sleep(e.cooldown)}if(e.stopFlag||(saveBtn.disabled=!0),e.stopFlag)break e}if(u&&u.pixels.length>0&&!e.stopFlag)if(console.log(`\u{1F3C1} Sending final batch with ${u.pixels.length} pixels`),await Ct(u.pixels,u.regionX,u.regionY)){if(u.pixels.forEach(T=>{e.paintedPixels++,i.markPixelPainted(T.x,T.y,u.regionX,u.regionY)}),e.currentCharges-=u.pixels.length,i.saveProgress(),y.PAINTING_SPEED_ENABLED&&e.paintingSpeed>0&&u.pixels.length>0){let T=1e3/e.paintingSpeed,P=Math.max(100,T*u.pixels.length);await i.sleep(P)}}else console.warn(`\u26A0\uFE0F Final batch failed with ${u.pixels.length} pixels after all retries.`)}finally{window._chargesInterval&&clearInterval(window._chargesInterval),window._chargesInterval=null}if(e.stopFlag)N("paintingStopped","warning"),i.saveProgress();else{N("paintingComplete","success",{count:e.paintedPixels}),e.lastPosition={x:0,y:0},i.saveProgress(),Te.clear();let C=document.getElementById("toggleOverlayBtn");C&&(C.classList.remove("active"),C.disabled=!0)}console.log("\u{1F4CA} Pixel Statistics:"),console.log(`   Painted: ${e.paintedPixels}`),console.log(`   Skipped - Transparent: ${z.transparent}`),console.log(`   Skipped - White (disabled): ${z.white}`),console.log(`   Skipped - Already painted: ${z.alreadyPainted}`),console.log(`   Total processed: ${e.paintedPixels+z.transparent+z.white+z.alreadyPainted}`),Ee()}function en(){let t;if(e.batchMode==="random"){let o=Math.max(1,e.randomBatchMin),r=Math.max(o,e.randomBatchMax);t=Math.floor(Math.random()*(r-o+1))+o,console.log(`\u{1F3B2} Random batch size generated: ${t} (range: ${o}-${r})`)}else t=e.paintingSpeed;let a=Math.floor(e.currentCharges);return Math.min(t,a)}async function Ct(t,a,n,o=fa){let r=0;for(;r<o&&!e.stopFlag;){r++,console.log(`\u{1F504} Attempting to send batch (attempt ${r}/${o}) for region ${a},${n} with ${t.length} pixels`);let l=await tn(t,a,n);if(l===!0)return console.log(`\u2705 Batch succeeded on attempt ${r}`),!0;if(l==="token_error"){console.log(`\u{1F511} Token error on attempt ${r}, regenerating...`),N("captchaSolving","warning");try{await ea(),r--;continue}catch(s){console.error(`\u274C Token regeneration failed on attempt ${r}:`,s),N("captchaFailed","error"),await i.sleep(5e3)}}else{console.warn(`\u26A0\uFE0F Batch failed on attempt ${r}, retrying...`);let s=Math.min(1e3*Math.pow(2,r-1),3e4),d=Math.random()*1e3;await i.sleep(s+d)}}return r>=o&&(console.error(`\u274C Batch failed after ${o} attempts (MAX_BATCH_RETRIES=${fa}). This will stop painting to prevent infinite loops.`),N("paintingError","error")),!1}async function tn(t,a,n){let o=Se;if(!o)try{console.log("\u{1F511} Generating Turnstile token for pixel batch..."),o=await ea(),Se=o}catch(s){return console.error("\u274C Failed to generate Turnstile token:",s),nt=new Promise(d=>{$e=d}),"token_error"}let r=new Array(t.length*2),l=new Array(t.length);for(let s=0;s<t.length;s++){let d=t[s];r[s*2]=d.x,r[s*2+1]=d.y,l[s]=d.color}try{let s={coords:r,colors:l,t:o},d=await fetch(`https://backend.wplace.live/s0/pixel/${a}/${n}`,{method:"POST",headers:{"Content-Type":"text/plain;charset=UTF-8"},credentials:"include",body:JSON.stringify(s)});if(d.status===403){let p=null;try{p=await d.json()}catch{}console.error("\u274C 403 Forbidden. Turnstile token might be invalid or expired.");try{console.log("\u{1F504} Regenerating Turnstile token after 403..."),o=await ea(),Se=o;let m={coords:r,colors:l,t:o},g=await fetch(`https://backend.wplace.live/s0/pixel/${a}/${n}`,{method:"POST",headers:{"Content-Type":"text/plain;charset=UTF-8"},credentials:"include",body:JSON.stringify(m)});if(g.status===403)return Se=null,nt=new Promise(w=>{$e=w}),"token_error";let S=await g.json();return(S==null?void 0:S.painted)===t.length}catch(m){return console.error("\u274C Token regeneration failed:",m),Se=null,nt=new Promise(g=>{$e=g}),"token_error"}}let h=await d.json();return(h==null?void 0:h.painted)===t.length}catch(s){return console.error("Batch paint request failed:",s),!1}}function Z(){var t,a;try{let n={paintingSpeed:e.paintingSpeed,paintingSpeedEnabled:(t=document.getElementById("enableSpeedToggle"))==null?void 0:t.checked,batchMode:e.batchMode,randomBatchMin:e.randomBatchMin,randomBatchMax:e.randomBatchMax,cooldownChargeThreshold:e.cooldownChargeThreshold,tokenSource:e.tokenSource,minimized:e.minimized,overlayOpacity:e.overlayOpacity,blueMarbleEnabled:(a=document.getElementById("enableBlueMarbleToggle"))==null?void 0:a.checked,ditheringEnabled:e.ditheringEnabled,colorMatchingAlgorithm:e.colorMatchingAlgorithm,enableChromaPenalty:e.enableChromaPenalty,chromaPenaltyWeight:e.chromaPenaltyWeight,customTransparencyThreshold:e.customTransparencyThreshold,customWhiteThreshold:e.customWhiteThreshold,paintWhitePixels:e.paintWhitePixels,paintTransparentPixels:e.paintTransparentPixels,resizeSettings:e.resizeSettings,originalImage:e.originalImage,resizeIgnoreMask:e.resizeIgnoreMask&&e.resizeSettings&&e.resizeSettings.width*e.resizeSettings.height===e.resizeIgnoreMask.length?{w:e.resizeSettings.width,h:e.resizeSettings.height,data:btoa(String.fromCharCode(...e.resizeIgnoreMask))}:null,notificationsEnabled:e.notificationsEnabled,notifyOnChargesReached:e.notifyOnChargesReached,notifyOnlyWhenUnfocused:e.notifyOnlyWhenUnfocused,notificationIntervalMinutes:e.notificationIntervalMinutes};y.PAINTING_SPEED_ENABLED=n.paintingSpeedEnabled,localStorage.setItem("wplace-bot-settings",JSON.stringify(n))}catch(n){console.warn("Could not save bot settings:",n)}}function an(){try{let t=localStorage.getItem("wplace-bot-settings");if(!t)return;let a=JSON.parse(t);if(e.paintingSpeed=a.paintingSpeed||y.PAINTING_SPEED.DEFAULT,e.batchMode=a.batchMode||y.BATCH_MODE,e.randomBatchMin=a.randomBatchMin||y.RANDOM_BATCH_RANGE.MIN,e.randomBatchMax=a.randomBatchMax||y.RANDOM_BATCH_RANGE.MAX,e.cooldownChargeThreshold=a.cooldownChargeThreshold||y.COOLDOWN_CHARGE_THRESHOLD,e.tokenSource=a.tokenSource||y.TOKEN_SOURCE,e.minimized=a.minimized??!1,y.PAINTING_SPEED_ENABLED=a.paintingSpeedEnabled??!1,y.AUTO_CAPTCHA_ENABLED=a.autoCaptchaEnabled??!1,e.overlayOpacity=a.overlayOpacity??y.OVERLAY.OPACITY_DEFAULT,e.blueMarbleEnabled=a.blueMarbleEnabled??y.OVERLAY.BLUE_MARBLE_DEFAULT,e.ditheringEnabled=a.ditheringEnabled??!1,e.colorMatchingAlgorithm=a.colorMatchingAlgorithm||"lab",e.enableChromaPenalty=a.enableChromaPenalty??!0,e.chromaPenaltyWeight=a.chromaPenaltyWeight??.15,e.customTransparencyThreshold=a.customTransparencyThreshold??y.TRANSPARENCY_THRESHOLD,e.customWhiteThreshold=a.customWhiteThreshold??y.WHITE_THRESHOLD,e.paintWhitePixels=a.paintWhitePixels??!0,e.paintTransparentPixels=a.paintTransparentPixels??!1,e.resizeSettings=a.resizeSettings??null,e.originalImage=a.originalImage??null,e.notificationsEnabled=a.notificationsEnabled??y.NOTIFICATIONS.ENABLED,e.notifyOnChargesReached=a.notifyOnChargesReached??y.NOTIFICATIONS.ON_CHARGES_REACHED,e.notifyOnlyWhenUnfocused=a.notifyOnlyWhenUnfocused??y.NOTIFICATIONS.ONLY_WHEN_UNFOCUSED,e.notificationIntervalMinutes=a.notificationIntervalMinutes??y.NOTIFICATIONS.REPEAT_MINUTES,a.resizeIgnoreMask&&a.resizeIgnoreMask.data&&e.resizeSettings&&a.resizeIgnoreMask.w===e.resizeSettings.width&&a.resizeIgnoreMask.h===e.resizeSettings.height)try{let he=atob(a.resizeIgnoreMask.data),we=new Uint8Array(he.length);for(let be=0;be<he.length;be++)we[be]=he.charCodeAt(be);e.resizeIgnoreMask=we}catch{e.resizeIgnoreMask=null}else e.resizeIgnoreMask=null;let n=document.getElementById("speedSlider");n&&(n.value=e.paintingSpeed);let o=document.getElementById("speedValue");o&&(o.textContent=`${e.paintingSpeed} (batch size)`);let r=document.getElementById("enableSpeedToggle");r&&(r.checked=y.PAINTING_SPEED_ENABLED);let l=document.getElementById("batchModeSelect");l&&(l.value=e.batchMode);let s=document.getElementById("normalBatchControls"),d=document.getElementById("randomBatchControls");s&&d&&(e.batchMode==="random"?(s.style.display="none",d.style.display="block"):(s.style.display="block",d.style.display="none"));let h=document.getElementById("randomBatchMin");h&&(h.value=e.randomBatchMin);let p=document.getElementById("randomBatchMax");p&&(p.value=e.randomBatchMax);let m=document.getElementById("cooldownSlider");m&&(m.value=e.cooldownChargeThreshold);let g=document.getElementById("cooldownValue");g&&(g.textContent=e.cooldownChargeThreshold);let S=document.getElementById("overlayOpacitySlider");S&&(S.value=e.overlayOpacity);let w=document.getElementById("overlayOpacityValue");w&&(w.textContent=`${Math.round(e.overlayOpacity*100)}%`);let u=document.getElementById("enableBlueMarbleToggle");u&&(u.checked=e.blueMarbleEnabled);let z=document.getElementById("tokenSourceSelect");z&&(z.value=e.tokenSource);let C=document.getElementById("colorAlgorithmSelect");C&&(C.value=e.colorMatchingAlgorithm);let T=document.getElementById("enableChromaPenaltyToggle");T&&(T.checked=e.enableChromaPenalty);let P=document.getElementById("chromaPenaltyWeightSlider");P&&(P.value=e.chromaPenaltyWeight);let B=document.getElementById("chromaWeightValue");B&&(B.textContent=e.chromaPenaltyWeight);let O=document.getElementById("transparencyThresholdInput");O&&(O.value=e.customTransparencyThreshold);let V=document.getElementById("whiteThresholdInput");V&&(V.value=e.customWhiteThreshold);let j=document.getElementById("notifEnabledToggle");j&&(j.checked=e.notificationsEnabled);let le=document.getElementById("notifOnChargesToggle");le&&(le.checked=e.notifyOnChargesReached);let te=document.getElementById("notifOnlyUnfocusedToggle");te&&(te.checked=e.notifyOnlyWhenUnfocused);let ze=document.getElementById("notifIntervalInput");ze&&(ze.value=e.notificationIntervalMinutes),He.resetEdgeTracking()}catch(t){console.warn("Could not load bot settings:",t)}}console.log("\u{1F680} WPlace Auto-Image with Turnstile Token Generator loaded"),console.log("\u{1F511} Turnstile token generator: ALWAYS ENABLED (Background mode)"),console.log("\u{1F3AF} Manual pixel captcha solving: Available as fallback/alternative"),console.log("\u{1F4F1} Turnstile widgets: DISABLED - pure background token generation only!");function Pt(){e.initialSetupComplete=!0;let t=document.querySelector("#loadBtn"),a=document.querySelector("#loadFromFileBtn"),n=document.querySelector("#uploadBtn");t&&(t.disabled=!1,t.title="",t.style.animation="pulse 0.6s ease-in-out",setTimeout(()=>{t&&(t.style.animation="")},600),console.log("\u2705 Load Progress button enabled after initial setup")),a&&(a.disabled=!1,a.title="",a.style.animation="pulse 0.6s ease-in-out",setTimeout(()=>{a&&(a.style.animation="")},600),console.log("\u2705 Load from File button enabled after initial setup")),n&&(n.disabled=!1,n.title="",n.style.animation="pulse 0.6s ease-in-out",setTimeout(()=>{n&&(n.style.animation="")},600),console.log("\u2705 Upload Image button enabled after initial setup")),i.showAlert(i.t("fileOperationsAvailable"),"success")}async function nn(){if(Jt()){console.log("\u2705 Valid token already available, skipping initialization"),N("tokenReady","success"),Pt();return}try{console.log("\u{1F527} Initializing Turnstile token generator..."),N("initializingToken","default"),console.log("Attempting to load Turnstile script..."),await i.loadTurnstile(),console.log("Turnstile script loaded. Attempting to generate token...");let t=await va();t?(kt(t),console.log("\u2705 Startup token generated successfully"),N("tokenReady","success"),i.showAlert(i.t("tokenGeneratorReady"),"success"),Pt()):(console.warn("\u26A0\uFE0F Startup token generation failed (no token received), will retry when needed"),N("tokenRetryLater","warning"),Pt())}catch(t){console.error("\u274C Critical error during Turnstile initialization:",t),N("tokenRetryLater","warning"),Pt()}}ma(),qt(),ta().then(()=>{setTimeout(nn,1e3),setTimeout(()=>{let a=document.getElementById("chromaPenaltyWeightSlider"),n=document.getElementById("chromaWeightValue"),o=document.getElementById("resetAdvancedColorBtn"),r=document.getElementById("colorAlgorithmSelect"),l=document.getElementById("enableChromaPenaltyToggle"),s=document.getElementById("transparencyThresholdInput"),d=document.getElementById("whiteThresholdInput"),h=document.getElementById("enableDitheringToggle");r&&r.addEventListener("change",p=>{e.colorMatchingAlgorithm=p.target.value,Z(),ge()}),l&&l.addEventListener("change",p=>{e.enableChromaPenalty=p.target.checked,Z(),ge()}),a&&n&&a.addEventListener("input",p=>{e.chromaPenaltyWeight=parseFloat(p.target.value)||.15,n.textContent=e.chromaPenaltyWeight.toFixed(2),Z(),ge()}),s&&s.addEventListener("change",p=>{let m=parseInt(p.target.value,10);!isNaN(m)&&m>=0&&m<=255&&(e.customTransparencyThreshold=m,y.TRANSPARENCY_THRESHOLD=m,Z(),ge())}),d&&d.addEventListener("change",p=>{let m=parseInt(p.target.value,10);!isNaN(m)&&m>=200&&m<=255&&(e.customWhiteThreshold=m,y.WHITE_THRESHOLD=m,Z(),ge())}),h&&h.addEventListener("change",p=>{e.ditheringEnabled=p.target.checked,Z(),ge()}),o&&o.addEventListener("click",()=>{e.colorMatchingAlgorithm="lab",e.enableChromaPenalty=!0,e.chromaPenaltyWeight=.15,e.customTransparencyThreshold=y.TRANSPARENCY_THRESHOLD=100,e.customWhiteThreshold=y.WHITE_THRESHOLD=250,Z();let p=document.getElementById("colorAlgorithmSelect");p&&(p.value="lab");let m=document.getElementById("enableChromaPenaltyToggle");m&&(m.checked=!0),a&&(a.value=.15),n&&(n.textContent="0.15"),s&&(s.value=100),d&&(d.value=250),ge(),i.showAlert(i.t("advancedColorSettingsReset"),"success")})},500),window.addEventListener("beforeunload",()=>{i.cleanupTurnstile()})})})();})();
