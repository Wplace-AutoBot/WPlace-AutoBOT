var WPlaceAutoBot=(()=>{var Ka=`/* WPlace Auto-Image Bot - Unified CSS Styles (decoupled from JS)
...
:root {
    ...
    --wplace-shadow:
        0 8px 32px rgb(0 0 0 / 60%), 0 0 0 1px rgb(255 255 255 / 10%);
    ...
    /* Shadow variants */
    --wplace-shadow-drag:
        0 12px 40px rgb(0 0 0 / 80%), 0 0 0 2px rgb(255 255 255 / 20%);
    --wplace-shadow-notification: 0 4px 12px rgb(0 0 0 / 30%);
    --wplace-shadow-slider-thumb:
        0 3px 6px rgb(0 0 0 / 30%), 0 0 0 2px var(--wplace-icon-primary);
    --wplace-shadow-slider-hover:
        0 4px 8px rgb(0 0 0 / 40%), 0 0 0 3px var(--wplace-icon-primary);
...
.wplace-settings-container-themed.glow-effect {
    box-shadow:
        var(--theme-box-shadow, 0 20px 40px rgba(0, 0, 0, 0.3)),
...
`,Yt={"classic-light":`/* WPlace Auto-Image Bot - Classic Light Theme */
...
.wplace-theme-classic-light {
    ...
    /* Shadow variants */
    --wplace-shadow-drag:
        0 12px 40px rgb(0 0 0 / 20%), 0 0 0 2px rgb(111 66 193 / 30%);
    --wplace-shadow-notification: 0 4px 12px rgb(0 0 0 / 15%);
    --wplace-shadow-slider-thumb:
        0 3px 6px rgb(0 0 0 / 20%), 0 0 0 2px var(--wplace-icon-primary);
    --wplace-shadow-slider-hover:
        0 4px 8px rgb(0 0 0 / 25%), 0 0 0 3px var(--wplace-icon-primary);
...
.wplace-theme-classic-light #wplace-image-bot-container {
    ...
    box-shadow:
        ...
        0 0 0 1px rgb(0 0 0 / 8%) !important;
...
.wplace-theme-classic .wplace-btn[aria-pressed='true'] {
    ...
    box-shadow:
        0 0 8px rgb(0 0 0 / 25%) inset,
        0 0 6px rgb(0 0 0 / 20%) !important;
}
...
.wplace-theme-neon {
    ...
    --wplace-shadow:
        0 0 20px rgb(0 255 65 / 30%), inset 0 0 20px rgb(0 255 65 / 10%);
    ...
    --wplace-shadow-drag:
        0 12px 40px rgb(0 255 65 / 60%), 0 0 0 2px rgb(0 255 65 / 80%),
        0 0 20px rgb(0 255 65 / 30%);
    --wplace-shadow-notification:
        0 4px 12px rgb(0 255 65 / 40%), 0 0 15px rgb(0 255 65 / 20%);
    --wplace-shadow-slider-thumb:
        0 3px 6px rgb(0 255 65 / 50%), 0 0 0 2px var(--wplace-icon-primary),
        0 0 10px rgb(0 255 65 / 30%);
    --wplace-shadow-slider-hover:
        0 4px 8px rgb(0 255 65 / 60%), 0 0 0 3px var(--wplace-icon-primary),
        0 0 15px rgb(0 255 65 / 40%);
...
.wplace-theme-neon #wplace-image-bot-container {
    ...
    box-shadow:
        ...
        inset 0 0 20px rgb(0 255 65 / 10%) !important;
    font-family: var(--wplace-font) !important;
}
...
.wplace-theme-neon .wplace-btn:hover:not(:disabled) {
    box-shadow:
        ...
        inset 0 0 15px rgb(0 255 65 / 10%) !important;
    animation:
        pixel-blink 0.5s infinite,
...
.wplace-theme-neon #wplace-settings-container {
    ...
    box-shadow:
        ...
        inset 0 0 30px rgb(0 255 65 / 10%) !important;
    font-family: var(--wplace-font) !important;
}
...
.wplace-theme-neon .wplace-input-btn-compact {
    ...
    box-shadow:
        0 0 20px var(--wplace-text),
        inset 0 0 10px rgb(0 255 65 / 10%) !important;
...
.wplace-theme-neon .wplace-alert-success {
    ...
    text-shadow: 0 0 8px var(--wplace-success) !important;
    box-shadow:
        0 0 20px var(--wplace-success),
        inset 0 0 10px rgb(57 255 20 / 10%) !important;
}
...
.wplace-theme-neon .wplace-alert-warning {
    ...
    text-shadow: 0 0 8px var(--wplace-warning) !important;
    box-shadow:
        0 0 20px var(--wplace-warning),
        inset 0 0 10px rgb(255 255 0 / 10%) !important;
}
...
.wplace-theme-neon .wplace-alert-error {
    ...
    text-shadow: 0 0 8px var(--wplace-error) !important;
    box-shadow:
        0 0 20px var(--wplace-error),
        inset 0 0 10px rgb(255 7 58 / 10%) !important;
}
...
.wplace-theme-neon .wplace-cooldown-input:focus {
    ...
    box-shadow:
        0 0 20px var(--wplace-text),
        inset 0 0 10px rgb(0 255 65 / 20%) !important;
...
.wplace-theme-neon .wplace-input-btn-small:hover {
    box-shadow:
        0 0 20px var(--wplace-text),
        inset 0 0 15px rgb(0 255 65 / 20%) !important;
    animation:
        pixel-blink 0.5s infinite,
        neon-glow 1s ease-in-out infinite alternate !important;
}
...
RGB\uFF1A{rgb}`,expandMode:"\u5C55\u958B\u6A21\u5F0F",minimize:"\u6700\u5C0F\u5316",restore:"\u6062\u5FA9",hideStats:"\u96B1\u85CF\u7D71\u8A08",paintOptions:"\u7E6A\u5716\u9078\u9805",paintWhitePixels:"\u7E6A\u88FD\u767D\u8272\u50CF\u7D20",paintTransparentPixels:"\u7E6A\u88FD\u900F\u660E\u50CF\u7D20"}};(async()=>{let f={COOLDOWN_DEFAULT:31e3,TRANSPARENCY_THRESHOLD:100,WHITE_THRESHOLD:250,LOG_INTERVAL:10,PAINTING_SPEED:{MIN:1,MAX:1e3,DEFAULT:5},BATCH_MODE:"normal",RANDOM_BATCH_RANGE:{MIN:3,MAX:20},PAINTING_SPEED_ENABLED:!1,AUTO_CAPTCHA_ENABLED:!0,TOKEN_SOURCE:"generator",COOLDOWN_CHARGE_THRESHOLD:1,NOTIFICATIONS:{ENABLED:!1,ON_CHARGES_REACHED:!0,ONLY_WHEN_UNFOCUSED:!0,REPEAT_MINUTES:5},OVERLAY:{OPACITY_DEFAULT:.2,BLUE_MARBLE_DEFAULT:!1,ditheringEnabled:!1},COLOR_MAP:{0:{id:1,name:"Black",rgb:{r:0,g:0,b:0}},1:{id:2,name:"Dark Gray",rgb:{r:60,g:60,b:60}},2:{id:3,name:"Gray",rgb:{r:120,g:120,b:120}},3:{id:4,name:"Light Gray",rgb:{r:210,g:210,b:210}},4:{id:5,name:"White",rgb:{r:255,g:255,b:255}},5:{id:6,name:"Deep Red",rgb:{r:96,g:0,b:24}},6:{id:7,name:"Red",rgb:{r:237,g:28,b:36}},7:{id:8,name:"Orange",rgb:{r:255,g:127,b:39}},8:{id:9,name:"Gold",rgb:{r:246,g:170,b:9}},9:{id:10,name:"Yellow",rgb:{r:249,g:221,b:59}},10:{id:11,name:"Light Yellow",rgb:{r:255,g:250,b:188}},11:{id:12,name:"Dark Green",rgb:{r:14,g:185,b:104}},12:{id:13,name:"Green",rgb:{r:19,g:230,b:123}},13:{id:14,name:"Light Green",rgb:{r:135,g:255,b:94}},14:{id:15,name:"Dark Teal",rgb:{r:12,g:129,b:110}},15:{id:16,name:"Teal",rgb:{r:16,g:174,b:166}},16:{id:17,name:"Light Teal",rgb:{r:19,g:225,b:190}},17:{id:20,name:"Cyan",rgb:{r:96,g:247,b:242}},18:{id:44,name:"Light Cyan",rgb:{r:187,g:250,b:242}},19:{id:18,name:"Dark Blue",rgb:{r:40,g:80,b:158}},20:{id:19,name:"Blue",rgb:{r:64,g:147,b:228}},21:{id:21,name:"Indigo",rgb:{r:107,g:80,b:246}},22:{id:22,name:"Light Indigo",rgb:{r:153,g:177,b:251}},23:{id:23,name:"Dark Purple",rgb:{r:120,g:12,b:153}},24:{id:24,name:"Purple",rgb:{r:170,g:56,b:185}},25:{id:25,name:"Light Purple",rgb:{r:224,g:159,b:249}},26:{id:26,name:"Dark Pink",rgb:{r:203,g:0,b:122}},27:{id:27,name:"Pink",rgb:{r:236,g:31,b:128}},28:{id:28,name:"Light Pink",rgb:{r:243,g:141,b:169}},29:{id:29,name:"Dark Brown",rgb:{r:104,g:70,b:52}},30:{id:30,name:"Brown",rgb:{r:149,g:104,b:42}},31:{id:31,name:"Beige",rgb:{r:248,g:178,b:119}},32:{id:52,name:"Light Beige",rgb:{r:255,g:197,b:165}},33:{id:32,name:"Medium Gray",rgb:{r:170,g:170,b:170}},34:{id:33,name:"Dark Red",rgb:{r:165,g:14,b:30}},35:{id:34,name:"Light Red",rgb:{r:250,g:128,b:114}},36:{id:35,name:"Dark Orange",rgb:{r:228,g:92,b:26}},37:{id:37,name:"Dark Goldenrod",rgb:{r:156,g:132,b:49}},38:{id:38,name:"Goldenrod",rgb:{r:197,g:173,b:49}},39:{id:39,name:"Light Goldenrod",rgb:{r:232,g:212,b:95}},40:{id:40,name:"Dark Olive",rgb:{r:74,g:107,b:58}},41:{id:41,name:"Olive",rgb:{r:90,g:148,b:74}},42:{id:42,name:"Light Olive",rgb:{r:132,g:197,b:115}},43:{id:43,name:"Dark Cyan",rgb:{r:15,g:121,b:159}},44:{id:45,name:"Light Blue",rgb:{r:125,g:199,b:255}},45:{id:46,name:"Dark Indigo",rgb:{r:77,g:49,b:184}},46:{id:47,name:"Dark Slate Blue",rgb:{r:74,g:66,b:132}},47:{id:48,name:"Slate Blue",rgb:{r:122,g:113,b:196}},48:{id:49,name:"Light Slate Blue",rgb:{r:181,g:174,b:241}},49:{id:53,name:"Dark Peach",rgb:{r:155,g:82,b:73}},50:{id:54,name:"Peach",rgb:{r:209,g:128,b:120}},51:{id:55,name:"Light Peach",rgb:{r:250,g:182,b:164}},52:{id:50,name:"Light Brown",rgb:{r:219,g:164,b:99}},53:{id:56,name:"Dark Tan",rgb:{r:123,g:99,b:82}},54:{id:57,name:"Tan",rgb:{r:156,g:132,b:107}},55:{id:36,name:"Light Tan",rgb:{r:214,g:181,b:148}},56:{id:51,name:"Dark Beige",rgb:{r:209,g:128,b:81}},57:{id:61,name:"Dark Stone",rgb:{r:109,g:100,b:63}},58:{id:62,name:"Stone",rgb:{r:148,g:140,b:107}},59:{id:63,name:"Light Stone",rgb:{r:205,g:197,b:158}},60:{id:58,name:"Dark Slate",rgb:{r:51,g:57,b:65}},61:{id:59,name:"Slate",rgb:{r:109,g:117,b:141}},62:{id:60,name:"Light Slate",rgb:{r:179,g:185,b:209}},63:{id:0,name:"Transparent",rgb:null}},THEMES:{"Classic Autobot":{primary:"#000000",secondary:"#111111",accent:"#222222",text:"#ffffff",highlight:"#775ce3",success:"#00ff00",error:"#ff0000",warning:"#ffaa00",fontFamily:"'Segoe UI', Roboto, sans-serif",borderRadius:"12px",borderStyle:"solid",borderWidth:"1px",boxShadow:"0 8px 32px rgba(0,0,0,0.6), 0 0 0 1px rgba(255,255,255,0.1)",backdropFilter:"blur(10px)",animations:{glow:!1,scanline:!1,"pixel-blink":!1}},"Classic Light":{primary:"#ffffff",secondary:"#f8f9fa",accent:"#e9ecef",text:"#212529",highlight:"#6f42c1",success:"#28a745",error:"#dc3545",warning:"#ffc107",fontFamily:"'Segoe UI', Roboto, sans-serif",borderRadius:"12px",borderStyle:"solid",borderWidth:"1px",boxShadow:"0 8px 32px rgba(0,0,0,0.15), 0 0 0 1px rgba(0,0,0,0.08)",backdropFilter:"blur(10px)",animations:{glow:!1,scanline:!1,"pixel-blink":!1}},"Neon Retro":{primary:"#1a1a2e",secondary:"#16213e",accent:"#0f3460",text:"#00ff41",highlight:"#ff6b35",success:"#39ff14",error:"#ff073a",warning:"#ffff00",neon:"#00ffff",purple:"#bf00ff",pink:"#ff1493",fontFamily:"'Press Start 2P', monospace",borderRadius:"0",borderStyle:"solid",borderWidth:"3px",boxShadow:"0 0 20px rgba(0, 255, 65, 0.3), inset 0 0 20px rgba(0, 255, 65, 0.1)",backdropFilter:"none",animations:{glow:!0,scanline:!0,"pixel-blink":!0}}},currentTheme:"Classic Autobot",PAINT_UNAVAILABLE:!0,COORDINATE_MODE:"rows",COORDINATE_DIRECTION:"bottom-left",COORDINATE_SNAKE:!0,COORDINATE_BLOCK_WIDTH:6,COORDINATE_BLOCK_HEIGHT:2},ya=()=>f.THEMES[f.currentTheme],On=()=>Object.keys(Yt),Ja=()=>f.currentTheme,Za=t=>{f.THEMES[t]&&(f.currentTheme=t,Qa(),Vt(),aa())};function Vt(){let t=ya();document.documentElement.classList.remove("wplace-theme-classic","wplace-theme-classic-light","wplace-theme-neon");let n={"Classic Autobot":"wplace-theme-classic","Classic Light":"wplace-theme-classic-light","Neon Retro":"wplace-theme-neon"}[f.currentTheme]||"wplace-theme-classic";document.documentElement.classList.add(n);let i=document.getElementById("wplace-theme-css");i&&i.remove();let r=Ja(),c={"Classic Autobot":"classic","Classic Light":"classic-light","Neon Retro":"neon"}[r]||"classic";if(Yt[c]){let d=document.createElement("style");d.id="wplace-theme-css",d.textContent=Yt[c],document.head.appendChild(d)}let p=document.documentElement,h=(d,l)=>{try{p.style.setProperty(d,l)}catch{}};h("--wplace-primary",t.primary),h("--wplace-secondary",t.secondary),h("--wplace-accent",t.accent),h("--wplace-text",t.text),h("--wplace-highlight",t.highlight),h("--wplace-success",t.success),h("--wplace-error",t.error),h("--wplace-warning",t.warning),h("--wplace-font",t.fontFamily||"'Segoe UI', Roboto, sans-serif"),h("--wplace-radius",""+(t.borderRadius||"12px")),h("--wplace-border-style",""+(t.borderStyle||"solid")),h("--wplace-border-width",""+(t.borderWidth||"1px")),h("--wplace-backdrop",""+(t.backdropFilter||"blur(10px)")),h("--wplace-border-color","rgba(255,255,255,0.1)")}let Qa=()=>{try{localStorage.setItem("wplace-theme",f.currentTheme)}catch(t){console.warn("Could not save theme preference:",t)}},ka=()=>{try{let t=localStorage.getItem("wplace-theme");t&&f.THEMES[t]&&(f.currentTheme=t)}catch(t){console.warn("Could not load theme preference:",t)}},Xt=new Map,Fe={},jt=["en","ru","pt","vi","fr","id","tr","zh-CN","zh-TW","ja","ko","uk"],Kt=async(t,a=0)=>{if(Fe[t])return Fe[t];if(xa[t]){let n=xa[t];if(typeof n=="object"&&n!==null&&Object.keys(n).length>0)return Fe[t]=n,console.log(`\u{1F4DA} Loaded ${t} translations successfully from embedded assets (${Object.keys(n).length} keys)`),n;console.warn(`\u274C Invalid translation format for ${t}`)}else console.warn(`\u274C Language ${t} not found in embedded assets`);return null},en=async()=>{let t=localStorage.getItem("wplace_language"),a=navigator.language,n=a.split("-")[0],i="en";try{t&&jt.includes(t)?(i=t,console.log(`\u{1F504} Using saved language preference: ${i}`)):jt.includes(a)?(i=a,localStorage.setItem("wplace_language",a),console.log(`\u{1F504} Using browser locale: ${i}`)):jt.includes(n)?(i=n,localStorage.setItem("wplace_language",n),console.log(`\u{1F504} Using browser language: ${i}`)):console.log("\u{1F504} No matching language found, using English fallback"),e.language=i,i!=="en"&&!Fe[i]&&(await Kt(i)||(console.warn(`\u26A0\uFE0F Failed to load ${i} translations, falling back to English`),e.language="en",localStorage.setItem("wplace_language","en")))}catch(r){console.error("\u274C Error in loadLanguagePreference:",r),e.language="en"}},Sa=t=>{try{let a=document.createElement("div");a.className="wplace-warning-banner",a.textContent=t,document.body.appendChild(a),setTimeout(()=>{a.parentNode&&a.remove()},8e3)}catch(a){console.warn("Failed to show translation warning UI:",a)}},tn=async()=>{try{console.log("\u{1F310} Initializing translation system..."),Fe.en||await Kt("en")||(console.warn("\u26A0\uFE0F Failed to load English translations from CDN, using fallback"),Sa("\u26A0\uFE0F Translation loading failed, using basic fallbacks")),await en(),console.log(`\u2705 Translation system initialized. Active language: ${e.language}`)}catch(t){console.error("\u274C Translation initialization failed:",t),e.language||(e.language="en"),console.warn("\u26A0\uFE0F Using fallback translations due to initialization failure"),Sa("\u26A0\uFE0F Translation system error, using basic English")}},Jt={en:{title:"WPlace Auto-Image",toggleOverlay:"Toggle Overlay",scanColors:"Scan Colors",uploadImage:"Upload Image",resizeImage:"Resize Image",selectPosition:"Select Position",startPainting:"Start Painting",stopPainting:"Stop Painting",progress:"Progress",pixels:"Pixels",charges:"Charges",batchSize:"Batch Size",initMessage:"Click 'Upload Image' to begin"}},Rn=(t,a={})=>{var i,r,s;let n=(i=Fe[e.language])==null?void 0:i[t];return!n&&e.language!=="en"&&(n=(r=Fe.en)==null?void 0:r[t]),n||(n=(s=Jt.en)==null?void 0:s[t]),n?Object.entries(a).reduce((c,[p,h])=>c.replace(new RegExp(`\\{${p}\\}`,"g"),h),n):(console.warn(`\u26A0\uFE0F Missing translation for key: ${t}`),t)},e={running:!1,imageLoaded:!1,processing:!1,totalPixels:0,paintedPixels:0,availableColors:[],activeColorPalette:[],paintWhitePixels:!0,fullChargeData:null,fullChargeInterval:null,paintTransparentPixels:!1,displayCharges:0,preciseCurrentCharges:0,maxCharges:1,cooldown:f.COOLDOWN_DEFAULT,imageData:null,stopFlag:!1,colorsChecked:!1,startPosition:null,selectingPosition:!1,region:null,minimized:!1,lastPosition:{x:0,y:0},estimatedTime:0,language:"en",paintingSpeed:f.PAINTING_SPEED.DEFAULT,batchMode:f.BATCH_MODE,randomBatchMin:f.RANDOM_BATCH_RANGE.MIN,randomBatchMax:f.RANDOM_BATCH_RANGE.MAX,cooldownChargeThreshold:f.COOLDOWN_CHARGE_THRESHOLD,chargesThresholdInterval:null,tokenSource:f.TOKEN_SOURCE,initialSetupComplete:!1,overlayOpacity:f.OVERLAY.OPACITY_DEFAULT,blueMarbleEnabled:f.OVERLAY.BLUE_MARBLE_DEFAULT,ditheringEnabled:!0,colorMatchingAlgorithm:"lab",enableChromaPenalty:!0,chromaPenaltyWeight:.15,customTransparencyThreshold:f.TRANSPARENCY_THRESHOLD,customWhiteThreshold:f.WHITE_THRESHOLD,resizeSettings:null,originalImage:null,resizeIgnoreMask:null,paintUnavailablePixels:f.PAINT_UNAVAILABLE,coordinateMode:f.COORDINATE_MODE,coordinateDirection:f.COORDINATE_DIRECTION,coordinateSnake:f.COORDINATE_SNAKE,blockWidth:f.COORDINATE_BLOCK_WIDTH,blockHeight:f.COORDINATE_BLOCK_HEIGHT,notificationsEnabled:f.NOTIFICATIONS.ENABLED,notifyOnChargesReached:f.NOTIFICATIONS.ON_CHARGES_REACHED,notifyOnlyWhenUnfocused:f.NOTIFICATIONS.ONLY_WHEN_UNFOCUSED,notificationIntervalMinutes:f.NOTIFICATIONS.REPEAT_MINUTES,_lastChargesNotifyAt:0,_lastChargesBelow:!0,_lastSavePixelCount:0,_lastSaveTime:0,_saveInProgress:!1,paintedMap:null},fe=()=>{},Tt=null;class an{constructor(){this.isEnabled=!1,this.startCoords=null,this.imageBitmap=null,this.chunkedTiles=new Map,this.originalTiles=new Map,this.originalTilesData=new Map,this.tileSize=1e3,this.processPromise=null,this.lastProcessedHash=null,this.workerPool=null}toggle(){return this.isEnabled=!this.isEnabled,console.log(`Overlay ${this.isEnabled?"enabled":"disabled"}.`),this.isEnabled}enable(){this.isEnabled=!0}disable(){this.isEnabled=!1}clear(){this.disable(),this.imageBitmap=null,this.chunkedTiles.clear(),this.originalTiles.clear(),this.originalTilesData.clear(),this.lastProcessedHash=null,this.processPromise&&(this.processPromise=null)}async setImage(a){this.imageBitmap=a,this.lastProcessedHash=null,this.imageBitmap&&this.startCoords&&await this.processImageIntoChunks()}async setPosition(a,n){if(!a||!n){this.startCoords=null,this.chunkedTiles.clear(),this.lastProcessedHash=null;return}this.startCoords={region:n,pixel:a},this.lastProcessedHash=null,this.imageBitmap&&await this.processImageIntoChunks()}_generateProcessHash(){if(!this.imageBitmap||!this.startCoords)return null;let{width:a,height:n}=this.imageBitmap,{x:i,y:r}=this.startCoords.pixel,{x:s,y:c}=this.startCoords.region;return`${a}x${n}_${i},${r}_${s},${c}_${e.blueMarbleEnabled}_${e.overlayOpacity}`}async processImageIntoChunks(){if(!this.imageBitmap||!this.startCoords)return;if(this.processPromise)return this.processPromise;let a=this._generateProcessHash();if(this.lastProcessedHash===a&&this.chunkedTiles.size>0){console.log(`\u{1F4E6} Using cached overlay chunks (${this.chunkedTiles.size} tiles)`);return}this.processPromise=this._doProcessImageIntoChunks();try{await this.processPromise,this.lastProcessedHash=a}finally{this.processPromise=null}}async _doProcessImageIntoChunks(){let a=performance.now();this.chunkedTiles.clear();let{width:n,height:i}=this.imageBitmap,{x:r,y:s}=this.startCoords.pixel,{x:c,y:p}=this.startCoords.region,{startTileX:h,startTileY:d,endTileX:l,endTileY:w}=o.calculateTileRange(c,p,r,s,n,i,this.tileSize),g=(l-h+1)*(w-d+1);console.log(`\u{1F504} Processing ${g} overlay tiles...`);let S=4,u=[];for(let x=d;x<=w;x++)for(let T=h;T<=l;T++)u.push({tx:T,ty:x});for(let x=0;x<u.length;x+=S){let T=u.slice(x,x+S);await Promise.all(T.map(async({tx:P,ty:M})=>{let R=`${P},${M}`,W=await this._processTile(P,M,n,i,r,s,c,p);W&&this.chunkedTiles.set(R,W)})),x+S<u.length&&await new Promise(P=>setTimeout(P,0))}let v=performance.now()-a;console.log(`\u2705 Overlay processed ${this.chunkedTiles.size} tiles in ${Math.round(v)}ms`)}async _processTile(a,n,i,r,s,c,p,h){let d=`${a},${n}`,l=(a-p)*this.tileSize-s,w=(n-h)*this.tileSize-c,g=Math.max(0,l),S=Math.max(0,w),u=Math.min(i-g,this.tileSize-(g-l)),v=Math.min(r-S,this.tileSize-(S-w));if(u<=0||v<=0)return null;let x=Math.max(0,-l),T=Math.max(0,-w),P=new OffscreenCanvas(this.tileSize,this.tileSize),M=P.getContext("2d");if(M.imageSmoothingEnabled=!1,M.drawImage(this.imageBitmap,g,S,u,v,x,T,u,v),e.blueMarbleEnabled){let R=M.getImageData(x,T,u,v),W=R.data;for(let Z=0;Z<W.length;Z+=4){let ve=Z/4,Ie=Math.floor(ve/u);(ve%u+Ie)%2===0&&W[Z+3]>0&&(W[Z+3]=0)}M.putImageData(R,x,T)}return await P.transferToImageBitmap()}async processAndRespondToTileRequest(a){let{endpoint:n,blobID:i,blobData:r}=a,s=r;if(this.isEnabled&&this.chunkedTiles.size>0){let c=n.match(/(\d+)\/(\d+)\.png/);if(c){let p=parseInt(c[1],10),h=parseInt(c[2],10),d=`${p},${h}`,l=this.chunkedTiles.get(d);try{let w=await createImageBitmap(r);this.originalTiles.set(d,w);try{let g,S;typeof OffscreenCanvas<"u"?(g=new OffscreenCanvas(w.width,w.height),S=g.getContext("2d")):(g=document.createElement("canvas"),g.width=w.width,g.height=w.height,S=g.getContext("2d")),S.imageSmoothingEnabled=!1,S.drawImage(w,0,0);let u=S.getImageData(0,0,w.width,w.height);this.originalTilesData.set(d,{w:w.width,h:w.height,data:new Uint8ClampedArray(u.data)})}catch(g){console.warn("OverlayManager: could not cache ImageData for",d,g)}}catch(w){console.warn("OverlayManager: could not create original bitmap for",d,w)}if(l)try{s=await this._compositeTileOptimized(r,l)}catch(w){console.error("Error compositing overlay:",w),s=r}}}window.postMessage({source:"auto-image-overlay",blobID:i,blobData:s},"*")}async getTilePixelColor(a,n,i,r){let s=`${a},${n}`,c=e.customTransparencyThreshold||f.TRANSPARENCY_THRESHOLD,p=this.originalTilesData.get(s);if(p&&p.data&&p.w>0&&p.h>0){let d=Math.max(0,Math.min(p.w-1,i)),l=Math.max(0,Math.min(p.h-1,r)),w=(l*p.w+d)*4,g=p.data,S=g[w+3];return!e.paintTransparentPixels&&S<c?(window._overlayDebug&&console.debug("OverlayManager: pixel transparent (cached), skipping",s,d,l,S),null):[g[w],g[w+1],g[w+2],S]}let h=3;for(let d=1;d<=h;d++){let l=this.originalTiles.get(s);if(!l){d===h?console.warn("OverlayManager: no bitmap for",s,"after",h,"attempts"):await o.sleep(50*d);continue}try{let w,g;typeof OffscreenCanvas<"u"?(w=new OffscreenCanvas(l.width,l.height),g=w.getContext("2d")):(w=document.createElement("canvas"),w.width=l.width,w.height=l.height,g=w.getContext("2d")),g.imageSmoothingEnabled=!1,g.drawImage(l,0,0);let S=Math.max(0,Math.min(l.width-1,i)),u=Math.max(0,Math.min(l.height-1,r)),v=g.getImageData(S,u,1,1).data,x=v[3];return!e.paintTransparentPixels&&x<c?(window._overlayDebug&&console.debug("OverlayManager: pixel transparent (fallback)",s,S,u,x),null):[v[0],v[1],v[2],x]}catch(w){console.warn("OverlayManager: failed to read pixel (attempt",d,")",s,w),d<h?await o.sleep(50*d):console.error("OverlayManager: failed to read pixel after",h,"attempts",s)}}return null}async _compositeTileOptimized(a,n){let i=await createImageBitmap(a),r=new OffscreenCanvas(i.width,i.height),s=r.getContext("2d");return s.imageSmoothingEnabled=!1,s.drawImage(i,0,0),s.globalAlpha=e.overlayOpacity,s.globalCompositeOperation="source-over",s.drawImage(n,0,0),await r.convertToBlob({type:"image/png",quality:.95})}async waitForTiles(a,n,i,r,s=0,c=0,p=1e4){let{startTileX:h,startTileY:d,endTileX:l,endTileY:w}=o.calculateTileRange(a,n,s,c,i,r,this.tileSize),g=[];for(let u=d;u<=w;u++)for(let v=h;v<=l;v++)g.push(`${v},${u}`);if(g.length===0)return!0;let S=Date.now();for(;Date.now()-S<p;){if(e.stopFlag)return console.log("waitForTiles: stopped by user"),!1;if(g.filter(v=>!this.originalTiles.has(v)).length===0)return console.log(`\u2705 All ${g.length} required tiles are loaded`),!0;await o.sleep(100)}return console.warn(`\u274C Timeout waiting for tiles: ${g.length} required, 
        ${g.filter(u=>this.originalTiles.has(u)).length} loaded`),!1}}let Me=new an,be=null,Zt=0,Qt=!1,We=null,ct=new Promise(t=>{We=t}),Nn=0,Fn=10,Ta=10,nn=24e4;function nt(t){We&&(We(t),We=null),be=t,Zt=Date.now()+nn,console.log("\u2705 Turnstile token set successfully")}function pt(){return be&&Date.now()<Zt}function on(){be=null,Zt=0,console.log("\u{1F5D1}\uFE0F Token invalidated, will force fresh generation")}async function Ca(t=!1){if(pt()&&!t)return be;if(t&&on(),Qt)return console.log("\u{1F504} Token generation already in progress, waiting..."),await o.sleep(2e3),pt()?be:null;Qt=!0;try{console.log("\u{1F504} Token expired or missing, generating new one...");let a=await Pa();if(a&&a.length>20)return nt(a),console.log("\u2705 Token captured and cached successfully"),a;console.log("\u26A0\uFE0F Invisible Turnstile failed, forcing browser automation...");let n=await Pt();return n&&n.length>20?(nt(n),console.log("\u2705 Fallback token captured successfully"),n):(console.log("\u274C All token generation methods failed"),null)}finally{Qt=!1}}async function Pa(){let t=performance.now();try{let{sitekey:a,token:n}=await o.obtainSitekeyAndToken();if(!a)throw new Error("No valid sitekey found");console.log("\u{1F511} Using sitekey:",a),typeof window<"u"&&window.navigator&&console.log("\u{1F9ED} UA:",window.navigator.userAgent.substring(0,50)+"...","Platform:",window.navigator.platform);let i=null;if(n&&typeof n=="string"&&n.length>20?(console.log("\u267B\uFE0F Reusing pre-generated Turnstile token"),i=n):pt()?(console.log("\u267B\uFE0F Using existing cached token (from previous session)"),i=be):(console.log("\u{1F510} Generating new token with executeTurnstile..."),i=await o.executeTurnstile(a,"paint"),i&&nt(i)),i&&typeof i=="string"&&i.length>20){let r=Math.round(performance.now()-t);return console.log(`\u2705 Turnstile token generated successfully in ${r}ms`),i}else throw new Error(`Invalid or empty token received - Length: ${(i==null?void 0:i.length)||0}`)}catch(a){let n=Math.round(performance.now()-t);throw console.error(`\u274C Turnstile token generation failed after ${n}ms:`,a),a}}function rn(t){var n;let a=document.createElement("script");a.textContent=`(${t})();`,(n=document.documentElement)==null||n.appendChild(a),a.remove()}rn(()=>{let t=new Map;window.addEventListener("message",n=>{let{source:i,blobID:r,blobData:s}=n.data;if(i==="auto-image-overlay"&&r&&s){let c=t.get(r);typeof c=="function"&&c(s),t.delete(r)}});let a=window.fetch;window.fetch=async function(...n){var s;let i=await a.apply(this,n),r=n[0]instanceof Request?n[0].url:n[0];if(typeof r=="string"){if(r.includes("https://backend.wplace.live/s0/pixel/"))try{let p=JSON.parse(n[1].body);p.t&&(console.log(`\u{1F50D}\u2705 Turnstile Token Captured - Type: ${typeof p.t}, Value: ${p.t?typeof p.t=="string"?p.t.length>50?p.t.substring(0,50)+"...":p.t:JSON.stringify(p.t):"null/undefined"}, Length: ${((s=p.t)==null?void 0:s.length)||0}`),window.postMessage({source:"turnstile-capture",token:p.t},"*"))}catch{}if((i.headers.get("content-type")||"").includes("image/png")&&r.includes(".png")){let p=i.clone();return new Promise(async h=>{let d=crypto.randomUUID(),l=await p.blob();t.set(d,w=>{h(new Response(w,{headers:p.headers,status:p.status,statusText:p.statusText}))}),window.postMessage({source:"auto-image-tile",endpoint:r,blobID:d,blobData:l},"*")})}}return i}}),window.addEventListener("message",t=>{var c;let{source:a,endpoint:n,blobID:i,blobData:r,token:s}=t.data;a==="auto-image-tile"&&n&&i&&r&&Me.processAndRespondToTileRequest(t.data),a==="turnstile-capture"&&s&&(nt(s),(c=document.querySelector("#statusText"))!=null&&c.textContent.includes("CAPTCHA")&&(o.showAlert(o.t("tokenCapturedSuccess"),"success"),$("colorsFound","success",{count:e.availableColors.length})))});async function sn(){try{let a=await(await fetch("https://backend.wplace.live/me",{credentials:"include"})).json();e.language=a.language==="pt"?"pt":"en"}catch{e.language=navigator.language.startsWith("pt")?"pt":"en"}}let o={sleep:t=>new Promise(a=>setTimeout(a,t)),dynamicSleep:async function(t){let a=Math.max(0,await t());for(;a>0;){let n=a>5e3?2e3:a>1e3?500:100;await this.sleep(Math.min(n,a)),a=Math.max(0,await t())}},waitForSelector:async(t,a=200,n=5e3)=>{let i=Date.now();for(;Date.now()-i<n;){let r=document.querySelector(t);if(r)return r;await o.sleep(a)}return null},msToTimeText(t){let a=Math.ceil(t/1e3),n=Math.floor(a/3600),i=Math.floor(a%3600/60),r=a%60;return n>0?`${n}h ${i}m ${r}s`:i>0?`${i}m ${r}s`:`${r}s`},calculateTileRange(t,a,n,i,r,s,c=1e3){let p=n+r,h=i+s;return{startTileX:t+Math.floor(n/c),startTileY:a+Math.floor(i/c),endTileX:t+Math.floor((p-1)/c),endTileY:a+Math.floor((h-1)/c)}},turnstileLoaded:!1,_turnstileContainer:null,_turnstileOverlay:null,_turnstileWidgetId:null,_lastSitekey:null,async loadTurnstile(){return window.turnstile?(this.turnstileLoaded=!0,Promise.resolve()):new Promise((t,a)=>{if(document.querySelector('script[src^="https://challenges.cloudflare.com/turnstile/v0/api.js"]')){let i=()=>{window.turnstile?(this.turnstileLoaded=!0,t()):setTimeout(i,100)};return i()}let n=document.createElement("script");n.src="https://challenges.cloudflare.com/turnstile/v0/api.js?render=explicit",n.async=!0,n.defer=!0,n.onload=()=>{this.turnstileLoaded=!0,console.log("\u2705 Turnstile script loaded successfully"),t()},n.onerror=()=>{console.error("\u274C Failed to load Turnstile script"),a(new Error("Failed to load Turnstile"))},document.head.appendChild(n)})},ensureTurnstileContainer(){return(!this._turnstileContainer||!document.body.contains(this._turnstileContainer))&&(this._turnstileContainer&&this._turnstileContainer.remove(),this._turnstileContainer=document.createElement("div"),this._turnstileContainer.className="wplace-turnstile-hidden",this._turnstileContainer.setAttribute("aria-hidden","true"),this._turnstileContainer.id="turnstile-widget-container",document.body.appendChild(this._turnstileContainer)),this._turnstileContainer},ensureTurnstileOverlayContainer(){if(this._turnstileOverlay&&document.body.contains(this._turnstileOverlay))return this._turnstileOverlay;let t=document.createElement("div");t.id="turnstile-overlay-container",t.className="wplace-turnstile-overlay wplace-overlay-hidden";let a=document.createElement("div");a.textContent=o.t("turnstileInstructions"),a.className="wplace-turnstile-title";let n=document.createElement("div");n.id="turnstile-overlay-host",n.className="wplace-turnstile-host";let i=document.createElement("button");return i.textContent=o.t("hideTurnstileBtn"),i.className="wplace-turnstile-hide-btn",i.addEventListener("click",()=>t.remove()),t.appendChild(a),t.appendChild(n),t.appendChild(i),document.body.appendChild(t),this._turnstileOverlay=t,t},async executeTurnstile(t,a="paint"){var i;if(await this.loadTurnstile(),this._turnstileWidgetId&&this._lastSitekey===t&&((i=window.turnstile)!=null&&i.execute))try{console.log("\u{1F504} Reusing existing Turnstile widget...");let r=await Promise.race([window.turnstile.execute(this._turnstileWidgetId,{action:a}),new Promise((s,c)=>setTimeout(()=>c(new Error("Execute timeout")),15e3))]);if(r&&r.length>20)return console.log("\u2705 Token generated via widget reuse"),r}catch(r){console.log("\uFFFD Widget reuse failed, will create a fresh widget:",r.message)}let n=await this.createTurnstileWidget(t,a);return n&&n.length>20?n:(console.log("\uFFFD Falling back to interactive Turnstile (visible)."),await this.createTurnstileWidgetInteractive(t,a))},async createTurnstileWidget(t,a){return new Promise(n=>{var i,r;try{if(this._turnstileWidgetId&&((i=window.turnstile)!=null&&i.remove))try{window.turnstile.remove(this._turnstileWidgetId),console.log("\u{1F9F9} Cleaned up existing Turnstile widget")}catch(p){console.warn("\u26A0\uFE0F Widget cleanup warning:",p.message)}let s=this.ensureTurnstileContainer();if(s.innerHTML="",!((r=window.turnstile)!=null&&r.render)){console.error("\u274C Turnstile not available for rendering"),n(null);return}console.log("\u{1F527} Creating invisible Turnstile widget...");let c=window.turnstile.render(s,{sitekey:t,action:a,size:"invisible",retry:"auto","retry-interval":8e3,callback:p=>{console.log("\u2705 Invisible Turnstile callback"),n(p)},"error-callback":()=>n(null),"timeout-callback":()=>n(null)});if(this._turnstileWidgetId=c,this._lastSitekey=t,!c)return n(null);Promise.race([window.turnstile.execute(c,{action:a}),new Promise((p,h)=>setTimeout(()=>h(new Error("Invisible execute timeout")),12e3))]).then(n).catch(()=>n(null))}catch(s){console.error("\u274C Invisible Turnstile creation failed:",s),n(null)}})},async createTurnstileWidgetInteractive(t,a){return console.log("\u{1F504} Creating interactive Turnstile widget (visible)"),new Promise(n=>{var i;try{if(this._turnstileWidgetId&&((i=window.turnstile)!=null&&i.remove))try{window.turnstile.remove(this._turnstileWidgetId)}catch(h){console.warn("\u26A0\uFE0F Widget cleanup warning:",h.message)}let r=this.ensureTurnstileOverlayContainer();r.classList.remove("wplace-overlay-hidden"),r.style.display="block";let s=r.querySelector("#turnstile-overlay-host");s.innerHTML="";let c=setTimeout(()=>{console.warn("\u23F0 Interactive Turnstile widget timeout"),r.classList.add("wplace-overlay-hidden"),r.style.display="none",n(null)},6e4),p=window.turnstile.render(s,{sitekey:t,action:a,size:"normal",theme:"light",callback:h=>{clearTimeout(c),r.classList.add("wplace-overlay-hidden"),r.style.display="none",console.log("\u2705 Interactive Turnstile completed successfully"),typeof h=="string"&&h.length>20?n(h):(console.warn("\u274C Invalid token from interactive widget"),n(null))},"error-callback":h=>{clearTimeout(c),r.classList.add("wplace-overlay-hidden"),r.style.display="none",console.warn("\u274C Interactive Turnstile error:",h),n(null)}});this._turnstileWidgetId=p,this._lastSitekey=t,p?console.log("\u2705 Interactive Turnstile widget created, waiting for user interaction..."):(clearTimeout(c),r.classList.add("wplace-overlay-hidden"),r.style.display="none",console.warn("\u274C Failed to create interactive Turnstile widget"),n(null))}catch(r){console.error("\u274C Interactive Turnstile creation failed:",r),n(null)}})},cleanupTurnstile(){var t;if(this._turnstileWidgetId&&((t=window.turnstile)!=null&&t.remove))try{window.turnstile.remove(this._turnstileWidgetId)}catch(a){console.warn("Failed to cleanup Turnstile widget:",a)}this._turnstileContainer&&document.body.contains(this._turnstileContainer)&&this._turnstileContainer.remove(),this._turnstileOverlay&&document.body.contains(this._turnstileOverlay)&&this._turnstileOverlay.remove(),this._turnstileWidgetId=null,this._turnstileContainer=null,this._turnstileOverlay=null,this._lastSitekey=null},async obtainSitekeyAndToken(t="0x4AAAAAABpqJe8FO0N84q0F"){var r;if(this._cachedSitekey)return console.log("\u{1F50D} Using cached sitekey:",this._cachedSitekey),pt()?{sitekey:this._cachedSitekey,token:be}:{sitekey:this._cachedSitekey,token:null};let a=["0x4AAAAAABpqJe8FO0N84q0F","0x4AAAAAAAJ7xjKAp6Mt_7zw","0x4AAAAAADm5QWx6Ov2LNF2g"],n=async(s,c)=>{if(!s||s.length<10)return null;console.log(`\u{1F50D} Testing sitekey from ${c}:`,s);let p=await this.executeTurnstile(s);return p&&p.length>=20?(console.log(`\u2705 Valid token generated from ${c} sitekey`),nt(p),this._cachedSitekey=s,{sitekey:s,token:p}):(console.log(`\u274C Failed to get token from ${c} sitekey`),null)};try{let s=document.querySelector("[data-sitekey]");if(s){let d=s.getAttribute("data-sitekey"),l=await n(d,"data attribute");if(l)return l}let c=document.querySelector(".cf-turnstile");if((r=c==null?void 0:c.dataset)!=null&&r.sitekey){let d=c.dataset.sitekey,l=await n(d,"turnstile element");if(l)return l}let p=document.querySelectorAll('meta[name*="turnstile"], meta[property*="turnstile"]');for(let d of p){let l=d.getAttribute("content"),w=await n(l,"meta tag");if(w)return w}if(window.__TURNSTILE_SITEKEY){let d=await n(window.__TURNSTILE_SITEKEY,"global variable");if(d)return d}let h=document.querySelectorAll("script");for(let d of h){let w=(d.textContent||d.innerHTML).match(/(?:sitekey|data-sitekey)['"\s\[\]:\=\(]*['"]?([0-9a-zA-Z_-]{20,})['"]?/i);if(w&&w[1]){let g=w[1].replace(/['"]/g,""),S=await n(g,"script content");if(S)return S}}console.log("\u{1F50D} Testing known potential sitekeys...");for(let d of a){let l=await n(d,"known list");if(l)return l}}catch(s){console.warn("\u26A0\uFE0F Error during sitekey detection:",s)}console.log("\u{1F527} Trying fallback sitekey:",t);let i=await n(t,"fallback");return i||(console.error("\u274C No working sitekey or token found."),{sitekey:null,token:null})},createElement:(t,a={},n=[])=>{let i=document.createElement(t);return Object.entries(a).forEach(([r,s])=>{r==="style"&&typeof s=="object"?Object.assign(i.style,s):r==="className"?i.className=s:r==="innerHTML"?i.innerHTML=s:i.setAttribute(r,s)}),typeof n=="string"?i.textContent=n:Array.isArray(n)&&n.forEach(r=>{typeof r=="string"?i.appendChild(document.createTextNode(r)):i.appendChild(r)}),i},createButton:(t,a,n,i,r="wplace-btn-primary")=>{let s=o.createElement("button",{id:t,className:r,innerHTML:`${n?`<i class="${n}"></i>`:""}<span>${a}</span>`});return i&&s.addEventListener("click",i),s},addHoldToRepeatListener:(t,a,n=500,i=150)=>{let r,s,c=i,p=25,h=.9,d=()=>{a(),c=i,r=setTimeout(()=>{let w=()=>{a(),c=Math.max(p,c*h),s=setTimeout(w,c)};w()},n)},l=()=>{clearTimeout(r),clearTimeout(s),c=i};t.addEventListener("mousedown",d),t.addEventListener("mouseup",l),t.addEventListener("mouseleave",l),t.addEventListener("touchstart",d),t.addEventListener("touchend",l),t.addEventListener("contextmenu",w=>w.preventDefault())},t:(t,a={})=>{var r,s,c,p;let n=`${e.language}_${t}`;if(Xt.has(n)){let h=Xt.get(n);return Object.keys(a).forEach(d=>{h=h.replace(`{${d}}`,a[d])}),h}if((r=Fe[e.language])!=null&&r[t]){let h=Fe[e.language][t];return Xt.set(n,h),Object.keys(a).forEach(d=>{h=h.replace(`{${d}}`,a[d])}),h}if(e.language!=="en"&&((s=Fe.en)!=null&&s[t])){let h=Fe.en[t];return Object.keys(a).forEach(d=>{h=h.replace(`{${d}}`,a[d])}),h}let i=((c=Jt[e.language])==null?void 0:c[t])||((p=Jt.en)==null?void 0:p[t])||t;return Object.keys(a).forEach(h=>{i=i.replace(new RegExp(`\\{${h}\\}`,"g"),a[h])}),i===t&&t!=="undefined"&&console.warn(`\u26A0\uFE0F Missing translation for key: ${t} (language: ${e.language})`),i},showAlert:(t,a="info")=>{let n=document.createElement("div");n.className=`wplace-alert-base wplace-alert-${a}`,n.textContent=t,document.body.appendChild(n),setTimeout(()=>{n.style.animation="slide-down 0.3s ease-out reverse",setTimeout(()=>{document.body.removeChild(n)},300)},4e3)},colorDistance:(t,a)=>Math.sqrt(Math.pow(t[0]-a[0],2)+Math.pow(t[1]-a[1],2)+Math.pow(t[2]-a[2],2)),_labCache:new Map,_rgbToLab:(t,a,n)=>{let i=T=>(T/=255,T<=.04045?T/12.92:Math.pow((T+.055)/1.055,2.4)),r=i(t),s=i(a),c=i(n),p=r*.4124+s*.3576+c*.1805,h=r*.2126+s*.7152+c*.0722,d=r*.0193+s*.1192+c*.9505;p/=.95047,h/=1,d/=1.08883;let l=T=>T>.008856?Math.cbrt(T):7.787*T+16/116,w=l(p),g=l(h),S=l(d),u=116*g-16,v=500*(w-g),x=200*(g-S);return[u,v,x]},_lab:(t,a,n)=>{let i=t<<16|a<<8|n,r=o._labCache.get(i);return r||(r=o._rgbToLab(t,a,n),o._labCache.set(i,r)),r},findClosestPaletteColor:(t,a,n,i)=>{if((!i||i.length===0)&&(i=Object.values(f.COLOR_MAP).filter(l=>l.rgb).map(l=>[l.rgb.r,l.rgb.g,l.rgb.b])),e.colorMatchingAlgorithm==="legacy"){let l=1/0,w=[0,0,0];for(let g=0;g<i.length;g++){let[S,u,v]=i[g],x=(S+t)/2,T=S-t,P=u-a,M=v-n,R=Math.sqrt(((512+x)*T*T>>8)+4*P*P+((767-x)*M*M>>8));R<l&&(l=R,w=[S,u,v])}return w}let[r,s,c]=o._lab(t,a,n),p=Math.sqrt(s*s+c*c),h=null,d=1/0;for(let l=0;l<i.length;l++){let[w,g,S]=i[l],[u,v,x]=o._lab(w,g,S),T=r-u,P=s-v,M=c-x,R=T*T+P*P+M*M;if(e.enableChromaPenalty&&p>20){let W=Math.sqrt(v*v+x*x);if(W<p){let Z=p-W;R+=Z*Z*e.chromaPenaltyWeight}}if(R<d&&(d=R,h=i[l],d===0))break}return h||[0,0,0]},isWhitePixel:(t,a,n)=>{let i=e.customWhiteThreshold||f.WHITE_THRESHOLD;return t>=i&&a>=i&&n>=i},resolveColor(t,a,n=!1){if(!a||a.length===0)return{id:null,rgb:t};let i=`${t[0]},${t[1]},${t[2]}|${e.colorMatchingAlgorithm}|${e.enableChromaPenalty?"c":"nc"}|${e.chromaPenaltyWeight}|${n?"exact":"closest"}`;if(Xe.has(i))return Xe.get(i);if(n){let d=a.find(w=>w.rgb[0]===t[0]&&w.rgb[1]===t[1]&&w.rgb[2]===t[2]),l=d?{id:d.id,rgb:[...d.rgb]}:{id:null,rgb:t};return Xe.set(i,l),l}let r=e.customWhiteThreshold||f.WHITE_THRESHOLD;if(t[0]>=r&&t[1]>=r&&t[2]>=r){let d=a.find(l=>l.rgb[0]>=r&&l.rgb[1]>=r&&l.rgb[2]>=r);if(d){let l={id:d.id,rgb:[...d.rgb]};return Xe.set(i,l),l}}let s=a[0].id,c=[...a[0].rgb],p=1/0;if(e.colorMatchingAlgorithm==="legacy")for(let d=0;d<a.length;d++){let l=a[d],[w,g,S]=l.rgb,u=(w+t[0])/2,v=w-t[0],x=g-t[1],T=S-t[2],P=Math.sqrt(((512+u)*v*v>>8)+4*x*x+((767-u)*T*T>>8));if(P<p&&(p=P,s=l.id,c=[...l.rgb],P===0))break}else{let[d,l,w]=o._lab(t[0],t[1],t[2]),g=Math.sqrt(l*l+w*w),S=e.enableChromaPenalty?e.chromaPenaltyWeight||.15:0;for(let u=0;u<a.length;u++){let v=a[u],[x,T,P]=v.rgb,[M,R,W]=o._lab(x,T,P),Z=d-M,ve=l-R,Ie=w-W,j=Z*Z+ve*ve+Ie*Ie;if(S>0&&g>20){let de=Math.sqrt(R*R+W*W);if(de<g){let se=g-de;j+=se*se*S}}if(j<p&&(p=j,s=v.id,c=[...v.rgb],j===0))break}}let h={id:s,rgb:c};if(Xe.set(i,h),Xe.size>15e3){let d=Xe.keys().next().value;Xe.delete(d)}return h},createImageUploader:()=>new Promise(t=>{let a=document.createElement("input");a.type="file",a.accept="image/png,image/jpeg",a.onchange=()=>{let n=new FileReader;n.onload=()=>t(n.result),n.readAsDataURL(a.files[0])},a.click()}),createFileDownloader:(t,a)=>{let n=new Blob([t],{type:"application/json"}),i=URL.createObjectURL(n),r=document.createElement("a");r.href=i,r.download=a,document.body.appendChild(r),r.click(),document.body.removeChild(r),URL.revokeObjectURL(i)},createFileUploader:()=>new Promise((t,a)=>{let n=document.createElement("input");n.type="file",n.accept=".json",n.onchange=i=>{let r=i.target.files[0];if(r){let s=new FileReader;s.onload=()=>{try{let c=JSON.parse(s.result);t(c)}catch{a(new Error("Invalid JSON file"))}},s.onerror=()=>a(new Error("File reading error")),s.readAsText(r)}else a(new Error("No file selected"))},n.click()}),extractAvailableColors:()=>{let t=document.querySelectorAll('.tooltip button[id^="color-"]');if(t.length===0)return console.log("\u274C No color elements found on page"),null;let a=[],n=[];return Array.from(t).forEach(i=>{let r=Number.parseInt(i.id.replace("color-",""));if(r===0)return;let s=i.style.backgroundColor.match(/\d+/g);if(!s||s.length<3){console.warn(`Skipping color element ${i.id} \u2014 cannot parse RGB`);return}let c=s.map(Number),p=Object.values(f.COLOR_MAP).find(l=>l.id===r),h=p?p.name:`Unknown Color ${r}`,d={id:r,name:h,rgb:c};i.querySelector("svg")?n.push(d):a.push(d)}),console.log("=== CAPTURED COLORS STATUS ==="),console.log(`Total available colors: ${a.length}`),console.log(`Total unavailable colors: ${n.length}`),console.log(`Total colors scanned: ${a.length+n.length}`),a.length>0&&(console.log(`
--- AVAILABLE COLORS ---`),a.forEach((i,r)=>{console.log(`${r+1}. ID: ${i.id}, Name: "${i.name}", RGB: (${i.rgb[0]}, ${i.rgb[1]}, ${i.rgb[2]})`)})),n.length>0&&(console.log(`
--- UNAVAILABLE COLORS ---`),n.forEach((i,r)=>{console.log(`${r+1}. ID: ${i.id}, Name: "${i.name}", RGB: (${i.rgb[0]}, ${i.rgb[1]}, ${i.rgb[2]}) [LOCKED]`)})),console.log("=== END COLOR STATUS ==="),a},formatTime:t=>{let a=Math.floor(t/1e3%60),n=Math.floor(t/(1e3*60)%60),i=Math.floor(t/(1e3*60*60)%24),r=Math.floor(t/(1e3*60*60*24)),s="";return r>0&&(s+=`${r}d `),(i>0||r>0)&&(s+=`${i}h `),(n>0||i>0||r>0)&&(s+=`${n}m `),s+=`${a}s`,s},calculateEstimatedTime:(t,a,n)=>{if(t<=0)return 0;let i=e.paintingSpeed>0?1e3/e.paintingSpeed:1e3,r=t*i,c=Math.ceil(t/Math.max(a,1))*n;return r+c},initializePaintedMap:(t,a)=>{(!e.paintedMap||e.paintedMap.length!==a)&&(e.paintedMap=Array(a).fill().map(()=>Array(t).fill(!1)),console.log(`\u{1F4CB} Initialized painted map: ${t}x${a}`))},markPixelPainted:(t,a,n=0,i=0)=>{let r=t+n,s=a+i;e.paintedMap&&e.paintedMap[s]&&r>=0&&r<e.paintedMap[s].length&&(e.paintedMap[s][r]=!0)},isPixelPainted:(t,a,n=0,i=0)=>{let r=t+n,s=a+i;return e.paintedMap&&e.paintedMap[s]&&r>=0&&r<e.paintedMap[s].length?e.paintedMap[s][r]:!1},shouldAutoSave:()=>{let t=Date.now(),a=e.paintedPixels-e._lastSavePixelCount,n=t-e._lastSaveTime;return!e._saveInProgress&&a>=25&&n>=3e4},performSmartSave:()=>{if(!o.shouldAutoSave())return!1;e._saveInProgress=!0;let t=o.saveProgress();return t&&(e._lastSavePixelCount=e.paintedPixels,e._lastSaveTime=Date.now(),console.log(`\u{1F4BE} Auto-saved at ${e.paintedPixels} pixels`)),e._saveInProgress=!1,t},packPaintedMapToBase64:(t,a,n)=>{if(!t||!a||!n)return null;let i=a*n,r=Math.ceil(i/8),s=new Uint8Array(r),c=0;for(let d=0;d<n;d++){let l=t[d];for(let w=0;w<a;w++){let g=l&&l[w]?1:0,S=c>>3,u=c&7;g&&(s[S]|=1<<u),c++}}let p="",h=32768;for(let d=0;d<s.length;d+=h)p+=String.fromCharCode.apply(null,s.subarray(d,Math.min(d+h,s.length)));return btoa(p)},unpackPaintedMapFromBase64:(t,a,n)=>{if(!t||!a||!n)return null;let i=atob(t),r=new Uint8Array(i.length);for(let p=0;p<i.length;p++)r[p]=i.charCodeAt(p);let s=Array(n).fill().map(()=>Array(a).fill(!1)),c=0;for(let p=0;p<n;p++)for(let h=0;h<a;h++){let d=c>>3,l=c&7;s[p][h]=(r[d]>>l&1)===1,c++}return s},migrateProgressToV2:t=>{var n,i;if(!t||!(!t.version||t.version==="1"||t.version==="1.0"||t.version==="1.1"))return t;try{let r={...t},s=(n=r.imageData)==null?void 0:n.width,c=(i=r.imageData)==null?void 0:i.height;if(r.paintedMap&&s&&c){let p=o.packPaintedMapToBase64(r.paintedMap,s,c);r.paintedMapPacked={width:s,height:c,data:p}}return delete r.paintedMap,r.version="2",r}catch(r){return console.warn("Migration to v2 failed, using original data:",r),t}},migrateProgressToV21:t=>{var i,r;if(!t||t.version==="2.1")return t;let a=t.version==="2"||t.version==="2.0",n=!t.version||t.version==="1"||t.version==="1.0"||t.version==="1.1";if(!a&&!n)return t;try{let s={...t};if(n){let c=(i=s.imageData)==null?void 0:i.width,p=(r=s.imageData)==null?void 0:r.height;if(s.paintedMap&&c&&p){let h=o.packPaintedMapToBase64(s.paintedMap,c,p);s.paintedMapPacked={width:c,height:p,data:h}}delete s.paintedMap}return s.version="2.1",s}catch(s){return console.warn("Migration to v2.1 failed, using original data:",s),t}},migrateProgressToV22:t=>{try{let a={...t};return a.version="2.2",a.state.coordinateMode||(a.state.coordinateMode=f.COORDINATE_MODE),a.state.coordinateDirection||(a.state.coordinateDirection=f.COORDINATE_DIRECTION),a.state.coordinateSnake||(a.state.coordinateSnake=f.COORDINATE_SNAKE),a.state.blockWidth||(a.state.blockWidth=f.COORDINATE_BLOCK_WIDTH),a.state.blockHeight||(a.state.blockHeight=f.COORDINATE_BLOCK_HEIGHT),a}catch(a){return console.warn("Migration to v2.2 failed, using original data:",a),t}},buildPaintedMapPacked(){if(e.paintedMap&&e.imageData){let t=o.packPaintedMapToBase64(e.paintedMap,e.imageData.width,e.imageData.height);if(t)return{width:e.imageData.width,height:e.imageData.height,data:t}}return null},buildProgressData(){return{timestamp:Date.now(),version:"2.2",state:{totalPixels:e.totalPixels,paintedPixels:e.paintedPixels,lastPosition:e.lastPosition,startPosition:e.startPosition,region:e.region,imageLoaded:e.imageLoaded,colorsChecked:e.colorsChecked,coordinateMode:e.coordinateMode,coordinateDirection:e.coordinateDirection,coordinateSnake:e.coordinateSnake,blockWidth:e.blockWidth,blockHeight:e.blockHeight,availableColors:e.availableColors},imageData:e.imageData?{width:e.imageData.width,height:e.imageData.height,pixels:Array.from(e.imageData.pixels),totalPixels:e.imageData.totalPixels}:null,paintedMapPacked:o.buildPaintedMapPacked()}},migrateProgress(t){if(!t)return null;let a=t,n=a.version;return(!n||n==="1"||n==="1.0"||n==="1.1")&&(a=o.migrateProgressToV2(a)),(a.version==="2"||a.version==="2.0")&&(a=o.migrateProgressToV21(a)),a.version==="2.1"&&(a=o.migrateProgressToV22(a)),a},saveProgress:()=>{try{let t=o.buildProgressData(e);return localStorage.setItem("wplace-bot-progress",JSON.stringify(t)),!0}catch(t){return console.error("Error saving progress:",t),!1}},loadProgress:()=>{try{let t=localStorage.getItem("wplace-bot-progress");if(!t)return null;let a=JSON.parse(t),n=o.migrateProgress(a);if(n&&n!==a)try{localStorage.setItem("wplace-bot-progress",JSON.stringify(n))}catch{}return n}catch(t){return console.error("Error loading progress:",t),null}},clearProgress:()=>{try{return localStorage.removeItem("wplace-bot-progress"),e.paintedMap=null,e._lastSavePixelCount=0,e._lastSaveTime=0,e.coordinateMode=f.COORDINATE_MODE,e.coordinateDirection=f.COORDINATE_DIRECTION,e.coordinateSnake=f.COORDINATE_SNAKE,e.blockWidth=f.COORDINATE_BLOCK_WIDTH,e.blockHeight=f.COORDINATE_BLOCK_HEIGHT,console.log("\u{1F4CB} Progress and painted map cleared"),!0}catch(t){return console.error("Error clearing progress:",t),!1}},restoreProgress:t=>{try{if(Object.assign(e,t.state),t.state.coordinateMode&&(e.coordinateMode=t.state.coordinateMode),t.state.coordinateDirection&&(e.coordinateDirection=t.state.coordinateDirection),t.state.coordinateSnake!==void 0&&(e.coordinateSnake=t.state.coordinateSnake),t.state.blockWidth&&(e.blockWidth=t.state.blockWidth),t.state.blockHeight&&(e.blockHeight=t.state.blockHeight),t.imageData){e.imageData={...t.imageData,pixels:new Uint8ClampedArray(t.imageData.pixels)};try{let a=document.createElement("canvas");a.width=e.imageData.width,a.height=e.imageData.height;let n=a.getContext("2d"),i=new ImageData(e.imageData.pixels,e.imageData.width,e.imageData.height);n.putImageData(i,0,0);let r=new ea("");r.img=a,r.canvas=a,r.ctx=n,e.imageData.processor=r}catch(a){console.warn("Could not rebuild processor from saved image data:",a)}}if(t.paintedMapPacked&&t.paintedMapPacked.data){let{width:a,height:n,data:i}=t.paintedMapPacked;e.paintedMap=o.unpackPaintedMapFromBase64(i,a,n)}else t.paintedMap&&(e.paintedMap=t.paintedMap.map(a=>Array.from(a)));return!0}catch(a){return console.error("Error restoring progress:",a),!1}},saveProgressToFile:()=>{try{let t=o.buildProgressData(),a=`wplace-bot-progress-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.json`;return o.createFileDownloader(JSON.stringify(t,null,2),a),!0}catch(t){return console.error("Error saving to file:",t),!1}},loadProgressFromFile:async()=>{try{let t=await o.createFileUploader();if(!t||!t.state)throw new Error("Invalid file format");let a=o.migrateProgress(t);return o.restoreProgress(a)}catch(t){throw console.error("Error loading from file:",t),t}},restoreOverlayFromData:async()=>{if(!e.imageLoaded||!e.imageData||!e.startPosition||!e.region)return!1;try{let t=new ImageData(e.imageData.pixels,e.imageData.width,e.imageData.height),a=new OffscreenCanvas(e.imageData.width,e.imageData.height);a.getContext("2d").putImageData(t,0,0);let i=await a.transferToImageBitmap();await Me.setImage(i),await Me.setPosition(e.startPosition,e.region),Me.enable();let r=document.getElementById("toggleOverlayBtn");return r&&(r.disabled=!1,r.classList.add("active")),console.log("Overlay restored from data"),!0}catch(t){return console.error("Failed to restore overlay from data:",t),!1}},updateCoordinateUI({mode:t,directionControls:a,snakeControls:n,blockControls:i}){let r=t==="rows"||t==="columns",s=t==="blocks"||t==="shuffle-blocks";a&&(a.style.display=r?"block":"none"),n&&(n.style.display=r?"block":"none"),i&&(i.style.display=s?"block":"none")}};class ea{constructor(a){this.imageSrc=a,this.img=null,this.canvas=null,this.ctx=null}async load(){return new Promise((a,n)=>{this.img=new Image,this.img.crossOrigin="anonymous",this.img.onload=()=>{this.canvas=document.createElement("canvas"),this.ctx=this.canvas.getContext("2d"),this.canvas.width=this.img.width,this.canvas.height=this.img.height,this.ctx.drawImage(this.img,0,0),a()},this.img.onerror=n,this.img.src=this.imageSrc})}getDimensions(){return{width:this.canvas.width,height:this.canvas.height}}getPixelData(){return this.ctx.getImageData(0,0,this.canvas.width,this.canvas.height).data}resize(a,n){let i=document.createElement("canvas"),r=i.getContext("2d");return i.width=a,i.height=n,r.imageSmoothingEnabled=!1,r.drawImage(this.canvas,0,0,a,n),this.canvas.width=a,this.canvas.height=n,this.ctx.imageSmoothingEnabled=!1,this.ctx.drawImage(i,0,0),this.ctx.getImageData(0,0,a,n).data}generatePreview(a,n){let i=document.createElement("canvas"),r=i.getContext("2d");return i.width=a,i.height=n,r.imageSmoothingEnabled=!1,r.drawImage(this.img,0,0,a,n),i.toDataURL()}}let Ia={async paintPixelInRegion(t,a,n,i,r){try{if(await Ca(),!be)return"token_error";let s={coords:[n,i],colors:[r],t:be},c=await fetch(`https://backend.wplace.live/s0/pixel/${t}/${a}`,{method:"POST",headers:{"Content-Type":"text/plain;charset=UTF-8"},credentials:"include",body:JSON.stringify(s)});if(c.status===403)return console.error("\u274C 403 Forbidden. Turnstile token might be invalid or expired."),be=null,ct=new Promise(h=>{We=h}),"token_error";let p=await c.json();return(p==null?void 0:p.painted)===1}catch(s){return console.error("Paint request failed:",s),!1}},async getCharges(){var a,n,i;let t={charges:0,max:1,cooldown:f.COOLDOWN_DEFAULT};try{let r=await fetch("https://backend.wplace.live/me",{credentials:"include"});if(!r.ok)return console.error(`Failed to get charges: HTTP ${r.status}`),t;let s=await r.json();return{charges:((a=s.charges)==null?void 0:a.count)??0,max:((n=s.charges)==null?void 0:n.max)??1,cooldown:((i=s.charges)==null?void 0:i.cooldownMs)??f.COOLDOWN_DEFAULT}}catch(r){return console.error("Failed to get charges:",r),t}}},Ve={pollTimer:null,pollIntervalMs:6e4,icon(){let t=document.querySelector("link[rel~='icon']");return(t==null?void 0:t.href)||location.origin+"/favicon.ico"},async requestPermission(){if(!("Notification"in window))return o.showAlert(o.t("notificationsNotSupported"),"warning"),"denied";if(Notification.permission==="granted")return"granted";try{return await Notification.requestPermission()}catch{return Notification.permission}},canNotify(){return e.notificationsEnabled&&typeof Notification<"u"&&Notification.permission==="granted"},notify(t,a,n="wplace-charges",i=!1){if(!this.canNotify()||!i&&e.notifyOnlyWhenUnfocused&&document.hasFocus())return!1;try{return new Notification(t,{body:a,tag:n,renotify:!0,icon:this.icon(),badge:this.icon(),silent:!1}),!0}catch{return o.showAlert(a,"info"),!1}},resetEdgeTracking(){e._lastChargesBelow=e.displayCharges<e.cooldownChargeThreshold,e._lastChargesNotifyAt=0},maybeNotifyChargesReached(t=!1){if(!e.notificationsEnabled||!e.notifyOnChargesReached)return;let a=e.displayCharges>=e.cooldownChargeThreshold,n=Date.now(),i=Math.max(1,Number(e.notificationIntervalMinutes||5))*6e4;if(a){let r=e._lastChargesBelow||t,s=n-(e._lastChargesNotifyAt||0)>=i;if(r||s){let c=o.t("chargesReadyMessage",{current:e.displayCharges,max:e.maxCharges,threshold:e.cooldownChargeThreshold});this.notify(o.t("chargesReadyNotification"),c,"wplace-notify-charges"),e._lastChargesNotifyAt=n}e._lastChargesBelow=!1}else e._lastChargesBelow=!0},startPolling(){this.stopPolling(),!(!e.notificationsEnabled||!e.notifyOnChargesReached)&&(this.pollTimer=setInterval(async()=>{try{let{charges:t,cooldown:a,max:n}=await Ia.getCharges();e.displayCharges=Math.floor(t),e.cooldown=a,e.maxCharges=Math.max(1,Math.floor(n)),this.maybeNotifyChargesReached()}catch{}},this.pollIntervalMs))},stopPolling(){this.pollTimer&&(clearInterval(this.pollTimer),this.pollTimer=null)},syncFromState(){this.resetEdgeTracking(),e.notificationsEnabled&&e.notifyOnChargesReached?this.startPolling():this.stopPolling()}},Xe=new Map,$=()=>{},_e=t=>{},gt=()=>{};function Ct(){var a;e.activeColorPalette=[];let t=document.querySelectorAll(".wplace-color-swatch.active");t&&t.forEach(n=>{let i=n.getAttribute("data-rgb");if(i){let r=i.split(",").map(Number);e.activeColorPalette.push(r)}}),((a=document.querySelector(".resize-container"))==null?void 0:a.style.display)==="block"&&fe()}function Ea(t,a=!1){let n=document.querySelectorAll(".wplace-color-swatch");n&&n.forEach(i=>{let r=i.classList.contains("unavailable");(!r||a)&&(r||i.classList.toggle("active",t))}),Ct()}function ln(){let t=document.querySelectorAll(".wplace-color-swatch");t&&t.forEach(a=>{let n=parseInt(a.getAttribute("data-color-id"),10);!isNaN(n)&&n>=32&&a.classList.toggle("active",!1)}),Ct()}function cn(t){var r,s,c;let a=t.querySelector("#colors-container"),n=t.querySelector("#showAllColorsToggle");if(!a)return;if(!e.availableColors||e.availableColors.length===0){a.innerHTML=`<div class="wplace-colors-placeholder">${o.t("uploadImageFirst")}</div>`;return}function i(p=!1){a.innerHTML="";let h=0,d=0;Object.values(f.COLOR_MAP).filter(w=>w.rgb!==null).forEach(w=>{let{id:g,name:S,rgb:u}=w,v=`${u.r},${u.g},${u.b}`;d++;let x=e.availableColors.some(R=>R.rgb[0]===u.r&&R.rgb[1]===u.g&&R.rgb[2]===u.b);if(!p&&!x)return;x&&h++;let T=o.createElement("div",{className:"wplace-color-item"}),P=o.createElement("button",{className:`wplace-color-swatch ${x?"":"unavailable"}`,title:`${S} (ID: ${g})${x?"":" (Unavailable)"}`,"data-rgb":v,"data-color-id":g});P.style.backgroundColor=`rgb(${u.r}, ${u.g}, ${u.b})`,x?P.classList.add("active"):(P.style.opacity="0.4",P.style.filter="grayscale(50%)",P.disabled=!0);let M=o.createElement("span",{className:"wplace-color-item-name",style:x?"":"color: #888; font-style: italic;"},S+(x?"":" (N/A)"));x&&P.addEventListener("click",()=>{P.classList.toggle("active"),Ct()}),T.appendChild(P),T.appendChild(M),a.appendChild(T)}),Ct()}i(!1),n&&n.addEventListener("change",p=>{i(p.target.checked)}),(r=t.querySelector("#selectAllBtn"))==null||r.addEventListener("click",()=>Ea(!0,n==null?void 0:n.checked)),(s=t.querySelector("#unselectAllBtn"))==null||s.addEventListener("click",()=>Ea(!1,n==null?void 0:n.checked)),(c=t.querySelector("#unselectPaidBtn"))==null||c.addEventListener("click",()=>ln())}async function ta(){let t=performance.now();if(e.tokenSource==="manual")return console.log("\u{1F3AF} Manual token source selected - using pixel placement automation"),await Pt();try{let{sitekey:a,token:n}=await o.obtainSitekeyAndToken();if(!a)throw new Error("No valid sitekey found");console.log("\u{1F511} Generating Turnstile token for sitekey:",a),console.log("\u{1F9ED} UA:",navigator.userAgent.substring(0,50)+"...","Platform:",navigator.platform),window.turnstile||await o.loadTurnstile();let i=null;if(n&&typeof n=="string"&&n.length>20?(console.log("\u267B\uFE0F Reusing pre-generated token from sitekey detection phase"),i=n):pt()?(console.log("\u267B\uFE0F Using existing cached token (from previous operation)"),i=be):(console.log("\u{1F510} No valid pre-generated or cached token, creating new one..."),i=await o.executeTurnstile(a,"paint"),i&&nt(i)),console.log(`\u{1F50D} Token received - Type: ${typeof i}, Value: ${i?typeof i=="string"?i.length>50?i.substring(0,50)+"...":i:JSON.stringify(i):"null/undefined"}, Length: ${(i==null?void 0:i.length)||0}`),typeof i=="string"&&i.length>20){let r=Math.round(performance.now()-t);return console.log(`\u2705 Turnstile token generated successfully in ${r}ms`),i}else throw new Error(`Invalid or empty token received - Type: ${typeof i}, Value: ${JSON.stringify(i)}, Length: ${(i==null?void 0:i.length)||0}`)}catch(a){let n=Math.round(performance.now()-t);if(console.error(`\u274C Turnstile token generation failed after ${n}ms:`,a),e.tokenSource==="hybrid")return console.log("\u{1F504} Hybrid mode: Generator failed, automatically switching to manual pixel placement..."),await Pt();throw a}}async function Pt(){return new Promise(async(t,a)=>{try{We||(ct=new Promise(r=>{We=r}));let n=o.sleep(2e4).then(()=>a(new Error("Auto-CAPTCHA timed out."))),i=(async()=>{let r=await o.waitForSelector("button.btn.btn-primary.btn-lg, button.btn-primary.sm\\:btn-xl",200,1e4);if(!r)throw new Error("Could not find the main paint button.");r.click(),await o.sleep(500);let s=await o.waitForSelector("button#color-0",200,5e3);if(!s)throw new Error("Could not find the transparent color button.");s.click(),await o.sleep(500);let c=await o.waitForSelector("canvas",200,5e3);if(!c)throw new Error("Could not find the canvas element.");c.setAttribute("tabindex","0"),c.focus();let p=c.getBoundingClientRect(),h=Math.round(p.left+p.width/2),d=Math.round(p.top+p.height/2);c.dispatchEvent(new MouseEvent("mousemove",{clientX:h,clientY:d,bubbles:!0})),c.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",bubbles:!0})),await o.sleep(50),c.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",bubbles:!0})),await o.sleep(500),await o.sleep(800),(async()=>{for(;!be;){let g=await o.waitForSelector("button.btn.btn-primary.btn-lg, button.btn.btn-primary.sm\\:btn-xl");if(!g){let S=Array.from(document.querySelectorAll("button.btn-primary"));g=S.length?S[S.length-1]:null}g&&g.click(),await o.sleep(500)}})();let w=await ct;await o.sleep(300),t(w)})();await Promise.race([i,n])}catch(n){console.error("Auto-CAPTCHA process failed:",n),a(n)}})}async function aa(){var Wa,_a;await sn();let t=document.getElementById("wplace-image-bot-container"),a=document.getElementById("wplace-stats-container"),n=document.getElementById("wplace-settings-container"),i=document.querySelector(".resize-container"),r=document.querySelector(".resize-overlay");t&&t.remove(),a&&a.remove(),n&&n.remove(),i&&i.remove(),r&&r.remove(),ka(),await tn();let s=ya();Vt();function c(b,E={}){if(Array.from(document.head.querySelectorAll("link")).some(K=>K.href===b))return;let L=document.createElement("link");L.rel="stylesheet",L.href=b;for(let[K,Y]of Object.entries(E))L.setAttribute(K,Y);document.head.appendChild(L)}c("https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css"),s.fontFamily.includes("Press Start 2P")&&c("https://fonts.googleapis.com/css2?family=Press+Start+2P&display=swap");let p=document.createElement("style");p.textContent=Ka,p.setAttribute("data-wplace-theme","true"),document.head.appendChild(p);let d=localStorage.getItem("dev-mode")==="true"?`
      ...
      ">
        Build: 2025-09-04 16:23:57 | Target: bookmarklet <br />
        Commit: e93dc06 | Branch: dx-improvment <br />
        Git: <span style="color: #dc3545;">dirty</span> | Env: <span style="color: #fd7e14;">development</span> <br />
        Last: Merge upstream/dev into dx-improvment branch <br />
        Node: v18.19.1
      </div>
    `:"",l=document.createElement("div");l.id="wplace-image-bot-container",l.innerHTML=`
      ${d}
                ...
                <div class="wplace-slider-container">
                    ...
                    <div class="wplace-cooldown-controls">
                        <div class="wplace-cooldown-input-group">
                            ...
                            <input type="number" id="cooldownInput" class="wplace-cooldown-input" min="1" max="999" value="${e.cooldownChargeThreshold}">
    ...
    `;let g=document.createElement("div");g.id="wplace-settings-container";let S=s.primary?`linear-gradient(135deg, ${s.primary} 0%, ${s.secondary||s.primary} 100%)`:"linear-gradient(135deg, #667eea 0%, #764ba2 100%)";g.className="wplace-settings-container-base wplace-settings-container-themed",g.style.background=S,g.style.setProperty("--theme-text",s.text||"white"),g.style.setProperty("--theme-font-family",s.fontFamily||"'Segoe UI', Tahoma, Geneva, Verdana, sans-serif"),g.style.setProperty("--theme-box-shadow",s.boxShadow||"0 20px 40px rgba(0,0,0,0.3), 0 0 0 1px rgba(255,255,255,0.1)"),g.style.setProperty("--theme-backdrop-filter",s.backdropFilter||"blur(10px)"),g.style.setProperty("--theme-highlight",s.highlight||"#48dbfb"),(Wa=s.animations)!=null&&Wa.glow&&(g.classList.add("glow-effect"),g.style.setProperty("--theme-glow-color",s.highlight||s.neon||"#00ffff")),g.innerHTML=`
      ...
      <div class="wplace-settings-content">
        ...
        <div class="wplace-settings-section">
          ...
          ">
              ...
              <label for="enableBlueMarbleToggle" class="wplace-settings-toggle">
                  <div>
                      <span class="wplace-settings-toggle-title" style="color: ${s.text||"white"};">Blue Marble Effect</span>
                      <p class="wplace-settings-toggle-description" style="color: ${s.text?`${s.text}BB`:"rgba(255,255,255,0.7)"};">Renders a dithered "shredded" overlay.</p>
                  </div>
          ...
          <div id="pixelFilterControls" class="wplace-settings-section-wrapper wplace-pixel-filter-controls">
            ...
            <label class="wplace-settings-toggle">
              <div>
                ...
                <p class="wplace-settings-toggle-description" style="color: ${s.text?`${s.text}BB`:"rgba(255,255,255,0.7)"};">
            ...
            <label class="wplace-settings-toggle">
              <div>
                <span class="wplace-settings-toggle-title" style="color: ${s.text||"white"};">${o.t("paintUnavailablePixels")}</span>
                <p class="wplace-settings-toggle-description" style="color: ${s.text?`${s.text}BB`:"rgba(255,255,255,0.7)"};">${o.t("paintUnavailablePixelsDescription")}</p>
              </div>
        ...
        <div class="wplace-settings-section">
          ...
          <div id="normalBatchControls" class="wplace-batch-controls wplace-normal-batch-controls">
            <div class="wplace-speed-slider-container">
              <input type="range" id="speedSlider" min="${f.PAINTING_SPEED.MIN}" max="${f.PAINTING_SPEED.MAX}" value="${f.PAINTING_SPEED.DEFAULT}" class="wplace-speed-slider">
              <div class="wplace-speed-labels">
                <span class="wplace-speed-min">\u{1F422} ${f.PAINTING_SPEED.MIN}</span>
                <span class="wplace-speed-max">${f.PAINTING_SPEED.MAX} \u{1F407}</span>
              </div>
              <div class="wplace-speed-controls">
                <div class="wplace-speed-input-group">
                  ...
                  <input type="number" id="speedInput" class="wplace-speed-input" min="${f.PAINTING_SPEED.MIN}" max="${f.PAINTING_SPEED.MAX}" value="${f.PAINTING_SPEED.DEFAULT}">
          ...
          <div id="randomBatchControls" class="wplace-batch-controls wplace-random-batch-controls">
            <div class="wplace-random-batch-grid">
              <div>
                ...
                <input type="number" id="randomBatchMin" min="1" max="1000" value="${f.RANDOM_BATCH_RANGE.MIN}" class="wplace-settings-number-input">
              </div>
              <div>
                <label class="wplace-random-batch-label">
                ...
                <input type="number" id="randomBatchMax" min="1" max="1000" value="${f.RANDOM_BATCH_RANGE.MAX}" class="wplace-settings-number-input">
              </div>
            </div>
          ...
          <label class="wplace-speed-control-toggle">
            <input type="checkbox" id="enableSpeedToggle" ${f.PAINTING_SPEED_ENABLED?"checked":""} class="wplace-speed-checkbox"/>
        ...
        <div class="wplace-settings-section">
          ...
          <div id="snakeControls" class="wplace-snake-pattern-controls wplace-settings-section-wrapper">
            <label class="wplace-settings-toggle">
              <div>
                <span class="wplace-settings-toggle-title" style="color: ${s.text||"white"};">Snake Pattern</span>
                <p class="wplace-settings-toggle-description" style="color: ${s.text?`${s.text}BB`:"rgba(255,255,255,0.7)"};">Alternate direction for each row/column (zigzag pattern)</p>
              </div>
        ...
        <div class="wplace-settings-section">
          ...
          <div class="wplace-settings-section-wrapper">
            <select id="themeSelect" class="wplace-settings-select">
              ${Object.keys(f.THEMES).map(b=>`<option value="${b}" ${f.currentTheme===b?"selected":""} class="wplace-settings-option">${b}</option>`).join("")}
            </select>
          </div>
        </div>
    ...
    `;let u=document.createElement("div");u.className="resize-container",u.innerHTML=`
      <h3 class="resize-dialog-title">${o.t("resizeImage")}</h3>
    ...
    `;let v=document.createElement("div");v.className="resize-overlay",document.body.appendChild(l),document.body.appendChild(v),document.body.appendChild(u),document.body.appendChild(w),document.body.appendChild(g),l.style.display="block";let x=l.querySelector("#uploadBtn"),T=l.querySelector("#resizeBtn"),P=l.querySelector("#selectPosBtn"),M=l.querySelector("#startBtn"),R=l.querySelector("#stopBtn"),W=l.querySelector("#saveBtn"),Z=l.querySelector("#loadBtn"),ve=l.querySelector("#saveToFileBtn"),Ie=l.querySelector("#loadFromFileBtn");l.querySelectorAll(".wplace-section-title").forEach(b=>{if(!b.querySelector("i.arrow")){let E=document.createElement("i");E.className="fas fa-chevron-down arrow",b.appendChild(E)}b.addEventListener("click",()=>{b.parentElement.classList.toggle("collapsed")})}),Z&&(Z.disabled=!e.initialSetupComplete,Z.title=e.initialSetupComplete?"":"\u{1F504} Waiting for initial setup to complete..."),Ie&&(Ie.disabled=!e.initialSetupComplete,Ie.title=e.initialSetupComplete?"":"\u{1F504} Waiting for initial setup to complete..."),x&&(x.disabled=!e.initialSetupComplete,x.title=e.initialSetupComplete?"":"\u{1F504} Waiting for initial setup to complete...");let j=l.querySelector("#minimizeBtn"),de=l.querySelector("#compactBtn"),se=l.querySelector("#statsBtn"),Ce=l.querySelector("#toggleOverlayBtn"),je=l.querySelector("#statusText"),Mt=l.querySelector("#progressBar"),ht=w.querySelector("#statsArea"),it=l.querySelector(".wplace-content"),dt=w.querySelector("#closeStatsBtn"),He=w.querySelector("#refreshChargesBtn"),Ue=l.querySelector("#cooldownSlider"),Re=l.querySelector("#cooldownInput"),ut=l.querySelector("#cooldownDecrease"),ot=l.querySelector("#cooldownIncrease"),$n=l.querySelector("#cooldownValue");(!x||!P||!M||!R)&&console.error("Some UI elements not found:",{uploadBtn:!!x,selectPosBtn:!!P,startBtn:!!M,stopBtn:!!R});let Wn=l.querySelector(".wplace-header");zt(l);function zt(b){let E=0,B=0,L=0,K=0,Y=!1,ge=b.querySelector(".wplace-header")||b.querySelector(".wplace-settings-header");if(!ge){console.warn("No draggable header found for element:",b);return}ge.onmousedown=he;function he(ae){if(ae.target.closest(".wplace-header-btn")||ae.target.closest("button"))return;ae.preventDefault(),Y=!0;let q=b.getBoundingClientRect();b.style.transform="none",b.style.top=q.top+"px",b.style.left=q.left+"px",L=ae.clientX,K=ae.clientY,b.classList.add("wplace-dragging"),document.onmouseup=le,document.onmousemove=oe,document.body.style.userSelect="none"}function oe(ae){if(!Y)return;ae.preventDefault(),E=L-ae.clientX,B=K-ae.clientY,L=ae.clientX,K=ae.clientY;let q=b.offsetTop-B,ue=b.offsetLeft-E,ye=b.getBoundingClientRect(),ze=window.innerHeight-ye.height,pe=window.innerWidth-ye.width;q=Math.max(0,Math.min(q,ze)),ue=Math.max(0,Math.min(ue,pe)),b.style.top=q+"px",b.style.left=ue+"px"}function le(){Y=!1,b.classList.remove("wplace-dragging"),document.onmouseup=null,document.onmousemove=null,document.body.style.userSelect=""}}zt(w),zt(l),se&&dt&&(se.addEventListener("click",()=>{w.style.display!=="none"?(w.style.display="none",se.innerHTML='<i class="fas fa-chart-bar"></i>',se.title=o.t("showStats")):(w.style.display="block",se.innerHTML='<i class="fas fa-chart-line"></i>',se.title=o.t("hideStats"))}),dt.addEventListener("click",()=>{w.style.display="none",se.innerHTML='<i class="fas fa-chart-bar"></i>',se.title=o.t("showStats")}),He&&He.addEventListener("click",async()=>{He.innerHTML='<i class="fas fa-spinner fa-spin"></i>',He.disabled=!0;try{await _e(!0)}catch(b){console.error("Error refreshing charges:",b)}finally{He.innerHTML='<i class="fas fa-sync"></i>',He.disabled=!1}})),w&&se&&(se.innerHTML='<i class="fas fa-chart-bar"></i>',se.title=o.t("showStats"));let Ma=l.querySelector("#settingsBtn"),ia=g.querySelector("#closeSettingsBtn"),za=g.querySelector("#applySettingsBtn");if(Ma&&ia&&za){Ma.addEventListener("click",()=>{g.classList.contains("show")?(g.style.animation="settings-fade-out 0.3s ease-out forwards",g.classList.remove("show"),setTimeout(()=>{g.style.animation=""},300)):(g.style.top="50%",g.style.left="50%",g.style.transform="translate(-50%, -50%)",g.classList.add("show"),g.style.animation="settings-slide-in 0.4s ease-out")}),ia.addEventListener("click",()=>{g.style.animation="settings-fade-out 0.3s ease-out forwards",g.classList.remove("show"),setTimeout(()=>{g.style.animation="",g.style.top="50%",g.style.left="50%",g.style.transform="translate(-50%, -50%)"},300)}),za.addEventListener("click",()=>{let H=document.getElementById("colorAlgorithmSelect");H&&(e.colorMatchingAlgorithm=H.value);let N=document.getElementById("enableChromaPenaltyToggle");N&&(e.enableChromaPenalty=N.checked);let Ye=document.getElementById("chromaPenaltyWeightSlider");Ye&&(e.chromaPenaltyWeight=parseFloat(Ye.value)||.15);let Je=document.getElementById("transparencyThresholdInput");if(Je){let Te=parseInt(Je.value,10);!isNaN(Te)&&Te>=0&&Te<=255&&(e.customTransparencyThreshold=Te)}let Dt=document.getElementById("whiteThresholdInput");if(Dt){let Te=parseInt(Dt.value,10);!isNaN(Te)&&Te>=200&&Te<=255&&(e.customWhiteThreshold=Te)}f.TRANSPARENCY_THRESHOLD=e.customTransparencyThreshold,f.WHITE_THRESHOLD=e.customWhiteThreshold;let Lt=document.getElementById("notifEnabledToggle"),ke=document.getElementById("notifOnChargesToggle"),Se=document.getElementById("notifOnlyUnfocusedToggle"),Bt=document.getElementById("notifIntervalInput");if(Lt&&(e.notificationsEnabled=!!Lt.checked),ke&&(e.notifyOnChargesReached=!!ke.checked),Se&&(e.notifyOnlyWhenUnfocused=!!Se.checked),Bt){let Te=parseInt(Bt.value,10);!isNaN(Te)&&Te>=1&&Te<=60&&(e.notificationIntervalMinutes=Te)}G(),o.showAlert(o.t("settingsSaved"),"success"),ia.click(),Ve.syncFromState()}),zt(g);let b=g.querySelector("#tokenSourceSelect");b&&b.addEventListener("change",H=>{e.tokenSource=H.target.value,G(),console.log(`\u{1F511} Token source changed to: ${e.tokenSource}`);let N={generator:"Automatic Generator",hybrid:"Generator + Auto Fallback",manual:"Manual Pixel Placement"};o.showAlert(o.t("tokenSourceSet",{source:N[e.tokenSource]}),"success")});let E=g.querySelector("#batchModeSelect"),B=g.querySelector("#normalBatchControls"),L=g.querySelector("#randomBatchControls"),K=g.querySelector("#randomBatchMin"),Y=g.querySelector("#randomBatchMax");E&&E.addEventListener("change",H=>{e.batchMode=H.target.value,B&&L&&(H.target.value==="random"?(B.style.display="none",L.style.display="block"):(B.style.display="block",L.style.display="none")),G(),console.log(`\u{1F4E6} Batch mode changed to: ${e.batchMode}`),o.showAlert(o.t("batchModeSet",{mode:e.batchMode==="random"?o.t("randomRange"):o.t("normalFixedSize")}),"success")}),K&&K.addEventListener("input",H=>{let N=parseInt(H.target.value);N>=1&&N<=1e3&&(e.randomBatchMin=N,Y&&N>e.randomBatchMax&&(e.randomBatchMax=N,Y.value=N),G())}),Y&&Y.addEventListener("input",H=>{let N=parseInt(H.target.value);N>=1&&N<=1e3&&(e.randomBatchMax=N,K&&N<e.randomBatchMin&&(e.randomBatchMin=N,K.value=N),G())});let ge=g.querySelector("#languageSelect");ge&&ge.addEventListener("change",async H=>{let N=H.target.value;e.language=N,localStorage.setItem("wplace_language",N),await Kt(N),setTimeout(()=>{g.style.display="none",aa()},100)});let he=g.querySelector("#themeSelect");he&&he.addEventListener("change",H=>{let N=H.target.value;Za(N)});let oe=g.querySelector("#overlayOpacitySlider"),le=g.querySelector("#overlayOpacityValue"),ae=g.querySelector("#enableBlueMarbleToggle"),q=g.querySelector("#settingsPaintWhiteToggle"),ue=g.querySelector("#settingsPaintTransparentToggle");oe&&le&&oe.addEventListener("input",H=>{let N=parseFloat(H.target.value);e.overlayOpacity=N,le.textContent=`${Math.round(N*100)}%`}),q&&(q.checked=e.paintWhitePixels,q.addEventListener("change",H=>{e.paintWhitePixels=H.target.checked,G(),console.log(`\u{1F3A8} Paint white pixels: ${e.paintWhitePixels?"ON":"OFF"}`);let N=e.paintWhitePixels?"White pixels in the template will be painted":"White pixels will be skipped";o.showAlert(N,"success")})),ue&&(ue.checked=e.paintTransparentPixels,ue.addEventListener("change",H=>{e.paintTransparentPixels=H.target.checked,G(),console.log(`\u{1F3A8} Paint transparent pixels: ${e.paintTransparentPixels?"ON":"OFF"}`);let N=e.paintTransparentPixels?"Transparent pixels in the template will be painted with the closest available color":"Transparent pixels will be skipped";o.showAlert(N,"success")}));let ye=g.querySelector("#speedSlider"),ze=g.querySelector("#speedInput"),pe=g.querySelector("#speedDecrease"),D=g.querySelector("#speedIncrease");if(ye&&ze){let H=(N,Ye)=>{let Je=Math.max(f.PAINTING_SPEED.MIN,Math.min(f.PAINTING_SPEED.MAX,parseInt(N)));e.paintingSpeed=Je,Ye!=="slider"&&(ye.value=Je),Ye!=="input"&&(ze.value=Je),G()};ye.addEventListener("input",N=>{H(N.target.value,"slider")}),ze.addEventListener("input",N=>{H(N.target.value,"input")}),pe&&o.addHoldToRepeatListener(pe,()=>{H(parseInt(ze.value)-1,"button")}),D&&o.addHoldToRepeatListener(D,()=>{H(parseInt(ze.value)+1,"button")})}ae&&ae.addEventListener("click",async()=>{e.blueMarbleEnabled=ae.checked,e.imageLoaded&&Me.imageBitmap&&(o.showAlert(o.t("reprocessingOverlay"),"info"),await Me.processImageIntoChunks(),o.showAlert(o.t("overlayUpdated"),"success"))});let J=g.querySelector("#notifRequestPermBtn"),Ge=g.querySelector("#notifTestBtn");J&&J.addEventListener("click",async()=>{await Ve.requestPermission()==="granted"?o.showAlert(o.t("notificationsEnabled"),"success"):o.showAlert(o.t("notificationsPermissionDenied"),"warning")}),Ge&&Ge.addEventListener("click",()=>{Ve.notify(o.t("testNotificationTitle"),o.t("testNotificationMessage"),"wplace-notify-test",!0)})}let Le=u.querySelector("#widthSlider"),Be=u.querySelector("#heightSlider"),Aa=u.querySelector("#widthValue"),Da=u.querySelector("#heightValue"),La=u.querySelector("#keepAspect"),Ba=u.querySelector("#paintWhiteToggle"),Oa=u.querySelector("#paintTransparentToggle"),qe=u.querySelector("#zoomSlider"),At=u.querySelector("#zoomValue"),mt=u.querySelector("#zoomInBtn"),wt=u.querySelector("#zoomOutBtn"),Ra=u.querySelector("#zoomFitBtn"),Na=u.querySelector("#zoomActualBtn"),ft=u.querySelector("#panModeBtn"),me=u.querySelector("#resizePanStage"),bt=u.querySelector("#resizeCanvasStack"),V=u.querySelector("#resizeCanvas"),xe=u.querySelector("#maskCanvas"),rt=V.getContext("2d"),Ke=xe.getContext("2d"),bn=u.querySelector("#confirmResize"),vn=u.querySelector("#cancelResize"),xn=u.querySelector("#downloadPreviewBtn"),_n=u.querySelector("#clearIgnoredBtn"),oa=g.querySelector("#coordinateModeSelect"),ra=g.querySelector("#coordinateDirectionSelect"),sa=g.querySelector("#coordinateSnakeToggle"),yn=g.querySelector("#directionControls"),kn=g.querySelector("#snakeControls"),Sn=g.querySelector("#blockControls"),la=g.querySelector("#blockWidthInput"),ca=g.querySelector("#blockHeightInput"),pa=g.querySelector("#paintUnavailablePixelsToggle");pa&&(pa.checked=e.paintUnavailablePixels,pa.addEventListener("change",b=>{e.paintUnavailablePixels=b.target.checked,G(),console.log(`\u{1F3A8} Paint unavailable colors: ${e.paintUnavailablePixels?"ON":"OFF"}`);let E=e.paintUnavailablePixels?"Unavailable template colors will be painted with the closest available color":"Unavailable template colors will be skipped";o.showAlert(E,"success")})),oa&&(oa.value=e.coordinateMode,oa.addEventListener("change",b=>{e.coordinateMode=b.target.value,o.updateCoordinateUI({mode:e.coordinateMode,directionControls:yn,snakeControls:kn,blockControls:Sn}),G(),console.log(`\u{1F504} Coordinate mode changed to: ${e.coordinateMode}`),o.showAlert(`Coordinate mode set to: ${e.coordinateMode}`,"success")})),ra&&(ra.value=e.coordinateDirection,ra.addEventListener("change",b=>{e.coordinateDirection=b.target.value,G(),console.log(`\u{1F9ED} Coordinate direction changed to: ${e.coordinateDirection}`),o.showAlert(`Coordinate direction set to: ${e.coordinateDirection}`,"success")})),sa&&(sa.checked=e.coordinateSnake,sa.addEventListener("change",b=>{e.coordinateSnake=b.target.checked,G(),console.log(`\u{1F40D} Snake pattern ${e.coordinateSnake?"enabled":"disabled"}`),o.showAlert(`Snake pattern ${e.coordinateSnake?"enabled":"disabled"}`,"success")})),la&&(la.value=e.blockWidth,la.addEventListener("input",b=>{let E=parseInt(b.target.value);E>=1&&E<=50&&(e.blockWidth=E,G())})),ca&&(ca.value=e.blockHeight,ca.addEventListener("change",b=>{let E=parseInt(b.target.value);E>=1&&E<=50&&(e.blockHeight=E,G())})),de&&de.addEventListener("click",()=>{l.classList.toggle("wplace-compact"),l.classList.contains("wplace-compact")?(de.innerHTML='<i class="fas fa-expand"></i>',de.title=o.t("expandMode")):(de.innerHTML='<i class="fas fa-compress"></i>',de.title=o.t("compactMode"))}),j&&j.addEventListener("click",()=>{e.minimized=!e.minimized,e.minimized?(l.classList.add("wplace-minimized"),it.classList.add("wplace-hidden"),j.innerHTML='<i class="fas fa-expand"></i>',j.title=o.t("restore")):(l.classList.remove("wplace-minimized"),it.classList.remove("wplace-hidden"),j.innerHTML='<i class="fas fa-minus"></i>',j.title=o.t("minimize")),G()}),Ce&&Ce.addEventListener("click",()=>{let b=Me.toggle();Ce.classList.toggle("active",b),Ce.setAttribute("aria-pressed",b?"true":"false"),o.showAlert(b?o.t("overlayEnabled"):o.t("overlayDisabled"),"info")}),e.minimized?(l.classList.add("wplace-minimized"),it.classList.add("wplace-hidden"),j&&(j.innerHTML='<i class="fas fa-expand"></i>',j.title=o.t("restore"))):(l.classList.remove("wplace-minimized"),it.classList.remove("wplace-hidden"),j&&(j.innerHTML='<i class="fas fa-minus"></i>',j.title=o.t("minimize"))),W&&W.addEventListener("click",()=>{if(!e.imageLoaded){o.showAlert(o.t("missingRequirements"),"error");return}o.saveProgress()?($("autoSaved","success"),o.showAlert(o.t("autoSaved"),"success")):o.showAlert(o.t("errorSavingProgress"),"error")}),Z&&Z.addEventListener("click",()=>{if(!e.initialSetupComplete){o.showAlert(o.t("pleaseWaitInitialSetup"),"warning");return}let b=o.loadProgress();if(!b){$("noSavedData","warning"),o.showAlert(o.t("noSavedData"),"warning");return}confirm(`${o.t("savedDataFound")}

Saved: ${new Date(b.timestamp).toLocaleString()}
Progress: ${b.state.paintedPixels}/${b.state.totalPixels} pixels`)&&(o.restoreProgress(b)?($("dataLoaded","success"),o.showAlert(o.t("dataLoaded"),"success"),gt(),_e(),o.restoreOverlayFromData().catch(L=>{console.error("Failed to restore overlay from localStorage:",L)}),e.colorsChecked?(x.disabled=!1,P.disabled=!1):x.disabled=!1,e.imageLoaded&&e.startPosition&&e.region&&e.colorsChecked&&(M.disabled=!1)):o.showAlert(o.t("errorLoadingProgress"),"error"))}),ve&&ve.addEventListener("click",()=>{o.saveProgressToFile()?($("fileSaved","success"),o.showAlert(o.t("fileSaved"),"success")):o.showAlert(o.t("fileError"),"error")}),Ie&&Ie.addEventListener("click",async()=>{if(!e.initialSetupComplete){o.showAlert(o.t("pleaseWaitFileSetup"),"warning");return}try{await o.loadProgressFromFile()&&($("fileLoaded","success"),o.showAlert(o.t("fileLoaded"),"success"),gt(),await _e(),await o.restoreOverlayFromData().catch(E=>{console.error("Failed to restore overlay from file:",E)}),e.colorsChecked?(x.disabled=!1,P.disabled=!1,T.disabled=!1):x.disabled=!1,e.imageLoaded&&e.startPosition&&e.region&&e.colorsChecked&&(M.disabled=!1))}catch(b){b.message==="Invalid JSON file"?o.showAlert(o.t("invalidFileFormat"),"error"):o.showAlert(o.t("fileError"),"error")}}),$=(b,E="default",B={},L=!1)=>{let K=o.t(b,B);je.textContent=K,je.className=`wplace-status status-${E}`,L||(je.style.animation="none",je.offsetWidth,je.style.animation="slide-in 0.3s ease-out")};function Fa(b){let E=document.getElementById("wplace-stat-charges-value"),B=document.getElementById("wplace-stat-fullcharge-value");if(!B&&!E)return;if(!e.fullChargeData){B.textContent="--:--:--";return}let{current:L,max:K,cooldownMs:Y,startTime:ge,spentSinceShot:he}=e.fullChargeData,le=(Date.now()-ge)/Y,ae=L+le-he,q=Math.min(ae,K),ue;q-Math.floor(q)>=.95?ue=Math.ceil(q):ue=Math.floor(q),e.displayCharges=Math.max(0,ue),e.preciseCurrentCharges=q;let ze=na(q,K,e.cooldown,b),pe=o.msToTimeText(ze);E&&(E.innerHTML=`${e.displayCharges} / ${e.maxCharges}`),e.displayCharges<e.cooldownChargeThreshold&&!e.stopFlag&&e.running&&pn(b),B&&(e.displayCharges>=K?B.innerHTML='<span style="color:#10b981;">FULL</span>':B.innerHTML=`
            <span style="color:#f59e0b;">${pe}</span>
          `)}_e=async(b=!1)=>{var ze,pe;let E=b,B=!((ze=e.fullChargeData)!=null&&ze.startTime),L=6e4,Y=L+Math.random()*(9e4-L),he=Date.now()-(((pe=e.fullChargeData)==null?void 0:pe.startTime)||0)>=Y;if(E||B||he){let{charges:D,max:J,cooldown:Ge}=await Ia.getCharges();e.displayCharges=Math.floor(D),e.preciseCurrentCharges=D,e.cooldown=Ge,e.maxCharges=Math.floor(J)>1?Math.floor(J):e.maxCharges,e.fullChargeData={current:D,max:J,cooldownMs:Ge,startTime:Date.now(),spentSinceShot:0},Ve.maybeNotifyChargesReached()}e.fullChargeInterval&&(clearInterval(e.fullChargeInterval),e.fullChargeInterval=null);let le=1e3;e.fullChargeInterval=setInterval(()=>Fa(le),le),Ue&&Ue.max!==e.maxCharges&&(Ue.max=e.maxCharges),Re&&Re.max!==e.maxCharges&&(Re.max=e.maxCharges);let ae="";if(e.imageLoaded){let D=e.totalPixels>0?Math.round(e.paintedPixels/e.totalPixels*100):0,J=e.totalPixels-e.paintedPixels;e.estimatedTime=o.calculateEstimatedTime(J,e.displayCharges,e.cooldown),Mt.style.width=`${D}%`,ae=`
          <div class="wplace-stat-item">
            <div class="wplace-stat-label"><i class="fas fa-image"></i> ${o.t("progress")}</div>
            <div class="wplace-stat-value">${D}%</div>
          </div>
          <div class="wplace-stat-item">
        ...
        `}let q="";e.availableColors=e.availableColors.filter(D=>D.name!=="Unknown CoIor NaN"&&D.id!==null);let ue=o.extractAvailableColors(),ye=Array.isArray(ue)?ue.length:0;if(ye===0&&b)o.showAlert(o.t("noColorsFound"),"warning");else if(ye>0&&e.availableColors.length<ye){let D=e.availableColors.length;o.showAlert(o.t("colorsUpdated",{oldCount:D,newCount:ye,diffCount:ye-D}),"success"),e.availableColors=ue}e.colorsChecked&&(q=e.availableColors.map(D=>`<div class="wplace-stat-color-swatch" style="background-color: ${`rgb(${D.rgb.join(",")})`};" title="${o.t("colorTooltip",{id:D.id,rgb:D.rgb.join(", ")})}"></div>`).join("")),ht.innerHTML=`
            ${ae}
            <div class="wplace-stat-item">
            ...
            `:""}
        `,Fa(le)},gt=()=>{let b=e.imageLoaded&&e.imageData;W.disabled=!b,ve.disabled=!b},gt();function Tn(b){var ja;let E=b,B,L;if((ja=e.originalImage)!=null&&ja.dataUrl)E=new ea(e.originalImage.dataUrl),B=e.originalImage.width,L=e.originalImage.height;else{let m=b.getDimensions();B=m.width,L=m.height}let K=B/L,Y=e.resizeSettings;Le.max=B*2,Be.max=L*2;let ge=B,he=L;Y&&Number.isFinite(Y.width)&&Number.isFinite(Y.height)&&Y.width>0&&Y.height>0&&(ge=Y.width,he=Y.height),ge=Math.max(parseInt(Le.min,10)||10,Math.min(ge,parseInt(Le.max,10))),he=Math.max(parseInt(Be.min,10)||10,Math.min(he,parseInt(Be.max,10))),Le.value=ge,Be.value=he,Aa.textContent=ge,Da.textContent=he,qe.value=1,At&&(At.textContent="100%"),Ba.checked=e.paintWhitePixels,Oa.checked=e.paintTransparentPixels;let oe=null,le=0,ae=!1,q=1,ue=null,ye=null,ze=m=>((!ue||ue.length!==m*3)&&(ue=new Float32Array(m*3)),(!ye||ye.length!==m)&&(ye=new Uint8Array(m)),{work:ue,eligible:ye}),pe=null,D=null,J=null,Ge=()=>{J={minX:1/0,minY:1/0,maxX:-1,maxY:-1}},H=(m,y)=>{J||Ge(),m<J.minX&&(J.minX=m),y<J.minY&&(J.minY=y),m>J.maxX&&(J.maxX=m),y>J.maxY&&(J.maxY=y)},N=()=>{if(!J||J.maxX<J.minX||J.maxY<J.minY)return;let m=Math.max(0,J.minX),y=Math.max(0,J.minY),k=Math.min(xe.width-m,J.maxX-m+1),C=Math.min(xe.height-y,J.maxY-y+1);k>0&&C>0&&Ke.putImageData(pe,0,0,m,y,k,C),Ge()},Ye=(m,y,k=!1)=>{if((!pe||pe.width!==m||pe.height!==y)&&(pe=Ke.createImageData(m,y),D=pe.data,k=!0),k){let C=e.resizeIgnoreMask,I=D;if(I.fill(0),C){for(let z=0;z<C.length;z++)if(C[z]){let ee=z*4;I[ee]=255,I[ee+1]=0,I[ee+2]=0,I[ee+3]=150}}Ke.putImageData(pe,0,0),Ge()}},Je=(m,y)=>{(!e.resizeIgnoreMask||e.resizeIgnoreMask.length!==m*y)&&(e.resizeIgnoreMask=new Uint8Array(m*y)),V.width=m,V.height=y,xe.width=m,xe.height=y,Ke.clearRect(0,0,xe.width,xe.height),Ye(m,y,!0)};fe=async()=>{let m=++le,y=parseInt(Le.value,10),k=parseInt(Be.value,10);if(q=parseFloat(qe.value),Aa.textContent=y,Da.textContent=k,Je(y,k),bt.style.width=y+"px",bt.style.height=k+"px",rt.imageSmoothingEnabled=!1,!e.availableColors||e.availableColors.length===0){E!==b&&(!E.img||!E.canvas)&&await E.load(),rt.clearRect(0,0,y,k),rt.drawImage(E.img,0,0,y,k),Ke.clearRect(0,0,xe.width,xe.height),pe&&Ke.putImageData(pe,0,0),da();return}E!==b&&(!E.img||!E.canvas)&&await E.load(),rt.clearRect(0,0,y,k),rt.drawImage(E.img,0,0,y,k);let C=rt.getImageData(0,0,y,k),I=C.data,z=e.customTransparencyThreshold||f.TRANSPARENCY_THRESHOLD,ee=()=>{let A=y,_=k,re=A*_,{work:O,eligible:X}=ze(re);for(let U=0;U<_;U++)for(let ce=0;ce<A;ce++){let te=U*A+ce,Pe=te*4,Ae=I[Pe],Q=I[Pe+1],ne=I[Pe+2],ie=I[Pe+3],we=(e.paintTransparentPixels||ie>=z)&&(e.paintWhitePixels||!o.isWhitePixel(Ae,Q,ne));X[te]=we?1:0,O[te*3]=Ae,O[te*3+1]=Q,O[te*3+2]=ne,we||(I[Pe+3]=0)}let F=(U,ce,te,Pe,Ae,Q)=>{if(U<0||U>=A||ce<0||ce>=_)return;let ne=ce*A+U;if(!X[ne])return;let ie=ne*3;O[ie]=Math.min(255,Math.max(0,O[ie]+te*Q)),O[ie+1]=Math.min(255,Math.max(0,O[ie+1]+Pe*Q)),O[ie+2]=Math.min(255,Math.max(0,O[ie+2]+Ae*Q))};for(let U=0;U<_;U++)for(let ce=0;ce<A;ce++){let te=U*A+ce;if(!X[te])continue;let Pe=te*3,Ae=O[Pe],Q=O[Pe+1],ne=O[Pe+2],[ie,we,Ne]=o.findClosestPaletteColor(Ae,Q,ne,e.activeColorPalette),De=te*4;I[De]=ie,I[De+1]=we,I[De+2]=Ne,I[De+3]=255;let Oe=Ae-ie,Ee=Q-we,at=ne-Ne;F(ce+1,U,Oe,Ee,at,7/16),F(ce-1,U+1,Oe,Ee,at,3/16),F(ce,U+1,Oe,Ee,at,5/16),F(ce+1,U+1,Oe,Ee,at,1/16)}};if(e.ditheringEnabled&&!ae)ee();else for(let A=0;A<I.length;A+=4){let _=I[A],re=I[A+1],O=I[A+2],X=I[A+3];if(!e.paintTransparentPixels&&X<z||!e.paintWhitePixels&&o.isWhitePixel(_,re,O)){I[A+3]=0;continue}let[F,U,ce]=o.findClosestPaletteColor(_,re,O,e.activeColorPalette);I[A]=F,I[A+1]=U,I[A+2]=ce,I[A+3]=255}m===le&&(rt.putImageData(C,0,0),Ke.clearRect(0,0,xe.width,xe.height),pe&&Ke.putImageData(pe,0,0),da())};let Dt=()=>{La.checked&&(Be.value=Math.round(parseInt(Le.value,10)/K)),fe();let m=parseInt(Le.value,10),y=parseInt(Be.value,10);e.resizeSettings={baseWidth:B,baseHeight:L,width:m,height:y},G();let k=typeof Ze=="function"?Ze():1;!isNaN(k)&&isFinite(k)&&$e(k)},Lt=()=>{La.checked&&(Le.value=Math.round(parseInt(Be.value,10)*K)),fe();let m=parseInt(Le.value,10),y=parseInt(Be.value,10);e.resizeSettings={baseWidth:B,baseHeight:L,width:m,height:y},G();let k=typeof Ze=="function"?Ze():1;!isNaN(k)&&isFinite(k)&&$e(k)};Ba.onchange=m=>{e.paintWhitePixels=m.target.checked,fe(),G()},Oa.onchange=m=>{e.paintTransparentPixels=m.target.checked,fe(),G()};let ke=0,Se=0,Bt=()=>{let m=(me==null?void 0:me.getBoundingClientRect())||{width:0,height:0},y=(V.width||1)*q,k=(V.height||1)*q;if(y<=m.width)ke=Math.floor((m.width-y)/2);else{let C=m.width-y;ke=Math.min(0,Math.max(C,ke))}if(k<=m.height)Se=Math.floor((m.height-k)/2);else{let C=m.height-k;Se=Math.min(0,Math.max(C,Se))}},Te=0,Ot=()=>{Te||(Te=requestAnimationFrame(()=>{Bt(),bt.style.transform=`translate3d(${Math.round(ke)}px, ${Math.round(Se)}px, 0) scale(${q})`,Te=0}))},da=()=>{let m=V.width||1,y=V.height||1;V.style.width=m+"px",V.style.height=y+"px",xe.style.width=m+"px",xe.style.height=y+"px",bt.style.width=m+"px",bt.style.height=y+"px",Ot()},$e=m=>{q=Math.max(.05,Math.min(20,m||1)),qe.value=q,da(),At&&(At.textContent=`${Math.round(q*100)}%`)};qe.addEventListener("input",()=>{$e(parseFloat(qe.value))}),mt&&mt.addEventListener("click",()=>$e(parseFloat(qe.value)+.1)),wt&&wt.addEventListener("click",()=>$e(parseFloat(qe.value)-.1));let Ze=()=>{let m=me==null?void 0:me.getBoundingClientRect();if(!m)return 1;let y=V.width||1,k=V.height||1,C=10,I=(m.width-C)/y,z=(m.height-C)/k;return Math.max(.05,Math.min(20,Math.min(I,z)))};Ra&&Ra.addEventListener("click",()=>{$e(Ze()),vt()}),Na&&Na.addEventListener("click",()=>{$e(1),vt()});let vt=()=>{if(!me)return;let m=me.getBoundingClientRect(),y=(V.width||1)*q,k=(V.height||1)*q;ke=Math.floor((m.width-y)/2),Se=Math.floor((m.height-k)/2),Ot()},Qe=!1,Rt=0,Nt=0,Ft=0,$t=0,et=!1,st=!1,Pn=m=>m.button===1||m.button===2,lt=m=>{me&&(me.style.cursor=m)},In=m=>st||et||Pn(m),Ha=()=>{ft&&(ft.classList.toggle("active",st),ft.setAttribute("aria-pressed",st?"true":"false"))};if(ft&&(Ha(),ft.addEventListener("click",()=>{st=!st,Ha(),lt(st?"grab":"")})),me){me.addEventListener("contextmenu",C=>{et&&C.preventDefault()}),window.addEventListener("keydown",C=>{C.code==="Space"&&(et=!0,lt("grab"))}),window.addEventListener("keyup",C=>{C.code==="Space"&&(et=!1,Qe||lt(""))}),me.addEventListener("mousedown",C=>{In(C)&&(C.preventDefault(),Qe=!0,Rt=C.clientX,Nt=C.clientY,Ft=ke,$t=Se,lt("grabbing"))}),window.addEventListener("mousemove",C=>{if(!Qe)return;let I=C.clientX-Rt,z=C.clientY-Nt;ke=Ft+I,Se=$t+z,Ot()}),window.addEventListener("mouseup",()=>{Qe&&(Qe=!1,lt(et?"grab":""))}),me.addEventListener("wheel",C=>{if(!C.ctrlKey&&!C.metaKey)return;C.preventDefault();let I=me.getBoundingClientRect(),z=C.clientX-I.left-ke,ee=C.clientY-I.top-Se,A=q,_=Math.max(.05,Math.min(.5,Math.abs(C.deltaY)>20?.2:.1)),re=Math.max(.05,Math.min(20,A+(C.deltaY>0?-_:_)));if(re===A)return;let O=re/A;ke=ke-z*(O-1),Se=Se-ee*(O-1),$e(re)},{passive:!1});let m=null,y=0,k=null;me.addEventListener("touchstart",C=>{if(C.touches.length===1){let I=C.touches[0];Qe=!0,Rt=I.clientX,Nt=I.clientY,Ft=ke,$t=Se,lt("grabbing");let z=Date.now();if(z-y<300){let ee=Math.abs(q-1)<.01?Ze():1;$e(ee),vt(),k&&clearTimeout(k)}else y=z,k=setTimeout(()=>{k=null},320)}else if(C.touches.length===2){let[I,z]=C.touches;m=Math.hypot(z.clientX-I.clientX,z.clientY-I.clientY)}},{passive:!0}),me.addEventListener("touchmove",C=>{if(C.touches.length===1&&Qe){let I=C.touches[0],z=I.clientX-Rt,ee=I.clientY-Nt;ke=Ft+z,Se=$t+ee,Ot()}else if(C.touches.length===2&&m!=null){C.preventDefault();let[I,z]=C.touches,ee=Math.hypot(z.clientX-I.clientX,z.clientY-I.clientY),A=me.getBoundingClientRect(),_=(I.clientX+z.clientX)/2-A.left-ke,re=(I.clientY+z.clientY)/2-A.top-Se,O=q,X=ee/(m||ee),F=Math.max(.05,Math.min(20,O*X));F!==O&&(ke=ke-_*(F/O-1),Se=Se-re*(F/O-1),$e(F)),m=ee}},{passive:!1}),me.addEventListener("touchend",()=>{Qe=!1,m=null,lt(st||et?"grab":"")})}let ga=()=>{oe&&clearTimeout(oe);let m=()=>{oe=null,fe()};window.requestIdleCallback?oe=setTimeout(()=>requestIdleCallback(m,{timeout:150}),50):oe=setTimeout(()=>requestAnimationFrame(m),50)},Ua=()=>{ae=!0},qa=()=>{ae=!1,ga()};Le.addEventListener("pointerdown",Ua),Be.addEventListener("pointerdown",Ua),Le.addEventListener("pointerup",qa),Be.addEventListener("pointerup",qa),Le.addEventListener("input",()=>{Dt(),ga()}),Be.addEventListener("input",()=>{Lt(),ga()});let Wt=!1,En=-1,Mn=-1,_t=1,xt=1,tt="ignore",yt=u.querySelector("#maskBrushSize"),ha=u.querySelector("#maskBrushSizeValue"),ua=u.querySelector("#maskModeIgnore"),ma=u.querySelector("#maskModeUnignore"),wa=u.querySelector("#maskModeToggle"),Ga=u.querySelector("#clearIgnoredBtn"),Ya=u.querySelector("#invertMaskBtn"),kt=u.querySelector("#rowColSize"),fa=u.querySelector("#rowColSizeValue"),Va=()=>{let m=[[ua,"ignore"],[ma,"unignore"],[wa,"toggle"]];for(let[y,k]of m){if(!y)continue;let C=tt===k;y.classList.toggle("active",C),y.setAttribute("aria-pressed",C?"true":"false")}},ba=m=>{tt=m,Va()};yt&&ha&&(yt.addEventListener("input",()=>{_t=parseInt(yt.value,10)||1,ha.textContent=_t}),ha.textContent=yt.value,_t=parseInt(yt.value,10)||1),kt&&fa&&(kt.addEventListener("input",()=>{xt=parseInt(kt.value,10)||1,fa.textContent=xt}),fa.textContent=kt.value,xt=parseInt(kt.value,10)||1),ua&&ua.addEventListener("click",()=>ba("ignore")),ma&&ma.addEventListener("click",()=>ba("unignore")),wa&&wa.addEventListener("click",()=>ba("toggle")),Va();let zn=(m,y)=>{let k=V.getBoundingClientRect(),C=k.width/V.width,I=k.height/V.height,z=(m-k.left)/C,ee=(y-k.top)/I,A=Math.floor(z),_=Math.floor(ee);return{x:A,y:_}},va=(m,y)=>{(!e.resizeIgnoreMask||e.resizeIgnoreMask.length!==m*y)&&(e.resizeIgnoreMask=new Uint8Array(m*y))},An=(m,y,k,C)=>{let I=V.width,z=V.height;va(I,z);let ee=k*k;for(let A=y-k;A<=y+k;A++)if(!(A<0||A>=z))for(let _=m-k;_<=m+k;_++){if(_<0||_>=I)continue;let re=_-m,O=A-y;if(re*re+O*O<=ee){let X=A*I+_,F=e.resizeIgnoreMask[X];if(tt==="toggle"?F=F?0:1:tt==="ignore"?F=1:F=0,e.resizeIgnoreMask[X]=F,D){let U=X*4;F?(D[U]=255,D[U+1]=0,D[U+2]=0,D[U+3]=150):(D[U]=0,D[U+1]=0,D[U+2]=0,D[U+3]=0),H(_,A)}}}},Dn=(m,y)=>{let k=V.width,C=V.height;if(va(k,C),m<0||m>=C)return;let I=Math.floor(xt/2),z=Math.max(0,m-I),ee=Math.min(C-1,m+I);for(let A=z;A<=ee;A++){for(let _=0;_<k;_++){let re=A*k+_,O=e.resizeIgnoreMask[re];if(tt==="toggle"?O=O?0:1:tt==="ignore"?O=1:O=0,e.resizeIgnoreMask[re]=O,D){let X=re*4;O?(D[X]=255,D[X+1]=0,D[X+2]=0,D[X+3]=150):(D[X]=0,D[X+1]=0,D[X+2]=0,D[X+3]=0)}}D&&(H(0,A),H(k-1,A))}},Ln=(m,y)=>{let k=V.width,C=V.height;if(va(k,C),m<0||m>=k)return;let I=Math.floor(xt/2),z=Math.max(0,m-I),ee=Math.min(k-1,m+I);for(let A=z;A<=ee;A++){for(let _=0;_<C;_++){let re=_*k+A,O=e.resizeIgnoreMask[re];if(tt==="toggle"?O=O?0:1:tt==="ignore"?O=1:O=0,e.resizeIgnoreMask[re]=O,D){let X=re*4;O?(D[X]=255,D[X+1]=0,D[X+2]=0,D[X+3]=150):(D[X]=0,D[X+1]=0,D[X+2]=0,D[X+3]=0)}}D&&(H(A,0),H(A,C-1))}},Bn=()=>{N()},Xa=m=>{if((m.buttons&4)===4||(m.buttons&2)===2||et)return;let{x:y,y:k}=zn(m.clientX,m.clientY),C=V.width,I=V.height;if(y<0||k<0||y>=C||k>=I)return;let z=Math.max(1,Math.floor(_t/2));m.shiftKey?Dn(k):m.altKey?Ln(y):An(y,k,z),En=y,Mn=k,Bn()};xe.addEventListener("mousedown",m=>{m.button===1||m.button===2||et||(Wt=!0,Xa(m))}),xe.addEventListener("touchstart",m=>{},{passive:!0}),xe.addEventListener("touchmove",m=>{},{passive:!0}),xe.addEventListener("touchend",m=>{},{passive:!0}),window.addEventListener("mousemove",m=>{Wt&&Xa(m)}),window.addEventListener("mouseup",()=>{Wt&&(Wt=!1,G())}),Ga&&Ga.addEventListener("click",()=>{let m=V.width,y=V.height;e.resizeIgnoreMask&&e.resizeIgnoreMask.fill(0),Ye(m,y,!0),fe(),G()}),Ya&&Ya.addEventListener("click",()=>{if(!e.resizeIgnoreMask)return;for(let k=0;k<e.resizeIgnoreMask.length;k++)e.resizeIgnoreMask[k]=e.resizeIgnoreMask[k]?0:1;let m=V.width,y=V.height;Ye(m,y,!0),fe(),G()}),bn.onclick=async()=>{let m=parseInt(Le.value,10),y=parseInt(Be.value,10),k=document.createElement("canvas"),C=k.getContext("2d");k.width=m,k.height=y,C.imageSmoothingEnabled=!1,E!==b&&(!E.img||!E.canvas)&&await E.load(),C.drawImage(E.img,0,0,m,y);let I=C.getImageData(0,0,m,y),z=I.data,ee=e.customTransparencyThreshold||f.TRANSPARENCY_THRESHOLD,A=0,_=e.resizeIgnoreMask&&e.resizeIgnoreMask.length===m*y?e.resizeIgnoreMask:null,re=async()=>{let F=m,U=y,ce=F*U,{work:te,eligible:Pe}=ze(ce);for(let Q=0;Q<U;Q++){for(let ne=0;ne<F;ne++){let ie=Q*F+ne,we=ie*4,Ne=z[we],De=z[we+1],Oe=z[we+2],Ee=z[we+3],St=!(_&&_[ie])&&(e.paintTransparentPixels||Ee>=ee)&&(e.paintWhitePixels||!o.isWhitePixel(Ne,De,Oe));Pe[ie]=St?1:0,te[ie*3]=Ne,te[ie*3+1]=De,te[ie*3+2]=Oe,St||(z[we+3]=0)}Q&15||await Promise.resolve()}let Ae=(Q,ne,ie,we,Ne,De)=>{if(Q<0||Q>=F||ne<0||ne>=U)return;let Oe=ne*F+Q;if(!Pe[Oe])return;let Ee=Oe*3;te[Ee]=Math.min(255,Math.max(0,te[Ee]+ie*De)),te[Ee+1]=Math.min(255,Math.max(0,te[Ee+1]+we*De)),te[Ee+2]=Math.min(255,Math.max(0,te[Ee+2]+Ne*De))};for(let Q=0;Q<U;Q++){for(let ne=0;ne<F;ne++){let ie=Q*F+ne;if(!Pe[ie])continue;let we=ie*3,Ne=te[we],De=te[we+1],Oe=te[we+2],[Ee,at,St]=o.findClosestPaletteColor(Ne,De,Oe,e.activeColorPalette),Ht=ie*4;z[Ht]=Ee,z[Ht+1]=at,z[Ht+2]=St,z[Ht+3]=255,A++;let Ut=Ne-Ee,qt=De-at,Gt=Oe-St;Ae(ne+1,Q,Ut,qt,Gt,7/16),Ae(ne-1,Q+1,Ut,qt,Gt,3/16),Ae(ne,Q+1,Ut,qt,Gt,5/16),Ae(ne+1,Q+1,Ut,qt,Gt,1/16)}await Promise.resolve()}};if(e.ditheringEnabled)await re();else for(let F=0;F<z.length;F+=4){let U=z[F],ce=z[F+1],te=z[F+2],Pe=z[F+3],Ae=_&&_[F>>2],Q=!e.paintTransparentPixels&&Pe<ee||Ae,ne=!e.paintWhitePixels&&o.isWhitePixel(U,ce,te);if(Q||ne){z[F+3]=0;continue}A++;let[ie,we,Ne]=o.findClosestPaletteColor(U,ce,te,e.activeColorPalette);z[F]=ie,z[F+1]=we,z[F+2]=Ne,z[F+3]=255}C.putImageData(I,0,0);let O=new Uint8ClampedArray(I.data);e.imageData.pixels=O,e.imageData.width=m,e.imageData.height=y,e.imageData.totalPixels=A,e.totalPixels=A,e.paintedPixels=0,e.resizeSettings={baseWidth:B,baseHeight:L,width:m,height:y},G();let X=await createImageBitmap(k);await Me.setImage(X),Me.enable(),Ce.classList.add("active"),Ce.setAttribute("aria-pressed","true"),_e(),$("resizeSuccess","success",{width:m,height:y}),$a()},xn.onclick=()=>{try{let m=V.width,y=V.height,k=document.createElement("canvas");k.width=m,k.height=y;let C=k.getContext("2d");C.imageSmoothingEnabled=!1,C.drawImage(V,0,0),C.drawImage(xe,0,0);let I=document.createElement("a");I.download="wplace-preview.png",I.href=k.toDataURL(),I.click()}catch(m){console.warn("Failed to download preview:",m)}},vn.onclick=$a,v.style.display="block",u.style.display="block",cn(u),fe(),Tt=()=>{try{qe.replaceWith(qe.cloneNode(!0))}catch{}try{mt&&mt.replaceWith(mt.cloneNode(!0))}catch{}try{wt&&wt.replaceWith(wt.cloneNode(!0))}catch{}},setTimeout(()=>{if(typeof Ze=="function"){let m=Ze();!isNaN(m)&&isFinite(m)&&($e(m),vt())}else vt()},0)}function $a(){try{typeof Tt=="function"&&Tt()}catch{}v.style.display="none",u.style.display="none",fe=()=>{};try{typeof cancelAnimationFrame=="function"&&_panRaf&&cancelAnimationFrame(_panRaf)}catch{}try{_previewTimer&&(clearTimeout(_previewTimer),_previewTimer=null)}catch{}_maskImageData=null,_maskData=null,_dirty=null,_ditherWorkBuf=null,_ditherEligibleBuf=null,Tt=null}x&&x.addEventListener("click",async()=>{let b=o.extractAvailableColors();if(b===null||b.length<10){$("noColorsFound","error"),o.showAlert(o.t("noColorsFound"),"error");return}e.colorsChecked||(e.availableColors=b,e.colorsChecked=!0,$("colorsFound","success",{count:b.length}),_e(),P.disabled=!1,e.imageLoaded&&(T.disabled=!1));try{$("loadingImage","default");let E=await o.createImageUploader();if(!E){$("colorsFound","success",{count:e.availableColors.length});return}let B=new ea(E);await B.load();let{width:L,height:K}=B.getDimensions(),Y=B.getPixelData(),ge=0;for(let oe=0;oe<Y.length;oe+=4){let le=!e.paintTransparentPixels&&Y[oe+3]<(e.customTransparencyThreshold||f.TRANSPARENCY_THRESHOLD),ae=!e.paintWhitePixels&&o.isWhitePixel(Y[oe],Y[oe+1],Y[oe+2]);!le&&!ae&&ge++}e.imageData={width:L,height:K,pixels:Y,totalPixels:ge,processor:B},e.totalPixels=ge,e.paintedPixels=0,e.imageLoaded=!0,e.lastPosition={x:0,y:0},o.initializePaintedMap(L,K),e.resizeSettings=null,e.resizeIgnoreMask=null,e.originalImage={dataUrl:E,width:L,height:K},G();let he=await createImageBitmap(B.img);await Me.setImage(he),Me.enable(),Ce.disabled=!1,Ce.classList.add("active"),Ce.setAttribute("aria-pressed","true"),e.colorsChecked&&(T.disabled=!1),W.disabled=!1,e.startPosition&&(M.disabled=!1),_e(),gt(),$("imageLoaded","success",{count:ge})}catch{$("imageError","error")}}),T&&T.addEventListener("click",()=>{e.imageLoaded&&e.imageData.processor&&e.colorsChecked?Tn(e.imageData.processor):e.colorsChecked||o.showAlert(o.t("uploadImageFirstColors"),"warning")}),P&&P.addEventListener("click",async()=>{if(e.selectingPosition)return;e.selectingPosition=!0,e.startPosition=null,e.region=null,M.disabled=!0,o.showAlert(o.t("selectPositionAlert"),"info"),$("waitingPosition","default");let b=async(B,L)=>{var K;if(typeof B=="string"&&B.includes("https://backend.wplace.live/s0/pixel/")&&((K=L==null?void 0:L.method)==null?void 0:K.toUpperCase())==="POST")try{let Y=await E(B,L),he=await Y.clone().json();if((he==null?void 0:he.painted)===1){let oe=B.match(/\/pixel\/(\d+)\/(\d+)/);oe&&oe.length>=3&&(e.region={x:Number.parseInt(oe[1]),y:Number.parseInt(oe[2])});let le=JSON.parse(L.body);le!=null&&le.coords&&Array.isArray(le.coords)&&(e.startPosition={x:le.coords[0],y:le.coords[1]},e.lastPosition={x:0,y:0},await Me.setPosition(e.startPosition,e.region),e.imageLoaded&&(M.disabled=!1),window.fetch=E,e.selectingPosition=!1,$("positionSet","success"))}return Y}catch{return E(B,L)}return E(B,L)},E=window.fetch;window.fetch=b,setTimeout(()=>{e.selectingPosition&&(window.fetch=E,e.selectingPosition=!1,$("positionTimeout","error"),o.showAlert(o.t("positionTimeout"),"error"))},12e4)});async function Cn(){if(!e.imageLoaded||!e.startPosition||!e.region){$("missingRequirements","error");return}if(await Ca(),!!be){e.running=!0,e.stopFlag=!1,M.disabled=!0,R.disabled=!1,x.disabled=!0,P.disabled=!0,T.disabled=!0,W.disabled=!0,Ce.disabled=!0,$("startPaintingMsg","success");try{await gn()}catch(b){console.error("Unexpected error:",b),$("paintingError","error")}finally{e.running=!1,R.disabled=!0,W.disabled=!1,e.stopFlag?M.disabled=!1:(M.disabled=!0,x.disabled=!1,P.disabled=!1,T.disabled=!1),Ce.disabled=!1}}}if(M&&M.addEventListener("click",Cn),R&&R.addEventListener("click",()=>{e.stopFlag=!0,e.running=!1,R.disabled=!0,$("paintingStoppedByUser","warning"),e.imageLoaded&&e.paintedPixels>0&&(o.saveProgress(),o.showAlert(o.t("autoSaved"),"success"))}),setTimeout(()=>{let b=o.loadProgress();if(b&&b.state.paintedPixels>0){let E=new Date(b.timestamp).toLocaleString(),B=Math.round(b.state.paintedPixels/b.state.totalPixels*100);o.showAlert(`${o.t("savedDataFound")}

Saved: ${E}
Progress: ${b.state.paintedPixels}/${b.state.totalPixels} pixels (${B}%)
${o.t("clickLoadToContinue")}`,"info")}},1e3),Ue&&Re){let b=(E,B)=>{let L=Math.max(1,Math.min(e.maxCharges||999,parseInt(E)));e.cooldownChargeThreshold=L,B!=="slider"&&(Ue.value=L),B!=="input"&&(Re.value=L),G(),Ve.resetEdgeTracking()};Ue.addEventListener("input",E=>{b(E.target.value,"slider")}),Re.addEventListener("input",E=>{b(E.target.value,"input")}),ut&&o.addHoldToRepeatListener(ut,()=>{b(parseInt(Re.value)-1,"button")}),ot&&o.addHoldToRepeatListener(ot,()=>{b(parseInt(Re.value)+1,"button")})}wn(),Ve.syncFromState()}function na(t,a,n,i=0){let r=a-t;return Math.max(0,r*n-i)}function pn(t){if(e.stopFlag)return;let a=e.cooldownChargeThreshold,n=na(e.preciseCurrentCharges,a,e.cooldown,t),i=o.msToTimeText(n);$("noChargesThreshold","warning",{threshold:a,current:e.displayCharges,time:i},!0)}function dn(t,a,n,i,r,s,c){let p=[];console.log(`Generating coordinates with 
  mode:`,n,`
  direction:`,i,`
  snake:`,r,`
  blockWidth:`,s,`
  blockHeight:`,c);let h,d,l,w,g,S;switch(i){case"top-left":h=0,d=t,l=1,w=0,g=a,S=1;break;case"top-right":h=t-1,d=-1,l=-1,w=0,g=a,S=1;break;case"bottom-left":h=0,d=t,l=1,w=a-1,g=-1,S=-1;break;case"bottom-right":h=t-1,d=-1,l=-1,w=a-1,g=-1,S=-1;break;default:throw new Error(`Unknown direction: ${i}`)}if(n==="rows")for(let u=w;u!==g;u+=S)if(r&&(u-w)%2!==0)for(let v=d-l;v!==h-l;v-=l)p.push([v,u]);else for(let v=h;v!==d;v+=l)p.push([v,u]);else if(n==="columns")for(let u=h;u!==d;u+=l)if(r&&(u-h)%2!==0)for(let v=g-S;v!==w-S;v-=S)p.push([u,v]);else for(let v=w;v!==g;v+=S)p.push([u,v]);else if(n==="circle-out"){let u=Math.floor(t/2),v=Math.floor(a/2),x=Math.ceil(Math.sqrt(u*u+v*v));for(let T=0;T<=x;T++)for(let P=v-T;P<=v+T;P++)for(let M=u-T;M<=u+T;M++)M>=0&&M<t&&P>=0&&P<a&&Math.max(Math.abs(M-u),Math.abs(P-v))===T&&p.push([M,P])}else if(n==="circle-in"){let u=Math.floor(t/2),v=Math.floor(a/2),x=Math.ceil(Math.sqrt(u*u+v*v));for(let T=x;T>=0;T--)for(let P=v-T;P<=v+T;P++)for(let M=u-T;M<=u+T;M++)M>=0&&M<t&&P>=0&&P<a&&Math.max(Math.abs(M-u),Math.abs(P-v))===T&&p.push([M,P])}else if(n==="blocks"||n==="shuffle-blocks"){let u=[];for(let v=0;v<a;v+=c)for(let x=0;x<t;x+=s){let T=[];for(let P=v;P<Math.min(v+c,a);P++)for(let M=x;M<Math.min(x+s,t);M++)T.push([M,P]);u.push(T)}if(n==="shuffle-blocks")for(let v=u.length-1;v>0;v--){let x=Math.floor(Math.random()*(v+1));[u[v],u[x]]=[u[x],u[v]]}for(let v of u)p.push(...v)}else throw new Error(`Unknown mode: ${n}`);return p}async function It(t){if(!t||t.pixels.length===0)return!0;let a=t.pixels.length;console.log(`\u{1F4E6} Sending batch with ${a} pixels (region: ${t.regionX},${t.regionY})`);let n=await un(t.pixels,t.regionX,t.regionY);if(n){if(t.pixels.forEach(i=>{e.paintedPixels++,o.markPixelPainted(i.x,i.y,t.regionX,t.regionY)}),e.fullChargeData={...e.fullChargeData,spentSinceShot:e.fullChargeData.spentSinceShot+a},_e(),$("paintingProgress","default",{painted:e.paintedPixels,total:e.totalPixels}),o.performSmartSave(),f.PAINTING_SPEED_ENABLED&&e.paintingSpeed>0&&a>0){let i=1e3/e.paintingSpeed,r=Math.max(100,i*a);await o.sleep(r)}}else console.error("\u274C Batch failed permanently after retries. Stopping painting."),e.stopFlag=!0,$("paintingBatchFailed","error");return t.pixels=[],n}async function gn(){let{width:t,height:a,pixels:n}=e.imageData,{x:i,y:r}=e.startPosition,{x:s,y:c}=e.region;if(!await Me.waitForTiles(s,c,t,a,i,r,1e4)){$("overlayTilesNotLoaded","error"),e.stopFlag=!0;return}let h=null,d={transparent:0,white:0,alreadyPainted:0,colorUnavailable:0},l=e.customTransparencyThreshold||f.TRANSPARENCY_THRESHOLD;function w(S,u){let v=(u*t+S)*4,x=n[v],T=n[v+1],P=n[v+2],M=n[v+3];if(!e.paintTransparentPixels&&M<l)return{eligible:!1,reason:"transparent"};if(!e.paintWhitePixels&&o.isWhitePixel(x,T,P))return{eligible:!1,reason:"white"};let R=o.isWhitePixel(x,T,P)?[255,255,255]:o.findClosestPaletteColor(x,T,P,e.activeColorPalette),W=o.resolveColor(R,e.availableColors,!e.paintUnavailablePixels);return!e.paintUnavailablePixels&&!W.id?{eligible:!1,reason:"colorUnavailable",r:x,g:T,b:P,a:M,mappedColorId:W.id}:{eligible:!0,r:x,g:T,b:P,a:M,mappedColorId:W.id}}function g(S,u,v,x,T){S!=="transparent"&&console.log(`Skipped pixel for ${S} (id: ${u}, (${v.join(", ")})) at (${x}, ${T})`),d[S]++}try{let S=dn(t,a,e.coordinateMode,e.coordinateDirection,e.coordinateSnake,e.blockWidth,e.blockHeight);e:for(let[u,v]of S){if(e.stopFlag){h&&h.pixels.length>0&&(console.log(`\u{1F3AF} Sending last batch before stop with ${h.pixels.length} pixels`),await It(h)),e.lastPosition={x:u,y:v},$("paintingPaused","warning",{x:u,y:v});break e}let x=w(u,v),T=i+u,P=r+v,M=Math.floor(T/1e3),R=Math.floor(P/1e3),W=T%1e3,Z=P%1e3,ve=x.mappedColorId;if(!x.eligible){g(x.reason,ve,[x.r,x.g,x.b],W,Z);continue}if(!h||h.regionX!==s+M||h.regionY!==c+R){if(h&&h.pixels.length>0)if(console.log(`\u{1F30D} Sending region-change batch with ${h.pixels.length} pixels (switching to region ${s+M},${c+R})`),await It(h)){if(f.PAINTING_SPEED_ENABLED&&e.paintingSpeed>0&&h.pixels.length>0){let de=Math.max(1,100/e.paintingSpeed),se=Math.max(100,de*h.pixels.length);await o.sleep(se)}_e()}else{console.error("\u274C Batch failed permanently after retries. Stopping painting."),e.stopFlag=!0,$("paintingBatchFailed","error");break e}h={regionX:s+M,regionY:c+R,pixels:[]}}try{let j=[h.regionX,h.regionY],de=await Me.getTilePixelColor(j[0],j[1],W,Z);if(de&&Array.isArray(de)){let se=o.resolveColor(de.slice(0,3),e.availableColors),Ce=se.id===ve;if(Ce){g("alreadyPainted",ve,[x.r,x.g,x.b],W,Z);continue}console.debug(`[COMPARE] Pixel at \u{1F4CD} (${W}, ${Z}) in region (${s+M}, ${c+R})
  \u251C\u2500\u2500 Current color: rgb(${de.slice(0,3).join(", ")}) (id: ${se.id})
  \u251C\u2500\u2500 Target color:  rgb(${x.r}, ${x.g}, ${x.b}) (id: ${ve})
  \u2514\u2500\u2500 Status: ${Ce?"\u2705 Already painted \u2192 SKIP":"\u{1F534} Needs paint \u2192 PAINT"}
`)}}catch(j){console.error(`[DEBUG] Error checking existing pixel at (${W}, ${Z}):`,j),$("paintingPixelCheckFailed","error",{x:W,y:Z}),e.stopFlag=!0;break e}h.pixels.push({x:W,y:Z,color:ve,localX:u,localY:v});let Ie=hn();if(h.pixels.length>=Ie){let j=e.batchMode==="random"?`random (${e.randomBatchMin}-${e.randomBatchMax})`:"normal";if(console.log(`\u{1F4E6} Sending batch with ${h.pixels.length} pixels (mode: ${j}, target: ${Ie})`),!await It(h)){console.error("\u274C Batch failed permanently after retries. Stopping painting."),e.stopFlag=!0,$("paintingBatchFailed","error");break e}h.pixels=[]}if(e.displayCharges<e.cooldownChargeThreshold&&!e.stopFlag&&await o.dynamicSleep(()=>e.displayCharges>=e.cooldownChargeThreshold?(Ve.maybeNotifyChargesReached(!0),0):e.stopFlag?0:na(e.preciseCurrentCharges,e.cooldownChargeThreshold,e.cooldown)),e.stopFlag)break e}h&&h.pixels.length>0&&!e.stopFlag&&(console.log(`\u{1F3C1} Sending final batch with ${h.pixels.length} pixels`),await It(h)||console.warn(`\u26A0\uFE0F Final batch failed with ${h.pixels.length} pixels after all retries.`))}finally{window._chargesInterval&&clearInterval(window._chargesInterval),window._chargesInterval=null}if(e.stopFlag)o.saveProgress();else{$("paintingComplete","success",{count:e.paintedPixels}),e.lastPosition={x:0,y:0},o.saveProgress(),Me.clear();let S=document.getElementById("toggleOverlayBtn");S&&(S.classList.remove("active"),S.disabled=!0)}console.log("\u{1F4CA} Pixel Statistics:"),console.log(`   Painted: ${e.paintedPixels}`),console.log(`   Skipped - Transparent: ${d.transparent}`),console.log(`   Skipped - White (disabled): ${d.white}`),console.log(`   Skipped - Already painted: ${d.alreadyPainted}`),console.log(`   Skipped - Color Unavailable: ${d.colorUnavailable}`),console.log(`   Total processed: ${e.paintedPixels+d.transparent+d.white+d.alreadyPainted+d.colorUnavailable}`),_e()}function hn(){let t;if(e.batchMode==="random"){let i=Math.max(1,e.randomBatchMin),r=Math.max(i,e.randomBatchMax);t=Math.floor(Math.random()*(r-i+1))+i,console.log(`\u{1F3B2} Random batch size generated: ${t} (range: ${i}-${r})`)}else t=e.paintingSpeed;let a=e.displayCharges;return Math.min(t,a)}async function un(t,a,n,i=Ta){let r=0;for(;r<i&&!e.stopFlag;){r++,console.log(`\u{1F504} Attempting to send batch (attempt ${r}/${i}) for region ${a},${n} with ${t.length} pixels`);let s=await mn(t,a,n);if(s===!0)return console.log(`\u2705 Batch succeeded on attempt ${r}`),!0;if(s==="token_error"){console.log(`\u{1F511} Token error on attempt ${r}, regenerating...`),$("captchaSolving","warning");try{await ta(),r--;continue}catch(c){console.error(`\u274C Token regeneration failed on attempt ${r}:`,c),$("captchaFailed","error"),await o.sleep(5e3)}}else{console.warn(`\u26A0\uFE0F Batch failed on attempt ${r}, retrying...`);let c=Math.min(1e3*Math.pow(2,r-1),3e4),p=Math.random()*1e3;await o.sleep(c+p)}}return r>=i&&(console.error(`\u274C Batch failed after ${i} attempts (MAX_BATCH_RETRIES=${Ta}). This will stop painting to prevent infinite loops.`),$("paintingError","error")),!1}async function mn(t,a,n){let i=be;if(!i)try{console.log("\u{1F511} Generating Turnstile token for pixel batch..."),i=await ta(),be=i}catch(c){return console.error("\u274C Failed to generate Turnstile token:",c),ct=new Promise(p=>{We=p}),"token_error"}let r=new Array(t.length*2),s=new Array(t.length);for(let c=0;c<t.length;c++){let p=t[c];r[c*2]=p.x,r[c*2+1]=p.y,s[c]=p.color}try{let c={coords:r,colors:s,t:i},p=await fetch(`https://backend.wplace.live/s0/pixel/${a}/${n}`,{method:"POST",headers:{"Content-Type":"text/plain;charset=UTF-8"},credentials:"include",body:JSON.stringify(c)});if(p.status===403){let d=null;try{d=await p.json()}catch{}console.error("\u274C 403 Forbidden. Turnstile token might be invalid or expired.");try{console.log("\u{1F504} Regenerating Turnstile token after 403..."),i=await ta(),be=i;let l={coords:r,colors:s,t:i},w=await fetch(`https://backend.wplace.live/s0/pixel/${a}/${n}`,{method:"POST",headers:{"Content-Type":"text/plain;charset=UTF-8"},credentials:"include",body:JSON.stringify(l)});if(w.status===403)return be=null,ct=new Promise(S=>{We=S}),"token_error";let g=await w.json();return(g==null?void 0:g.painted)===t.length}catch(l){return console.error("\u274C Token regeneration failed:",l),be=null,ct=new Promise(w=>{We=w}),"token_error"}}let h=await p.json();return(h==null?void 0:h.painted)===t.length}catch(c){return console.error("Batch paint request failed:",c),!1}}function G(){var t,a;try{let n={paintingSpeed:e.paintingSpeed,paintingSpeedEnabled:(t=document.getElementById("enableSpeedToggle"))==null?void 0:t.checked,batchMode:e.batchMode,randomBatchMin:e.randomBatchMin,randomBatchMax:e.randomBatchMax,cooldownChargeThreshold:e.cooldownChargeThreshold,tokenSource:e.tokenSource,minimized:e.minimized,overlayOpacity:e.overlayOpacity,blueMarbleEnabled:(a=document.getElementById("enableBlueMarbleToggle"))==null?void 0:a.checked,ditheringEnabled:e.ditheringEnabled,colorMatchingAlgorithm:e.colorMatchingAlgorithm,enableChromaPenalty:e.enableChromaPenalty,chromaPenaltyWeight:e.chromaPenaltyWeight,customTransparencyThreshold:e.customTransparencyThreshold,customWhiteThreshold:e.customWhiteThreshold,paintWhitePixels:e.paintWhitePixels,paintTransparentPixels:e.paintTransparentPixels,resizeSettings:e.resizeSettings,paintUnavailablePixels:e.paintUnavailablePixels,coordinateMode:e.coordinateMode,coordinateDirection:e.coordinateDirection,coordinateSnake:e.coordinateSnake,blockWidth:e.blockWidth,blockHeight:e.blockHeight,resizeIgnoreMask:e.resizeIgnoreMask&&e.resizeSettings&&e.resizeSettings.width*e.resizeSettings.height===e.resizeIgnoreMask.length?{w:e.resizeSettings.width,h:e.resizeSettings.height,data:btoa(String.fromCharCode(...e.resizeIgnoreMask))}:null,notificationsEnabled:e.notificationsEnabled,notifyOnChargesReached:e.notifyOnChargesReached,notifyOnlyWhenUnfocused:e.notifyOnlyWhenUnfocused,notificationIntervalMinutes:e.notificationIntervalMinutes,originalImage:e.originalImage};f.PAINTING_SPEED_ENABLED=n.paintingSpeedEnabled,localStorage.setItem("wplace-bot-settings",JSON.stringify(n))}catch(n){console.warn("Could not save bot settings:",n)}}function wn(){try{let t=localStorage.getItem("wplace-bot-settings");if(!t)return;let a=JSON.parse(t);if(e.paintingSpeed=a.paintingSpeed||f.PAINTING_SPEED.DEFAULT,e.batchMode=a.batchMode||f.BATCH_MODE,e.randomBatchMin=a.randomBatchMin||f.RANDOM_BATCH_RANGE.MIN,e.randomBatchMax=a.randomBatchMax||f.RANDOM_BATCH_RANGE.MAX,e.cooldownChargeThreshold=a.cooldownChargeThreshold||f.COOLDOWN_CHARGE_THRESHOLD,e.tokenSource=a.tokenSource||f.TOKEN_SOURCE,e.minimized=a.minimized??!1,f.PAINTING_SPEED_ENABLED=a.paintingSpeedEnabled??!1,f.AUTO_CAPTCHA_ENABLED=a.autoCaptchaEnabled??!1,e.overlayOpacity=a.overlayOpacity??f.OVERLAY.OPACITY_DEFAULT,e.blueMarbleEnabled=a.blueMarbleEnabled??f.OVERLAY.BLUE_MARBLE_DEFAULT,e.ditheringEnabled=a.ditheringEnabled??!1,e.colorMatchingAlgorithm=a.colorMatchingAlgorithm||"lab",e.enableChromaPenalty=a.enableChromaPenalty??!0,e.chromaPenaltyWeight=a.chromaPenaltyWeight??.15,e.customTransparencyThreshold=a.customTransparencyThreshold??f.TRANSPARENCY_THRESHOLD,e.customWhiteThreshold=a.customWhiteThreshold??f.WHITE_THRESHOLD,e.paintWhitePixels=a.paintWhitePixels??!0,e.paintTransparentPixels=a.paintTransparentPixels??!1,e.resizeSettings=a.resizeSettings??null,e.originalImage=a.originalImage??null,e.paintUnavailablePixels=a.paintUnavailablePixels??f.PAINT_UNAVAILABLE,e.coordinateMode=a.coordinateMode??f.COORDINATE_MODE,e.coordinateDirection=a.coordinateDirection??f.COORDINATE_DIRECTION,e.coordinateSnake=a.coordinateSnake??f.COORDINATE_SNAKE,e.blockWidth=a.blockWidth??f.COORDINATE_BLOCK_WIDTH,e.blockHeight=a.blockHeight??f.COORDINATE_BLOCK_HEIGHT,e.notificationsEnabled=a.notificationsEnabled??f.NOTIFICATIONS.ENABLED,e.notifyOnChargesReached=a.notifyOnChargesReached??f.NOTIFICATIONS.ON_CHARGES_REACHED,e.notifyOnlyWhenUnfocused=a.notifyOnlyWhenUnfocused??f.NOTIFICATIONS.ONLY_WHEN_UNFOCUSED,e.notificationIntervalMinutes=a.notificationIntervalMinutes??f.NOTIFICATIONS.REPEAT_MINUTES,a.resizeIgnoreMask&&a.resizeIgnoreMask.data&&e.resizeSettings&&a.resizeIgnoreMask.w===e.resizeSettings.width&&a.resizeIgnoreMask.h===e.resizeSettings.height)try{let Re=atob(a.resizeIgnoreMask.data),ut=new Uint8Array(Re.length);for(let ot=0;ot<Re.length;ot++)ut[ot]=Re.charCodeAt(ot);e.resizeIgnoreMask=ut}catch{e.resizeIgnoreMask=null}else e.resizeIgnoreMask=null;let n=document.getElementById("coordinateModeSelect");n&&(n.value=e.coordinateMode);let i=document.getElementById("coordinateDirectionSelect");i&&(i.value=e.coordinateDirection);let r=document.getElementById("coordinateSnakeToggle");r&&(r.checked=e.coordinateSnake);let s=document.getElementById("wplace-settings-container"),c=s.querySelector("#directionControls"),p=s.querySelector("#snakeControls"),h=s.querySelector("#blockControls");o.updateCoordinateUI({mode:e.coordinateMode,directionControls:c,snakeControls:p,blockControls:h});let d=document.getElementById("paintUnavailablePixelsToggle");d&&(d.checked=e.paintUnavailablePixels);let l=s.querySelector("#settingsPaintWhiteToggle");l&&(l.checked=e.paintWhitePixels);let w=s.querySelector("#settingsPaintTransparentToggle");w&&(w.checked=e.paintTransparentPixels);let g=document.getElementById("speedSlider"),S=document.getElementById("speedInput");g&&(g.value=e.paintingSpeed),S&&(S.value=e.paintingSpeed);let u=document.getElementById("enableSpeedToggle");u&&(u.checked=f.PAINTING_SPEED_ENABLED);let v=document.getElementById("batchModeSelect");v&&(v.value=e.batchMode);let x=document.getElementById("normalBatchControls"),T=document.getElementById("randomBatchControls");x&&T&&(e.batchMode==="random"?(x.style.display="none",T.style.display="block"):(x.style.display="block",T.style.display="none"));let P=document.getElementById("randomBatchMin");P&&(P.value=e.randomBatchMin);let M=document.getElementById("randomBatchMax");M&&(M.value=e.randomBatchMax);let R=document.getElementById("cooldownSlider"),W=document.getElementById("cooldownInput");R&&(R.value=e.cooldownChargeThreshold),W&&(W.value=e.cooldownChargeThreshold);let Z=document.getElementById("overlayOpacitySlider");Z&&(Z.value=e.overlayOpacity);let ve=document.getElementById("overlayOpacityValue");ve&&(ve.textContent=`${Math.round(e.overlayOpacity*100)}%`);let Ie=document.getElementById("enableBlueMarbleToggle");Ie&&(Ie.checked=e.blueMarbleEnabled);let j=document.getElementById("tokenSourceSelect");j&&(j.value=e.tokenSource);let de=document.getElementById("colorAlgorithmSelect");de&&(de.value=e.colorMatchingAlgorithm);let se=document.getElementById("enableChromaPenaltyToggle");se&&(se.checked=e.enableChromaPenalty);let Ce=document.getElementById("chromaPenaltyWeightSlider");Ce&&(Ce.value=e.chromaPenaltyWeight);let je=document.getElementById("chromaWeightValue");je&&(je.textContent=e.chromaPenaltyWeight);let Mt=document.getElementById("transparencyThresholdInput");Mt&&(Mt.value=e.customTransparencyThreshold);let ht=document.getElementById("whiteThresholdInput");ht&&(ht.value=e.customWhiteThreshold);let it=document.getElementById("notifEnabledToggle");it&&(it.checked=e.notificationsEnabled);let dt=document.getElementById("notifOnChargesToggle");dt&&(dt.checked=e.notifyOnChargesReached);let He=document.getElementById("notifOnlyUnfocusedToggle");He&&(He.checked=e.notifyOnlyWhenUnfocused);let Ue=document.getElementById("notifIntervalInput");Ue&&(Ue.value=e.notificationIntervalMinutes),Ve.resetEdgeTracking()}catch(t){console.warn("Could not load bot settings:",t)}}console.log("\u{1F680} WPlace Auto-Image with Turnstile Token Generator loaded"),console.log("\u{1F511} Turnstile token generator: ALWAYS ENABLED (Background mode)"),console.log("\u{1F3AF} Manual pixel captcha solving: Available as fallback/alternative"),console.log("\u{1F4F1} Turnstile widgets: DISABLED - pure background token generation only!");function Et(){e.initialSetupComplete=!0;let t=document.querySelector("#loadBtn"),a=document.querySelector("#loadFromFileBtn"),n=document.querySelector("#uploadBtn");t&&(t.disabled=!1,t.title="",t.style.animation="pulse 0.6s ease-in-out",setTimeout(()=>{t&&(t.style.animation="")},600),console.log("\u2705 Load Progress button enabled after initial setup")),a&&(a.disabled=!1,a.title="",a.style.animation="pulse 0.6s ease-in-out",setTimeout(()=>{a&&(a.style.animation="")},600),console.log("\u2705 Load from File button enabled after initial setup")),n&&(n.disabled=!1,n.title="",n.style.animation="pulse 0.6s ease-in-out",setTimeout(()=>{n&&(n.style.animation="")},600),console.log("\u2705 Upload Image button enabled after initial setup")),o.showAlert(o.t("fileOperationsAvailable"),"success")}async function fn(){if(pt()){console.log("\u2705 Valid token already available, skipping initialization"),$("tokenReady","success"),Et();return}try{console.log("\u{1F527} Initializing Turnstile token generator..."),$("initializingToken","default"),console.log("Attempting to load Turnstile script..."),await o.loadTurnstile(),console.log("Turnstile script loaded. Attempting to generate token...");let t=await Pa();t?(nt(t),console.log("\u2705 Startup token generated successfully"),$("tokenReady","success"),o.showAlert(o.t("tokenGeneratorReady"),"success"),Et()):(console.warn("\u26A0\uFE0F Startup token generation failed (no token received), will retry when needed"),$("tokenRetryLater","warning"),Et())}catch(t){console.error("\u274C Critical error during Turnstile initialization:",t),$("tokenRetryLater","warning"),Et()}}ka(),Vt(),aa().then(()=>{setTimeout(fn,1e3),setTimeout(()=>{let a=document.getElementById("chromaPenaltyWeightSlider"),n=document.getElementById("chromaWeightValue"),i=document.getElementById("resetAdvancedColorBtn"),r=document.getElementById("colorAlgorithmSelect"),s=document.getElementById("enableChromaPenaltyToggle"),c=document.getElementById("transparencyThresholdInput"),p=document.getElementById("whiteThresholdInput"),h=document.getElementById("enableDitheringToggle");r&&r.addEventListener("change",d=>{e.colorMatchingAlgorithm=d.target.value,G(),fe()}),s&&s.addEventListener("change",d=>{e.enableChromaPenalty=d.target.checked,G(),fe()}),a&&n&&a.addEventListener("input",d=>{e.chromaPenaltyWeight=parseFloat(d.target.value)||.15,n.textContent=e.chromaPenaltyWeight.toFixed(2),G(),fe()}),c&&c.addEventListener("change",d=>{let l=parseInt(d.target.value,10);!isNaN(l)&&l>=0&&l<=255&&(e.customTransparencyThreshold=l,f.TRANSPARENCY_THRESHOLD=l,G(),fe())}),p&&p.addEventListener("change",d=>{let l=parseInt(d.target.value,10);!isNaN(l)&&l>=200&&l<=255&&(e.customWhiteThreshold=l,f.WHITE_THRESHOLD=l,G(),fe())}),h&&h.addEventListener("change",d=>{e.ditheringEnabled=d.target.checked,G(),fe()}),i&&i.addEventListener("click",()=>{e.colorMatchingAlgorithm="lab",e.enableChromaPenalty=!0,e.chromaPenaltyWeight=.15,e.customTransparencyThreshold=f.TRANSPARENCY_THRESHOLD=100,e.customWhiteThreshold=f.WHITE_THRESHOLD=250,G();let d=document.getElementById("colorAlgorithmSelect");d&&(d.value="lab");let l=document.getElementById("enableChromaPenaltyToggle");l&&(l.checked=!0),a&&(a.value=.15),n&&(n.textContent="0.15"),c&&(c.value=100),p&&(p.value=250),fe(),o.showAlert(o.t("advancedColorSettingsReset"),"success")})},500),window.addEventListener("beforeunload",()=>{o.cleanupTurnstile()})})})();})();
